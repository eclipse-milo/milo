...
class OpcUaXmlEncoderTest {
  ...
  class ScalarTests {
    ...
    @ParameterizedTest(name = "value = {0}")
    @MethodSource(
        "org.eclipse.milo.opcua.stack.core.encoding.xml.args.ScalarArguments#byteArguments")
    ...
    @MethodSource(
        "org.eclipse.milo.opcua.stack.core.encoding.xml.args.ScalarArguments#guidArguments")
