...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.8/#6.2.8.2.2">https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.8/#6.2.8.2.2</a>
 */
public abstract class ReaderGroupTransportDataType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=15621");
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", ReaderGroupTransportDataType.class.getSimpleName() + "[", "]");
    return joiner.toString();
  }

  public static StructureDefinition definition(NamespaceTable namespaceTable) {
    return new StructureDefinition(
        new NodeId(0, 15701), new NodeId(0, 22), StructureType.Structure, new StructureField[] {});
  }
}
