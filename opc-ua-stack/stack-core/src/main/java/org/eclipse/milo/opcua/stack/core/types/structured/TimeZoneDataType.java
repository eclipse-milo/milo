...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part3/8.28">https://reference.opcfoundation.org/v105/Core/docs/Part3/8.28</a>
 */
public class TimeZoneDataType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=8912");
  ...
  public static final class Codec extends GenericDataTypeCodec<TimeZoneDataType> {
    ...
    public TimeZoneDataType decodeType(EncodingContext context, UaDecoder decoder) {
      final Short offset;
      final Boolean daylightSavingInOffset;
      offset = decoder.decodeInt16("Offset");
      daylightSavingInOffset = decoder.decodeBoolean("DaylightSavingInOffset");
