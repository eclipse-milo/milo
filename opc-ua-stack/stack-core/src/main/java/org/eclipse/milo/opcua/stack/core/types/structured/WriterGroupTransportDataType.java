...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.6/#6.2.6.7.2">https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.6/#6.2.6.7.2</a>
 */
public abstract class WriterGroupTransportDataType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=15611");
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", WriterGroupTransportDataType.class.getSimpleName() + "[", "]");
