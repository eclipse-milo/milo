...
public class DeleteMonitoredItemsResponse extends Structure implements UaResponseMessageType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=782");
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", DeleteMonitoredItemsResponse.class.getSimpleName() + "[", "]");
  ...
  public static final class Codec extends GenericDataTypeCodec<DeleteMonitoredItemsResponse> {
    ...
    public void encodeType(
        EncodingContext context, UaEncoder encoder, DeleteMonitoredItemsResponse value) {
