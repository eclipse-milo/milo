...
public class AnnotationDataType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=32434");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=32560");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=32572");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=32584");
