...
public class QuantityDimension extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=32438");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=32562");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=32574");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=32586");
