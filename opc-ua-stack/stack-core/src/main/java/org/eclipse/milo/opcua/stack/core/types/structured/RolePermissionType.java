...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part3/5.2.9">https://reference.opcfoundation.org/v105/Core/docs/Part3/5.2.9</a>
 */
public class RolePermissionType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=96");
