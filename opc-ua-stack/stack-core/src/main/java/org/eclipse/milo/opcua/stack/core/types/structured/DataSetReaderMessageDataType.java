...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.9/#6.2.9.13.3">https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.9/#6.2.9.13.3</a>
 */
public abstract class DataSetReaderMessageDataType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=15629");
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", DataSetReaderMessageDataType.class.getSimpleName() + "[", "]");
