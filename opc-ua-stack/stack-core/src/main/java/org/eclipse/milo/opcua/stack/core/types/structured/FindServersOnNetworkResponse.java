...
public class FindServersOnNetworkResponse extends Structure implements UaResponseMessageType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=12191");
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", FindServersOnNetworkResponse.class.getSimpleName() + "[", "]");
  ...
  public static final class Codec extends GenericDataTypeCodec<FindServersOnNetworkResponse> {
    ...
    public void encodeType(
        EncodingContext context, UaEncoder encoder, FindServersOnNetworkResponse value) {
