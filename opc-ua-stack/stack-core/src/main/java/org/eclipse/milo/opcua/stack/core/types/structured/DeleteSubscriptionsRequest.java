...
public class DeleteSubscriptionsRequest extends Structure implements UaRequestMessageType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=845");
  ...
  public DeleteSubscriptionsRequest(
      RequestHeader requestHeader, UInteger @Nullable [] subscriptionIds) {
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", DeleteSubscriptionsRequest.class.getSimpleName() + "[", "]");
  ...
  public static final class Codec extends GenericDataTypeCodec<DeleteSubscriptionsRequest> {
    ...
    public void encodeType(
        EncodingContext context, UaEncoder encoder, DeleteSubscriptionsRequest value) {
