...
public class HistoryUpdateResponse extends Structure implements UaResponseMessageType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=701");
  ...
  public HistoryUpdateResponse(
      ...
      HistoryUpdateResult @Nullable [] results,
  ...
  public static final class Codec extends GenericDataTypeCodec<HistoryUpdateResponse> {
    ...
    public HistoryUpdateResponse decodeType(EncodingContext context, UaDecoder decoder) {
      ...
      final HistoryUpdateResult[] results;
      final DiagnosticInfo[] diagnosticInfos;
      responseHeader =
          (ResponseHeader) decoder.decodeStruct("ResponseHeader", ResponseHeader.TYPE_ID);
      results =
          (HistoryUpdateResult[]) decoder.decodeStructArray("Results", HistoryUpdateResult.TYPE_ID);
    ...
    public void encodeType(
        EncodingContext context, UaEncoder encoder, HistoryUpdateResponse value) {
