...
public class JsonActionResponseMessage extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=19322");
  ...
  public boolean equals(Object object) {
    ...
    JsonActionResponseMessage that = (JsonActionResponseMessage) object;
  ...
  public String toString() {
    var joiner = new StringJoiner(", ", JsonActionResponseMessage.class.getSimpleName() + "[", "]");
  ...
  public static final class Codec extends GenericDataTypeCodec<JsonActionResponseMessage> {
    @Override
    public Class<JsonActionResponseMessage> getType() {
      return JsonActionResponseMessage.class;
    }

    @Override
    public JsonActionResponseMessage decodeType(EncodingContext context, UaDecoder decoder) {
    ...
    public void encodeType(
        EncodingContext context, UaEncoder encoder, JsonActionResponseMessage value) {
