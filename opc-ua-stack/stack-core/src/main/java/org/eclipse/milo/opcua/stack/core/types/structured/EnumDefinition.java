...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part3/8.50">https://reference.opcfoundation.org/v105/Core/docs/Part3/8.50</a>
 */
public class EnumDefinition extends DataTypeDefinition implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=100");
  ...
  public static final class Codec extends GenericDataTypeCodec<EnumDefinition> {
    ...
    public EnumDefinition decodeType(EncodingContext context, UaDecoder decoder) {
      final EnumField[] fields;
      fields = (EnumField[]) decoder.decodeStructArray("Fields", EnumField.TYPE_ID);
