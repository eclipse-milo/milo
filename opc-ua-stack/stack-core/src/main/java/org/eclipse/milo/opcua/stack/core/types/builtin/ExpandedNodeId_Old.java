...
//
//  /**
//   * @return {@code true} if this {@link ExpandedNodeId} is absolute, i.e. it specifies a
// namespace
...
//
//  /**
//   * @return {@code true} if this {@link ExpandedNodeId} is relative, i.e. it specifies a
// namespace
...
//        ExpandedNodeId xni = new ExpandedNodeId(UShort.MIN, namespaceUri, identifier,
// serverIndex);
//
...
//   *
//   * <p>A relative ExpandedNodeId is one that defines the namespace index rather than namespace
// URI.
//   *
//   * <p>Returns {@link Optional#empty()} if the URI is not found in the namespace table.
//   *
...
//
//  /**
//   * Like {@link #toNodeId(NamespaceTable)}, but throws if the node is not local or the namespace
// is
//   * not registered.
//   *
//   * @param namespaceTable the {@link NamespaceTable}.
...
//   *
//   * @param nodeId the {@link NodeId} to check equality against.
//   * @param namespaceTable the {@link NamespaceTable} used to look up the index of a namespace
// URI.
//   * @return {@code true} if this {@link ExpandedNodeId} is equal to {@code nodeId}.
...
//    }
//
//    if (namespaceUri != null && !namespaceUri.equals(Namespaces.OPC_UA)) {
