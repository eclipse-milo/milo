...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part4/7.24.8">https://reference.opcfoundation.org/v105/Core/docs/Part4/7.24.8</a>
 */
public class DataTypeAttributes extends NodeAttributes implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=370");
