...
public class SortRuleElement extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=18648");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=18650");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=18652");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=18654");
