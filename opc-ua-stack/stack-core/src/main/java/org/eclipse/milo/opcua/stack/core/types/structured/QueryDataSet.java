...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part4/B.2.5">https://reference.opcfoundation.org/v105/Core/docs/Part4/B.2.5</a>
 */
public class QueryDataSet extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=577");
