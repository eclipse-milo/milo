...
abstract class NodeIds3 extends NodeIds4 {
  ...
  public static final NodeId
      AlarmSuppressionGroupType_AlarmCondition_Placeholder_AckedState_Number =
          new NodeId(UShort.MIN, uint(21148));
