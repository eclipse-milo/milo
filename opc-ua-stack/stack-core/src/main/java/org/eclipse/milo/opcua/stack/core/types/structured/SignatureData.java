...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part4/7.36">https://reference.opcfoundation.org/v105/Core/docs/Part4/7.36</a>
 */
public class SignatureData extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=456");
