...
public class DeleteSubscriptionsResponse extends Structure implements UaResponseMessageType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=848");
  ...
  public String toString() {
    var joiner =
        new StringJoiner(", ", DeleteSubscriptionsResponse.class.getSimpleName() + "[", "]");
  ...
  public static final class Codec extends GenericDataTypeCodec<DeleteSubscriptionsResponse> {
    ...
    public void encodeType(
        EncodingContext context, UaEncoder encoder, DeleteSubscriptionsResponse value) {
