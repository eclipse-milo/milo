...
public class ActionTargetDataType extends Structure implements UaStructuredType {
  public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=18593");

  public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=18598");

  public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=18610");

  public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=18622");
