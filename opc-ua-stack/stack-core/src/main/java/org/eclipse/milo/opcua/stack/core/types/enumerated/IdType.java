...
/**
 * @see <a
 *     href="https://reference.opcfoundation.org/v105/Core/docs/Part3/8.2.3">https://reference.opcfoundation.org/v105/Core/docs/Part3/8.2.3</a>
 */
public enum IdType implements UaEnumeratedType {
  ...
  public static final class TypeInfo {
    public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("i=256");
  }
}
