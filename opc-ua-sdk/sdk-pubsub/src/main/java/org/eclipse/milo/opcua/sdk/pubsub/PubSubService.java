...
public interface PubSubService extends AutoCloseable {
   ...
   * writers are all Disabled, paused outside an active parent writer group, or not yet constructed,
   * is dropped. Enabled writers paused under a PreOperational or recoverable Error writer group
   * still buffer events, e.g. while a secured group waits for keys.
   *
