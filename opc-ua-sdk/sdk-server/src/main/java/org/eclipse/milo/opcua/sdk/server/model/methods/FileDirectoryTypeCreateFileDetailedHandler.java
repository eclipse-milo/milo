 ...
 */
@FunctionalInterface
public interface FileDirectoryTypeCreateFileDetailedHandler {
  /**
   ...
   * @param fileName the input value; supplied null is retained
   * @param requestFileOpen the input value; supplied null is retained
