...
public class OrderedListTypeNode extends BaseObjectTypeNode implements OrderedListType {
  ...
  @Override
  public @Nullable PropertyTypeNode getNodeVersionNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "NodeVersion");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:NodeVersion (declaration"
  ...
  @Override
  public @Nullable String getNodeVersionProperty() {
    var node = getNodeVersionNode();
    if (node == null) {
      throw new UaRuntimeException(
  ...
  @Override
  public void setNodeVersionProperty(@Nullable String value) {
    var node = getNodeVersionNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
