 ...
 */
@FunctionalInterface
public interface SecurityGroupFolderTypeRemoveSecurityGroupFolderDetailedHandler {
  /**
   ...
   * @param securityGroupFolderNodeId the input value; supplied null is retained
