...
public class AuditConditionAcknowledgeEventTypeNode extends AuditConditionEventTypeNode
  ...
  public PropertyTypeNode getConditionEventIdNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ConditionEventId");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ConditionEventId (declaration"
  ...
  public @Nullable ByteString getConditionEventId() {
    var node = getConditionEventIdNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ConditionEventId (declaration i=17223, owner i=8944)"
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:Comment (declaration i=11853,"
                    + " owner i=8944) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
