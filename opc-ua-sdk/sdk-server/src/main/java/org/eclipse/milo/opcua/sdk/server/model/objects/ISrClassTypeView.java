 ...
 */
@NullMarked
public final class ISrClassTypeView extends ServerObjectView implements ISrClassType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<ISrClassType> TYPE =
      ServerViewType.of(ExpandedNodeId.parse("i=24169"), ISrClassType.class, ISrClassTypeView::new);
  ...
  private ISrClassTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "Vid");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
