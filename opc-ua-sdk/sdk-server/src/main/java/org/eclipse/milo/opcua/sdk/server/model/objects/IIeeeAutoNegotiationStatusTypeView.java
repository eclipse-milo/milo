 ...
 */
@NullMarked
public final class IIeeeAutoNegotiationStatusTypeView extends ServerObjectView
    implements IIeeeAutoNegotiationStatusType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIeeeAutoNegotiationStatusType> TYPE =
      ServerViewType.of(
  ...
  private IIeeeAutoNegotiationStatusTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "NegotiationStatus");
   ...
   */
  @Override
  public BaseDataVariableType getNegotiationStatusNode() {
