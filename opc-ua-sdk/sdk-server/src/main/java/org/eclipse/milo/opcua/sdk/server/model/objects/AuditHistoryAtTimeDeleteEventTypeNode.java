...
public class AuditHistoryAtTimeDeleteEventTypeNode extends AuditHistoryDeleteEventTypeNode
  ...
  public PropertyTypeNode getReqTimesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ReqTimes");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ReqTimes (declaration i=3020,"
                    + " owner i=3019) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable DateTime @Nullable [] getReqTimes() {
    var node = getReqTimesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ReqTimes (declaration i=3020, owner i=3019)"
  ...
  @Override
  public void setReqTimes(@Nullable DateTime @Nullable [] value) {
    var node = getReqTimesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:OldValues (declaration i=3021,"
                    + " owner i=3019) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
