...
public class NonExclusiveRateOfChangeAlarmTypeNode extends NonExclusiveLimitAlarmTypeNode
  ...
  @Override
  public @Nullable EUInformation getEngineeringUnits() {
    return ServerNodeSupport.read(this, getEngineeringUnitsNode(), EUInformation.class, null);
  }

  @Override
  public void setEngineeringUnits(@Nullable EUInformation value) {
  ...
  @Override
  public void setMethods(NonExclusiveRateOfChangeAlarmType.@Nullable Methods methods) {
