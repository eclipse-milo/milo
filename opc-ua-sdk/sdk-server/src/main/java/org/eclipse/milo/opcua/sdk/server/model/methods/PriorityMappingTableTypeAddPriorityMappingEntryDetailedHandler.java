 ...
 */
@FunctionalInterface
public interface PriorityMappingTableTypeAddPriorityMappingEntryDetailedHandler {
  /**
   ...
   * @param mappingUri the input value; supplied null is retained
   * @param priorityLabel the input value; supplied null is retained
   * @param priorityValuePcp the input value; supplied null is retained
   * @param priorityValueDscp the input value; supplied null is retained
