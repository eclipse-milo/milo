 ...
 */
@NullMarked
public final class IIetfBaseNetworkInterfaceTypeView extends ServerObjectView
    implements IIetfBaseNetworkInterfaceType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIetfBaseNetworkInterfaceType> TYPE =
      ServerViewType.of(
  ...
  private IIetfBaseNetworkInterfaceTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "AdminStatus");
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "OperStatus");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
        ...
        ((Supplier<@Nullable UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "PhysAddress");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
   ...
   */
  @Override
  public @Nullable BaseDataVariableType getPhysAddressNode() {
    this.views.checkOpen();
    views.checkOpen();
