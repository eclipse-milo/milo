...
public class AuditConditionShelvingEventTypeNode extends AuditConditionEventTypeNode
  ...
  @Override
  public @Nullable PropertyTypeNode getShelvingTimeNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ShelvingTime");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ShelvingTime (declaration"
                    + " i=11855, owner i=11093) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable Double getShelvingTime() {
    var node = getShelvingTimeNode();
    if (node == null) {
      throw new UaRuntimeException(
  ...
  @Override
  public void setShelvingTime(@Nullable Double value) {
    var node = getShelvingTimeNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
