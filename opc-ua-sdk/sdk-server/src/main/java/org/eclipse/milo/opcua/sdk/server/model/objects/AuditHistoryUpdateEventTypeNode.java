...
public class AuditHistoryUpdateEventTypeNode extends AuditUpdateEventTypeNode
  ...
  public PropertyTypeNode getParameterDataTypeIdNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ParameterDataTypeId");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ParameterDataTypeId"
  ...
  @Override
  public @Nullable NodeId getParameterDataTypeId() {
    var node = getParameterDataTypeIdNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ParameterDataTypeId (declaration i=2751, owner i=2104)"
  ...
  @Override
  public void setParameterDataTypeId(@Nullable NodeId value) {
    var node = getParameterDataTypeIdNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
