...
public class CertificateGroupTypeNode extends BaseObjectTypeNode implements CertificateGroupType {
  ...
  public MethodBinding bindGetRejectedList(
      MethodBindings bindings, CertificateGroupType.GetRejectedListHandler handler)
      throws UaException {
  ...
  public MethodBinding bindGetRejectedListDetailed(
      MethodBindings bindings, CertificateGroupType.GetRejectedListDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetRejectedListMethodNode();
