...
import org.eclipse.milo.opcua.sdk.server.model.methods.CertificateGroupTypeGetRejectedListDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.CertificateGroupTypeGetRejectedListHandler;
...
public class CertificateGroupTypeNode extends BaseObjectTypeNode implements CertificateGroupType {
  ...
  public @Nullable PropertyTypeNode getPurposeNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "Purpose");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:Purpose (declaration i=19398,"
                    + " owner i=12555) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
  ...
  public TrustListTypeNode getTrustListNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:TrustList (declaration i=13599, owner i=12555)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "TrustList");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:TrustList (declaration"
    ...
    if (!(parent instanceof TrustListTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:TrustList (declaration i=13599, owner i=12555)"
              + " on "
    ...
    return (TrustListTypeNode) parent;
  }
  ...
  public @Nullable CertificateExpirationAlarmTypeNode getCertificateExpiredNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:CertificateExpired (declaration i=19450, owner i=12555)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "CertificateExpired");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:CertificateExpired"
    ...
    if (!(parent instanceof CertificateExpirationAlarmTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:CertificateExpired (declaration i=19450, owner i=12555)"
              + " on "
    ...
    return (CertificateExpirationAlarmTypeNode) parent;
  }
  ...
  public @Nullable TrustListOutOfDateAlarmTypeNode getTrustListOutOfDateNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:TrustListOutOfDate (declaration i=20143, owner i=12555)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "TrustListOutOfDate");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:TrustListOutOfDate"
    ...
    if (!(parent instanceof TrustListOutOfDateAlarmTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:TrustListOutOfDate (declaration i=20143, owner i=12555)"
              + " on "
    ...
    return (TrustListOutOfDateAlarmTypeNode) parent;
  }
  ...
  public @Nullable UaMethodNode getGetRejectedListMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:GetRejectedList (declaration i=23526, owner i=12555)"
                + " on "
                + getNodeId());
      }
  ...
  public MethodBinding bindGetRejectedList(
      MethodBindings bindings, CertificateGroupTypeGetRejectedListHandler handler)
      throws UaException {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument Certificates (effective property i=23527, DataType i=15)"
  ...
  public MethodBinding bindGetRejectedListDetailed(
      MethodBindings bindings, CertificateGroupTypeGetRejectedListDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetRejectedListMethodNode();
