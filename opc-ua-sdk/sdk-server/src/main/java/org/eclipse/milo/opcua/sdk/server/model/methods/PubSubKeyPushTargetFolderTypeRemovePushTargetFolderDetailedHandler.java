 ...
 */
@FunctionalInterface
public interface PubSubKeyPushTargetFolderTypeRemovePushTargetFolderDetailedHandler {
  /**
   ...
   * @param pushTargetFolderNodeId the input value; supplied null is retained
