...
import org.eclipse.milo.opcua.sdk.server.model.methods.PubSubKeyServiceTypeGetSecurityGroupDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PubSubKeyServiceTypeGetSecurityGroupHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PubSubKeyServiceTypeGetSecurityKeysDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PubSubKeyServiceTypeGetSecurityKeysHandler;
...
public class PubSubKeyServiceTypeNode extends BaseObjectTypeNode implements PubSubKeyServiceType {
  ...
  public @Nullable UaMethodNode getGetSecurityKeysMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "GetSecurityKeys");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:GetSecurityKeys (declaration"
                    + " i=15907, owner i=15906) on "
                    + getNodeId());
          }
  ...
  @Override
  public MethodBinding bindGetSecurityKeys(
      MethodBindings bindings, PubSubKeyServiceTypeGetSecurityKeysHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetSecurityKeysMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            try {
              PubSubKeyServiceTypeGetSecurityKeysOutputs outputs =
              ...
              Variant outputValue0;
              {
                ...
                {
                  Object methodValue = outputs.securityPolicyUri();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument SecurityPolicyUri (effective property i=15909, DataType"
                              + " i=12) is unavailable in the effective type tree; resolved"
                              + " DataType: "
                              + argumentDataTypeId);
                    }
              ...
              Variant outputValue1;
              {
                ...
                {
                  Object methodValue = outputs.firstTokenId();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument FirstTokenId (effective property i=15909, DataType"
                              + " i=288) is unavailable in the effective type tree; resolved"
                              + " DataType: "
                              + argumentDataTypeId);
                    }
                    Object numericElements =
              ...
              Variant outputValue2;
              {
                ...
                {
                  Object methodValue = outputs.keys();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument Keys (effective property i=15909, DataType i=15) is"
              ...
              Variant outputValue3;
              {
                ...
                {
                  Object methodValue = outputs.timeToNextKey();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument TimeToNextKey (effective property i=15909, DataType"
                              + " i=290) is unavailable in the effective type tree; resolved"
                              + " DataType: "
                              + argumentDataTypeId);
                    }
                    Object numericElements =
              ...
              Variant outputValue4;
              {
                @Nullable Double convertedValue;
                {
                  Object methodValue = outputs.keyLifetime();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument KeyLifetime (effective property i=15909, DataType i=290)"
                ...
                try {
                  ...
                  wireValue =
                      ExtensionObject.encodeValue(
                          context.getServer().getStaticEncodingContext(), wireValue);
                  outputValue4 = Variant.of(wireValue);
                } catch (UaSerializationException encodingFailure) {
                  throw new UaException(
                      encodingFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                          ? StatusCodes.Bad_OutOfRange
              ...
              return new CallMethodResult(
                  ...
                  new Variant[] {
                    outputValue0, outputValue1, outputValue2, outputValue3, outputValue4
                  });
  ...
  @Override
  public MethodBinding bindGetSecurityKeysDetailed(
      MethodBindings bindings, PubSubKeyServiceTypeGetSecurityKeysDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetSecurityKeysMethodNode();
  ...
  public @Nullable UaMethodNode getGetSecurityGroupMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "GetSecurityGroup");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:GetSecurityGroup (declaration"
                    + " i=15910, owner i=15906) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public MethodBinding bindGetSecurityGroup(
      MethodBindings bindings, PubSubKeyServiceTypeGetSecurityGroupHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetSecurityGroupMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
                ...
                @Nullable NodeId convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument SecurityGroupNodeId (effective property i=15912,"
  ...
  @Override
  public MethodBinding bindGetSecurityGroupDetailed(
      MethodBindings bindings, PubSubKeyServiceTypeGetSecurityGroupDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetSecurityGroupMethodNode();
  ...
  public @Nullable SecurityGroupFolderTypeNode getSecurityGroupsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SecurityGroups");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:SecurityGroups (declaration"
                    + " i=15913, owner i=15906) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
    ...
    if (!(parent instanceof SecurityGroupFolderTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:SecurityGroups (declaration i=15913, owner i=15906)"
              + " on "
    ...
    return (SecurityGroupFolderTypeNode) parent;
  }
  ...
  public @Nullable PubSubKeyPushTargetFolderTypeNode getKeyPushTargetsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "KeyPushTargets");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:KeyPushTargets (declaration"
                    + " i=25277, owner i=15906) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
    ...
    if (!(parent instanceof PubSubKeyPushTargetFolderTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:KeyPushTargets (declaration i=25277, owner i=15906)"
              + " on "
    ...
    return (PubSubKeyPushTargetFolderTypeNode) parent;
  }
}
