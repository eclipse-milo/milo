...
public class CertificateUpdatedAuditEventTypeNode extends AuditUpdateMethodEventTypeNode
  ...
  public PropertyTypeNode getCertificateGroupNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "CertificateGroup");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:CertificateGroup (declaration"
  ...
  @Override
  public @Nullable NodeId getCertificateGroup() {
    var node = getCertificateGroupNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:CertificateGroup (declaration i=13735, owner i=12620)"
  ...
  @Override
  public void setCertificateGroup(@Nullable NodeId value) {
    var node = getCertificateGroupNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
