...
/**
 * Server API for the AuditSessionEventType ObjectType.
 *
...
public interface AuditSessionEventType extends AuditSecurityEventType {
  ...
  /**
   * Returns the mandatory SessionId child, a PropertyType with DataType NodeId.
   *
   * @throws UaRuntimeException if the child is absent, ambiguous or incompatible.
   * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part5/7.3">PropertyType
   *     documentation</a>
   */
  PropertyTypeNode getSessionIdNode();
