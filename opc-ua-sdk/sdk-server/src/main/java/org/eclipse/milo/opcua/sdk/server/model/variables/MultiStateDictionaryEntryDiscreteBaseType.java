...
public interface MultiStateDictionaryEntryDiscreteBaseType extends MultiStateValueDiscreteType {
  ...
  @Nullable Object getEnumDictionaryEntries();

  /** Sets the existing node's local value. */
  void setEnumDictionaryEntries(@Nullable Object value);
  ...
  /** Gets the existing node's local value. */
  @Nullable NodeId @Nullable [] getValueAsDictionaryEntries();

  /** Sets the existing node's local value. */
  void setValueAsDictionaryEntries(@Nullable NodeId @Nullable [] value);
   ...
   */
  @Nullable PropertyType getValueAsDictionaryEntriesNode();
}
