...
public class AuditAddNodesEventTypeNode extends AuditNodeManagementEventTypeNode
  ...
  public PropertyTypeNode getNodesToAddNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "NodesToAdd");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:NodesToAdd (declaration"
  ...
  @Override
  public @Nullable AddNodesItem @Nullable [] getNodesToAdd() {
    var node = getNodesToAddNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NodesToAdd (declaration i=2092, owner i=2091)"
    ...
    AddNodesItem[] typed = new AddNodesItem[elements.length];
    for (int i = 0; i < elements.length; i++) {
      if (elements[i] != null && !(elements[i] instanceof AddNodesItem)) {
        throw new UaRuntimeException(
            StatusCodes.Bad_TypeMismatch,
            "http://opcfoundation.org/UA/:NodesToAdd (declaration i=2092, owner i=2091)");
      }
      typed[i] = (AddNodesItem) elements[i];
    }
    return typed;
  }

  @Override
  public void setNodesToAdd(@Nullable AddNodesItem @Nullable [] value) {
    var node = getNodesToAddNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
