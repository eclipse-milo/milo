...
public class OptionSetTypeNode extends BaseDataVariableTypeNode implements OptionSetType {
  ...
  public PropertyTypeNode getOptionSetValuesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "OptionSetValues");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:OptionSetValues (declaration"
                    + " i=11488, owner i=11487) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable LocalizedText @Nullable [] getOptionSetValues() {
    var node = getOptionSetValuesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:OptionSetValues (declaration i=11488, owner i=11487)"
  ...
  @Override
  public void setOptionSetValues(@Nullable LocalizedText @Nullable [] value) {
    var node = getOptionSetValuesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
  ...
  public @Nullable PropertyTypeNode getBitMaskNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "BitMask");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:BitMask (declaration i=11701,"
                    + " owner i=11487) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
  ...
  @Override
  public @Nullable Boolean @Nullable [] getBitMask() {
    var node = getBitMaskNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:BitMask (declaration i=11701, owner i=11487)"
  ...
  @Override
  public void setBitMask(@Nullable Boolean @Nullable [] value) {
    var node = getBitMaskNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
