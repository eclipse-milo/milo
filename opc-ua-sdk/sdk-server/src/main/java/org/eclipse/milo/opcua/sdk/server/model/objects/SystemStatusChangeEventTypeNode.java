...
public class SystemStatusChangeEventTypeNode extends SystemEventTypeNode
  ...
  public PropertyTypeNode getSystemStateNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SystemState");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SystemState (declaration"
                    + " i=11696, owner i=11446) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable ServerState getSystemState() {
    var node = getSystemStateNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SystemState (declaration i=11696, owner i=11446)"
  ...
  @Override
  public void setSystemState(@Nullable ServerState value) {
    var node = getSystemStateNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
