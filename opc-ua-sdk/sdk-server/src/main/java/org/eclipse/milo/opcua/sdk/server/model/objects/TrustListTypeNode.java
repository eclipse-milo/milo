...
public class TrustListTypeNode extends FileTypeNode implements TrustListType {
  ...
  public MethodBinding bindOpenWithMasks(
      MethodBindings bindings, TrustListType.OpenWithMasksHandler handler) throws UaException {
  ...
  public MethodBinding bindOpenWithMasksDetailed(
      MethodBindings bindings, TrustListType.OpenWithMasksDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getOpenWithMasksMethodNode();
  ...
  public MethodBinding bindCloseAndUpdate(
      MethodBindings bindings, TrustListType.CloseAndUpdateHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindCloseAndUpdateDetailed(
      MethodBindings bindings, TrustListType.CloseAndUpdateDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getCloseAndUpdateMethodNode();
  ...
  public MethodBinding bindAddCertificate(
      MethodBindings bindings, TrustListType.AddCertificateHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindAddCertificateDetailed(
      MethodBindings bindings, TrustListType.AddCertificateDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddCertificateMethodNode();
  ...
  public MethodBinding bindRemoveCertificate(
      MethodBindings bindings, TrustListType.RemoveCertificateHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindRemoveCertificateDetailed(
      MethodBindings bindings, TrustListType.RemoveCertificateDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveCertificateMethodNode();
