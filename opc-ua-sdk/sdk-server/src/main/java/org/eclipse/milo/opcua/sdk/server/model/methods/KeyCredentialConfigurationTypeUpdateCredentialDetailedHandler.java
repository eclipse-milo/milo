 ...
 */
@FunctionalInterface
public interface KeyCredentialConfigurationTypeUpdateCredentialDetailedHandler {
  /**
   ...
   * @param credentialId the input value; supplied null is retained
   * @param credentialSecret the input value; supplied null is retained
   * @param certificateThumbprint the input value; supplied null is retained
