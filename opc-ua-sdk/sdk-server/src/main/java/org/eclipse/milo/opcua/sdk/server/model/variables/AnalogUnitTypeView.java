...
import com.digitalpetri.opcua.uanodeset.runtime.server.ServerVariableView;
import com.digitalpetri.opcua.uanodeset.runtime.server.ServerVariableViewType;
 ...
 * from a ServerViews context using {@link #TYPE}; the token itself does not prove membership.
 * Access after context close fails with IllegalStateException.
 */
@NullMarked
public final class AnalogUnitTypeView extends ServerVariableView implements AnalogUnitType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerVariableViewType<AnalogUnitType> TYPE =
      ServerVariableViewType.of(
  ...
  private AnalogUnitTypeView(ServerViews views, UaVariableNode node) {
    super(views, node);
  }

  private @Nullable UaVariableNode viewMember0() {
    views.checkOpen();
    var resolvedMember =
  ...
  private @Nullable UaVariableNode viewMember1() {
    views.checkOpen();
    var resolvedMember =
        ((Supplier<@Nullable UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "ValuePrecision");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
  ...
  private @Nullable UaVariableNode viewMember4() {
    views.checkOpen();
    var resolvedMember =
        ((Supplier<@Nullable UaVariableNode>)
                () -> {
  ...
  private @Nullable UaVariableNode viewMember5() {
    views.checkOpen();
    var resolvedMember =
        ((Supplier<@Nullable UaVariableNode>)
                () -> {
  ...
  private UaVariableNode viewMember6() {
    views.checkOpen();
    var resolvedMember =
  ...
  @Override
  public @Nullable PropertyType getDefinitionNode() {
    this.views.checkOpen();
    views.checkOpen();
    var child = viewMember0();
    return child == null ? null : views.wrapVariable(child.getNodeId(), PropertyTypeView.TYPE);
  }
  ...
  @Override
  public @Nullable PropertyType getValuePrecisionNode() {
    this.views.checkOpen();
    views.checkOpen();
  ...
  @Override
  public @Nullable PropertyType getInstrumentRangeNode() {
    this.views.checkOpen();
    views.checkOpen();
  ...
  @Override
  public @Nullable PropertyType getInstrumentNumberRangeNode() {
    this.views.checkOpen();
    views.checkOpen();
  ...
  @Override
  public @Nullable PropertyType getEuRangeNode() {
    this.views.checkOpen();
    views.checkOpen();
  ...
  @Override
  public @Nullable PropertyType getEuNumberRangeNode() {
    this.views.checkOpen();
    views.checkOpen();
  ...
  @Override
  public PropertyType getEngineeringUnitsNode() {
    this.views.checkOpen();
    views.checkOpen();
