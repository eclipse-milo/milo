 ...
 */
@FunctionalInterface
public interface DataSetReaderTypeCreateDataSetMirrorDetailedHandler {
  /**
   ...
   * @param parentNodeName the input value; supplied null is retained
   * @param rolePermissions the input value; supplied null is retained
