 ...
 */
@FunctionalInterface
public interface UserManagementTypeModifyUserDetailedHandler {
  /**
   ...
   * @param modifyPassword the input value; supplied null is retained
   * @param password the input value; supplied null is retained
   * @param modifyUserConfiguration the input value; supplied null is retained
   * @param userConfiguration the input value; supplied null is retained
   * @param modifyDescription the input value; supplied null is retained
