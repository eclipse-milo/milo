...
public class PubSubStatusTypeNode extends BaseObjectTypeNode implements PubSubStatusType {
  ...
  @Override
  public MethodBinding bindEnable(MethodBindings bindings, PubSubStatusType.EnableHandler handler)
      throws UaException {
  ...
  public MethodBinding bindEnableDetailed(
      MethodBindings bindings, PubSubStatusType.EnableDetailedHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getEnableMethodNode();
    if (methodNode == null) {
  ...
  @Override
  public MethodBinding bindDisable(MethodBindings bindings, PubSubStatusType.DisableHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindDisableDetailed(
      MethodBindings bindings, PubSubStatusType.DisableDetailedHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getDisableMethodNode();
    if (methodNode == null) {
