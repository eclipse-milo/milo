...
import org.eclipse.milo.opcua.sdk.server.model.methods.AddressSpaceFileTypeExportNamespaceDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.AddressSpaceFileTypeExportNamespaceHandler;
...
public interface AddressSpaceFileType extends FileType {
  ...
  /**
   * Binds a synchronous callback for this ObjectId through the supplied registry. The Method must
   * already exist and have compatible effective metadata; binding does not create nodes or rewrite
   * argument properties. Replacing this ObjectId does not replace another owner's registration.
   *
   ...
   *     the Method
   */
  MethodBinding bindExportNamespace(
      MethodBindings bindings, AddressSpaceFileTypeExportNamespaceHandler handler)
      throws UaException;
  ...
  MethodBinding bindExportNamespaceDetailed(
      MethodBindings bindings, AddressSpaceFileTypeExportNamespaceDetailedHandler handler)
      throws UaException;
}
