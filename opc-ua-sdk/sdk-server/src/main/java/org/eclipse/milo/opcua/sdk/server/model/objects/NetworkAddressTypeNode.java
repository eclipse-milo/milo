...
public class NetworkAddressTypeNode extends BaseObjectTypeNode implements NetworkAddressType {
  ...
  public SelectionListTypeNode getNetworkInterfaceNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "NetworkInterface");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:NetworkInterface (declaration"
  ...
  public @Nullable String getNetworkInterface() {
    var node = getNetworkInterfaceNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NetworkInterface (declaration i=21146, owner i=21145)"
