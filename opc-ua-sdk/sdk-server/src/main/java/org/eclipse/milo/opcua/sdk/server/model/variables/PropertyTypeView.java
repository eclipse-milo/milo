 ...
 *
 * <p>Selected <code>PropertyType</code> contract over one retained backing node. Obtain this view
 ...
 */
@NullMarked
public final class PropertyTypeView extends ServerVariableView implements PropertyType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerVariableViewType<PropertyType> TYPE =
      ServerVariableViewType.of(
          ExpandedNodeId.parse("i=68"), PropertyType.class, PropertyTypeView::new);
  ...
  private PropertyTypeView(ServerViews views, UaVariableNode node) {
    super(views, node);
  }
}
