 ...
 */
@NullMarked
public final class IIeeeTsnInterfaceConfigurationTypeView extends ServerObjectView
    implements IIeeeTsnInterfaceConfigurationType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIeeeTsnInterfaceConfigurationType> TYPE =
      ServerViewType.of(
  ...
  private IIeeeTsnInterfaceConfigurationTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
