...
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishedDataItemsTypeAddVariablesDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishedDataItemsTypeAddVariablesHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishedDataItemsTypeRemoveVariablesDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishedDataItemsTypeRemoveVariablesHandler;
...
public class PublishedDataItemsTypeNode extends PublishedDataSetTypeNode
  ...
  public PropertyTypeNode getPublishedDataNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "PublishedData");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:PublishedData (declaration"
  ...
  public @Nullable PublishedVariableDataType @Nullable [] getPublishedData() {
    ...
    PublishedVariableDataType[] typed = new PublishedVariableDataType[elements.length];
    for (int i = 0; i < elements.length; i++) {
      if (elements[i] != null && !(elements[i] instanceof PublishedVariableDataType)) {
        throw new UaRuntimeException(
            StatusCodes.Bad_TypeMismatch,
            "http://opcfoundation.org/UA/:PublishedData (declaration i=14548, owner i=14534)");
      }
      typed[i] = (PublishedVariableDataType) elements[i];
    }
    return typed;
  }
  ...
  public @Nullable UaMethodNode getAddVariablesMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:AddVariables (declaration i=14555, owner i=14534)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "AddVariables");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:AddVariables (declaration"
  ...
  @Override
  public MethodBinding bindAddVariables(
      MethodBindings bindings, PublishedDataItemsTypeAddVariablesHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddVariablesMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            @Nullable Boolean @Nullable [] callbackInput2 = null;
            if (inputValues.length > 2) {
              try {
                @Nullable Boolean @Nullable [] convertedInput2;
                {
                  ...
                  try {
                    ...
                    if (methodValue == null) {
                      ...
                      convertedInput2 = new Boolean[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < convertedInput2.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        convertedInput2[valueIndex] = (Boolean) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                ...
                @Nullable Boolean @Nullable [] projectedInput2;
                {
                  Object methodValue = inputValues[2].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    if (methodValue == null) {
                      ...
                      projectedInput2 = new Boolean[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < projectedInput2.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        projectedInput2[valueIndex] = (Boolean) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
            ...
            try {
              PublishedDataItemsTypeAddVariablesOutputs outputs =
                  handler.invoke(
              ...
              Variant outputValue0;
              {
                ...
                {
                  Object methodValue = outputs.newConfigurationVersion();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument NewConfigurationVersion (effective property i=14557,"
                ...
                @Nullable StatusCode @Nullable [] convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument AddResults (effective property i=14557, DataType i=19)"
  ...
  @Override
  public MethodBinding bindAddVariablesDetailed(
      MethodBindings bindings, PublishedDataItemsTypeAddVariablesDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddVariablesMethodNode();
  ...
  public @Nullable UaMethodNode getRemoveVariablesMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:RemoveVariables (declaration i=14558, owner i=14534)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "RemoveVariables");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:RemoveVariables (declaration"
                    + " i=14558, owner i=14534) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public MethodBinding bindRemoveVariables(
      MethodBindings bindings, PublishedDataItemsTypeRemoveVariablesHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveVariablesMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            @Nullable UInteger @Nullable [] callbackInput1 = null;
            if (inputValues.length > 1) {
              try {
                @Nullable UInteger @Nullable [] convertedInput1;
                {
                  Object methodValue = inputValues[1].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    if (methodValue == null) {
                      ...
                      convertedInput1 = new UInteger[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < convertedInput1.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        convertedInput1[valueIndex] = (UInteger) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                ...
                @Nullable UInteger @Nullable [] projectedInput1;
                {
                  Object methodValue = inputValues[1].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    if (methodValue == null) {
                      ...
                      projectedInput1 = new UInteger[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < projectedInput1.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        projectedInput1[valueIndex] = (UInteger) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
            ...
            try {
              PublishedDataItemsTypeRemoveVariablesOutputs outputs =
                ...
                @Nullable ConfigurationVersionDataType convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument NewConfigurationVersion (effective property i=14560,"
                              + " DataType i=14593) is unavailable in the effective type tree;"
                              + " resolved DataType: "
                              + argumentDataTypeId);
                    }
              ...
              Variant outputValue1;
              {
                @Nullable StatusCode @Nullable [] convertedValue;
                {
                  Object methodValue = outputs.removeResults();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument RemoveResults (effective property i=14560, DataType"
  ...
  @Override
  public MethodBinding bindRemoveVariablesDetailed(
      MethodBindings bindings, PublishedDataItemsTypeRemoveVariablesDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveVariablesMethodNode();
