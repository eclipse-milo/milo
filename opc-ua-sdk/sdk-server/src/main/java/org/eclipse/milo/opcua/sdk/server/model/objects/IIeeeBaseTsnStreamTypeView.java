 ...
 */
@NullMarked
public final class IIeeeBaseTsnStreamTypeView extends ServerObjectView
    implements IIeeeBaseTsnStreamType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIeeeBaseTsnStreamType> TYPE =
      ServerViewType.of(
  ...
  private IIeeeBaseTsnStreamTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
   ...
   */
  @Override
  public @Nullable BaseDataVariableType getAccumulatedLatencyNode() {
    this.views.checkOpen();
    views.checkOpen();
   ...
   */
  @Override
  public @Nullable BaseDataVariableType getSrClassIdNode() {
    this.views.checkOpen();
    views.checkOpen();
