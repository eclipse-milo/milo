 ...
 */
@FunctionalInterface
public interface ServerConfigurationTypeCreateSigningRequestDetailedHandler {
  /**
   ...
   * @param regeneratePrivateKey the input value; supplied null is retained
   * @param nonce the input value; supplied null is retained
