 ...
 */
@FunctionalInterface
public interface AlarmConditionTypeGetGroupMembershipsHandler {
  /**
   ...
   */
  @Nullable NodeId @Nullable [] invoke(AbstractMethodInvocationHandler.InvocationContext context)
      throws UaException;
}
