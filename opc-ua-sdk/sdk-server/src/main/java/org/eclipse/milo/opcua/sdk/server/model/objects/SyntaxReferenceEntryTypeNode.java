...
public class SyntaxReferenceEntryTypeNode extends DictionaryEntryTypeNode
  ...
  @Override
  public PropertyTypeNode getCommonNameNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "CommonName");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:CommonName (declaration"
