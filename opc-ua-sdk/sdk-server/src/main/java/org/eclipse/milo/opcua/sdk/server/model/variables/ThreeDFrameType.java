...
public interface ThreeDFrameType extends FrameType {
  ...
  @Nullable ThreeDCartesianCoordinates getCartesianCoordinates();

  /** Sets the existing node's local value. */
  void setCartesianCoordinates(@Nullable ThreeDCartesianCoordinates value);
  ...
  /** Gets the existing node's local value. */
  @Nullable ThreeDOrientation getOrientation();

  /** Sets the existing node's local value. */
  void setOrientation(@Nullable ThreeDOrientation value);
}
