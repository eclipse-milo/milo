...
public class IIeeeTsnInterfaceConfigurationTalkerTypeNode
  ...
  @Override
  public @Nullable BaseDataVariableTypeNode getTimeAwareOffsetNode() {
    UaNode parent = this;
    {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:TimeAwareOffset (declaration"
  ...
  public @Nullable UInteger getTimeAwareOffset() {
    var node = getTimeAwareOffsetNode();
    if (node == null) {
      throw new UaRuntimeException(
