 ...
 */
@FunctionalInterface
public interface AliasNameCategoryTypeFindAliasVerboseDetailedHandler {
  /**
   ...
   * @param aliasNameSearchPattern the input value; supplied null is retained
   * @param referenceTypeFilter the input value; supplied null is retained
