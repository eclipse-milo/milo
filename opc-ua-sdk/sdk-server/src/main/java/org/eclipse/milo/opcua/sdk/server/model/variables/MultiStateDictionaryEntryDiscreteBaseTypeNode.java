...
public class MultiStateDictionaryEntryDiscreteBaseTypeNode extends MultiStateValueDiscreteTypeNode
  ...
  public PropertyTypeNode getEnumDictionaryEntriesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "EnumDictionaryEntries");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:EnumDictionaryEntries"
                    + " (declaration i=19082, owner i=19077) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable Object getEnumDictionaryEntries() {
    var node = getEnumDictionaryEntriesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:EnumDictionaryEntries (declaration i=19082, owner i=19077)"
  ...
  @Override
  public void setEnumDictionaryEntries(@Nullable Object value) {
    var node = getEnumDictionaryEntriesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
  ...
  public @Nullable PropertyTypeNode getValueAsDictionaryEntriesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ValueAsDictionaryEntries");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ValueAsDictionaryEntries"
                    + " (declaration i=19083, owner i=19077) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public @Nullable NodeId @Nullable [] getValueAsDictionaryEntries() {
    var node = getValueAsDictionaryEntriesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ValueAsDictionaryEntries (declaration i=19083, owner"
  ...
  @Override
  public void setValueAsDictionaryEntries(@Nullable NodeId @Nullable [] value) {
    var node = getValueAsDictionaryEntriesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
