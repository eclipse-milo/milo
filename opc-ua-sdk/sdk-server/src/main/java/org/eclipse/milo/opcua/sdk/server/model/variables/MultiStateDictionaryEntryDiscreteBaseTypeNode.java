...
public class MultiStateDictionaryEntryDiscreteBaseTypeNode extends MultiStateValueDiscreteTypeNode
  ...
  public PropertyTypeNode getEnumDictionaryEntriesNode() {
    Optional<VariableNode> propertyNode =
        getPropertyNode(MultiStateDictionaryEntryDiscreteBaseType.ENUM_DICTIONARY_ENTRIES);
    return (PropertyTypeNode) propertyNode.orElse(null);
  }

  @Override
  public Object getEnumDictionaryEntries() {
    return getProperty(MultiStateDictionaryEntryDiscreteBaseType.ENUM_DICTIONARY_ENTRIES)
        .orElse(null);
  }
  ...
  public PropertyTypeNode getValueAsDictionaryEntriesNode() {
    Optional<VariableNode> propertyNode =
        getPropertyNode(MultiStateDictionaryEntryDiscreteBaseType.VALUE_AS_DICTIONARY_ENTRIES);
    return (PropertyTypeNode) propertyNode.orElse(null);
  }

  @Override
  public NodeId[] getValueAsDictionaryEntries() {
    return getProperty(MultiStateDictionaryEntryDiscreteBaseType.VALUE_AS_DICTIONARY_ENTRIES)
        .orElse(null);
  }
