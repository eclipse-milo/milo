 ...
 */
@FunctionalInterface
public interface UserManagementTypeChangePasswordDetailedHandler {
  /**
   ...
   * @param oldPassword the input value; supplied null is retained
   * @param newPassword the input value; supplied null is retained
