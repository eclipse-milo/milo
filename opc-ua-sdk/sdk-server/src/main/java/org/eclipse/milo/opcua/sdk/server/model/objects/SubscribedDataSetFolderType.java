...
public interface SubscribedDataSetFolderType extends FolderType {
  ...
  /**
   * https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.2 Binds a synchronous
   * callback for this ObjectId. Close the returned token to unbind.
   *
   * @see MethodBindings
   */
  MethodBinding bindAddSubscribedDataSet(
      MethodBindings bindings, AddSubscribedDataSetHandler handler) throws UaException;
  ...
  MethodBinding bindAddSubscribedDataSetDetailed(
      MethodBindings bindings, AddSubscribedDataSetDetailedHandler handler) throws UaException;
  ...
  /**
   * https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.3 Binds a synchronous
   * callback for this ObjectId. Close the returned token to unbind.
   *
   * @see MethodBindings
   */
  MethodBinding bindRemoveSubscribedDataSet(
      MethodBindings bindings, RemoveSubscribedDataSetHandler handler) throws UaException;
  ...
  MethodBinding bindRemoveSubscribedDataSetDetailed(
      MethodBindings bindings, RemoveSubscribedDataSetDetailedHandler handler) throws UaException;
  ...
  /**
   * https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.4 Binds a synchronous
   * callback for this ObjectId. Close the returned token to unbind.
   *
   * @see MethodBindings
   */
  ...
  /**
   * https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.5 Binds a synchronous
   * callback for this ObjectId. Close the returned token to unbind.
   *
   * @see MethodBindings
   */
  ...
  /** https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.2 */
  @FunctionalInterface
  interface AddSubscribedDataSetDetailedHandler {
    /**
  ...
  /** https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.3 */
  @FunctionalInterface
  interface RemoveSubscribedDataSetDetailedHandler {
    /**
     * @return a non-null complete operation outcome
     * @throws UaException for an operation failure
     */
