 ...
 */
@FunctionalInterface
public interface ConfigurationFileTypeConfirmUpdateHandler {
  /**
   ...
   * @param updateId the input value; supplied null is retained
   * @throws UaException for an operation failure
   */
  void invoke(AbstractMethodInvocationHandler.InvocationContext context, @Nullable UUID updateId)
      throws UaException;
}
