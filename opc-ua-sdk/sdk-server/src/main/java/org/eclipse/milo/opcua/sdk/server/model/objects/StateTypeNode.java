...
public class StateTypeNode extends BaseObjectTypeNode implements StateType {
  ...
  public PropertyTypeNode getStateNumberNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "StateNumber");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:StateNumber (declaration"
  ...
  @Override
  public @Nullable UInteger getStateNumber() {
    var node = getStateNumberNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:StateNumber (declaration i=2308, owner i=2307)"
  ...
  @Override
  public void setStateNumber(@Nullable UInteger value) {
    var node = getStateNumberNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
