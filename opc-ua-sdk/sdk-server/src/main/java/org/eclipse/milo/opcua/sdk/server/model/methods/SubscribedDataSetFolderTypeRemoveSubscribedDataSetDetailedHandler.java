 ...
 */
@FunctionalInterface
public interface SubscribedDataSetFolderTypeRemoveSubscribedDataSetDetailedHandler {
  /**
   ...
   * @param subscribedDataSetNodeId the input value; supplied null is retained
