...
/**
 * Server API for the ExclusiveDeviationAlarmType ObjectType.
 *
...
public interface ExclusiveDeviationAlarmType extends ExclusiveLimitAlarmType {
  ExpandedNodeId TYPE_ID = ExpandedNodeId.of(Namespaces.OPC_UA, 9764L);
  ...
  interface Methods extends ExclusiveLimitAlarmType.Methods {}
}
