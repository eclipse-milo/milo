...
public interface TransactionDiagnosticsType extends BaseObjectType {
  ...
  /** Gets the existing node's local value. */
  @Nullable NodeId @Nullable [] getAffectedTrustLists();

  /** Sets the existing node's local value. */
  void setAffectedTrustLists(@Nullable NodeId @Nullable [] value);
  ...
  /** Gets the existing node's local value. */
  @Nullable NodeId @Nullable [] getAffectedCertificateGroups();

  /** Sets the existing node's local value. */
  void setAffectedCertificateGroups(@Nullable NodeId @Nullable [] value);
