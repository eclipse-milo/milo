...
import org.eclipse.milo.opcua.sdk.server.model.methods.TemporaryFileTransferTypeCloseAndCommitDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TemporaryFileTransferTypeCloseAndCommitHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TemporaryFileTransferTypeGenerateFileForReadDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TemporaryFileTransferTypeGenerateFileForReadHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TemporaryFileTransferTypeGenerateFileForWriteDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TemporaryFileTransferTypeGenerateFileForWriteHandler;
...
public class TemporaryFileTransferTypeNode extends BaseObjectTypeNode
  ...
  public PropertyTypeNode getClientProcessingTimeoutNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ClientProcessingTimeout");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ClientProcessingTimeout"
                    + " (declaration i=15745, owner i=15744) on "
                    + getNodeId());
          }
  ...
  public @Nullable Double getClientProcessingTimeout() {
    var node = getClientProcessingTimeoutNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ClientProcessingTimeout (declaration i=15745, owner"
  ...
  public UaMethodNode getGenerateFileForReadMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:GenerateFileForRead (declaration i=15746, owner i=15744)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "GenerateFileForRead");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:GenerateFileForRead"
                    + " (declaration i=15746, owner i=15744) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public MethodBinding bindGenerateFileForRead(
      MethodBindings bindings, TemporaryFileTransferTypeGenerateFileForReadHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGenerateFileForReadMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            @Nullable Object callbackInput0 = null;
            if (inputValues.length > 0) {
              try {
                @Nullable Object convertedInput0;
                {
                  ...
                  try {
                    ...
                    convertedInput0 = (Object) methodValue;
                ...
                @Nullable Object projectedInput0;
                {
                  Object methodValue = inputValues[0].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    projectedInput0 = (Object) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
            ...
            try {
              TemporaryFileTransferTypeGenerateFileForReadOutputs outputs =
              ...
              Variant outputValue0;
              {
                ...
                {
                  Object methodValue = outputs.fileNodeId();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument FileNodeId (effective property i=15748, DataType i=17)"
              ...
              Variant outputValue1;
              {
                ...
                {
                  Object methodValue = outputs.fileHandle();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument FileHandle (effective property i=15748, DataType i=7) is"
              ...
              Variant outputValue2;
              {
                @Nullable NodeId convertedValue;
                {
                  Object methodValue = outputs.completionStateMachine();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument CompletionStateMachine (effective property i=15748,"
  ...
  @Override
  public MethodBinding bindGenerateFileForReadDetailed(
      MethodBindings bindings, TemporaryFileTransferTypeGenerateFileForReadDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGenerateFileForReadMethodNode();
  ...
  public UaMethodNode getGenerateFileForWriteMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:GenerateFileForWrite (declaration i=15749, owner i=15744)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "GenerateFileForWrite");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:GenerateFileForWrite"
                    + " (declaration i=15749, owner i=15744) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public MethodBinding bindGenerateFileForWrite(
      MethodBindings bindings, TemporaryFileTransferTypeGenerateFileForWriteHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGenerateFileForWriteMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            try {
              TemporaryFileTransferTypeGenerateFileForWriteOutputs outputs =
                  handler.invoke(context, callbackInput0);
              if (outputs == null) {
                throw new UaException(
                    StatusCodes.Bad_InternalError,
                ...
                @Nullable NodeId convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument FileNodeId (effective property i=15750, DataType i=17)"
                              + " is unavailable in the effective type tree; resolved DataType: "
                              + argumentDataTypeId);
                    }
                    Object numericElements =
                ...
                @Nullable UInteger convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument FileHandle (effective property i=15750, DataType i=7) is"
                              + " unavailable in the effective type tree; resolved DataType: "
                              + argumentDataTypeId);
                    }
                    Object numericElements =
  ...
  @Override
  public MethodBinding bindGenerateFileForWriteDetailed(
      MethodBindings bindings, TemporaryFileTransferTypeGenerateFileForWriteDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGenerateFileForWriteMethodNode();
  ...
  public UaMethodNode getCloseAndCommitMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "CloseAndCommit");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:CloseAndCommit (declaration"
                    + " i=15751, owner i=15744) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public MethodBinding bindCloseAndCommit(
      MethodBindings bindings, TemporaryFileTransferTypeCloseAndCommitHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getCloseAndCommitMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
                ...
                @Nullable NodeId convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument CompletionStateMachine (effective property i=15753,"
                              + " DataType i=17) is unavailable in the effective type tree;"
                              + " resolved DataType: "
                              + argumentDataTypeId);
                    }
  ...
  @Override
  public MethodBinding bindCloseAndCommitDetailed(
      MethodBindings bindings, TemporaryFileTransferTypeCloseAndCommitDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getCloseAndCommitMethodNode();
