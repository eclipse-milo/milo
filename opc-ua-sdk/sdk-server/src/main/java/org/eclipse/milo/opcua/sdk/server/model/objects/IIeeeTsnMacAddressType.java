...
public interface IIeeeTsnMacAddressType extends BaseInterfaceType {
   ...
   *     representation
   */
  @Nullable UByte @Nullable [] getDestinationAddress();
   ...
   *     resolution fails, or a checked conversion fails
   */
  void setDestinationAddress(@Nullable UByte @Nullable [] value);
   ...
   *     resolution fails, or a checked conversion fails
   */
  @Nullable BaseDataVariableType getSourceAddressNode();
   ...
   *     representation
   */
  @Nullable UByte @Nullable [] getSourceAddress();
   ...
   *     resolution fails, or a checked conversion fails
   */
  void setSourceAddress(@Nullable UByte @Nullable [] value);
}
