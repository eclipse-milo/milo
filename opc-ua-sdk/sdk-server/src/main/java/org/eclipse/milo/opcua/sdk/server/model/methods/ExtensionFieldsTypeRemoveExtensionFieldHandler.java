 ...
 */
@FunctionalInterface
public interface ExtensionFieldsTypeRemoveExtensionFieldHandler {
  /**
   ...
   * @param fieldId the input value; supplied null is retained
   * @throws UaException for an operation failure
   */
  void invoke(AbstractMethodInvocationHandler.InvocationContext context, @Nullable NodeId fieldId)
      throws UaException;
}
