 ...
 */
@FunctionalInterface
public interface RoleSetTypeAddRoleDetailedHandler {
  /**
   ...
   * @param roleName the input value; supplied null is retained
   * @param namespaceUri the input value; supplied null is retained
