...
import org.eclipse.milo.opcua.sdk.server.model.methods.WriterGroupTypeAddDataSetWriterDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.WriterGroupTypeAddDataSetWriterHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.WriterGroupTypeRemoveDataSetWriterDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.WriterGroupTypeRemoveDataSetWriterHandler;
...
public class WriterGroupTypeNode extends PubSubGroupTypeNode implements WriterGroupType {
  ...
  public PropertyTypeNode getWriterGroupIdNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "WriterGroupId");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:WriterGroupId (declaration"
  ...
  public PropertyTypeNode getKeepAliveTimeNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "KeepAliveTime");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:KeepAliveTime (declaration"
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:Priority (declaration i=17739,"
                    + " owner i=17725) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:LocaleIds (declaration"
  ...
  public PropertyTypeNode getHeaderLayoutUriNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "HeaderLayoutUri");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:HeaderLayoutUri (declaration"
                    + " i=17559, owner i=17725) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  public @Nullable WriterGroupTransportTypeNode getTransportSettingsNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:TransportSettings (declaration i=17741, owner i=17725)"
                + " on "
                + getNodeId());
      }
    ...
    if (!(parent instanceof WriterGroupTransportTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:TransportSettings (declaration i=17741, owner i=17725)"
              + " on "
    ...
    return (WriterGroupTransportTypeNode) parent;
  }
  ...
  public @Nullable WriterGroupMessageTypeNode getMessageSettingsNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:MessageSettings (declaration i=17742, owner i=17725)"
                + " on "
                + getNodeId());
      }
    ...
    if (!(parent instanceof WriterGroupMessageTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:MessageSettings (declaration i=17742, owner i=17725)"
              + " on "
    ...
    return (WriterGroupMessageTypeNode) parent;
  }
  ...
  public @Nullable PubSubDiagnosticsWriterGroupTypeNode getDiagnosticsNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:Diagnostics (declaration i=17812, owner i=17725)"
                + " on "
                + getNodeId());
      }
    ...
    if (!(parent instanceof PubSubDiagnosticsWriterGroupTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:Diagnostics (declaration i=17812, owner i=17725)"
              + " on "
    ...
    return (PubSubDiagnosticsWriterGroupTypeNode) parent;
  }
  ...
  public @Nullable UaMethodNode getAddDataSetWriterMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:AddDataSetWriter (declaration i=17969, owner i=17725)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "AddDataSetWriter");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:AddDataSetWriter (declaration"
  ...
  @Override
  public MethodBinding bindAddDataSetWriter(
      MethodBindings bindings, WriterGroupTypeAddDataSetWriterHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddDataSetWriterMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            @Nullable DataSetWriterDataType callbackInput0 = null;
            if (inputValues.length > 0) {
              try {
                @Nullable DataSetWriterDataType convertedInput0;
                {
                  ...
                  try {
                    ...
                    convertedInput0 = (DataSetWriterDataType) methodValue;
                ...
                @Nullable DataSetWriterDataType projectedInput0;
                {
                  Object methodValue = inputValues[0].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    projectedInput0 = (DataSetWriterDataType) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
                ...
                @Nullable NodeId convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument DataSetWriterNodeId (effective property i=17987,"
  ...
  @Override
  public MethodBinding bindAddDataSetWriterDetailed(
      MethodBindings bindings, WriterGroupTypeAddDataSetWriterDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddDataSetWriterMethodNode();
  ...
  public @Nullable UaMethodNode getRemoveDataSetWriterMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:RemoveDataSetWriter (declaration i=17992, owner i=17725)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "RemoveDataSetWriter");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:RemoveDataSetWriter"
  ...
  @Override
  public MethodBinding bindRemoveDataSetWriter(
      MethodBindings bindings, WriterGroupTypeRemoveDataSetWriterHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveDataSetWriterMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
  ...
  @Override
  public MethodBinding bindRemoveDataSetWriterDetailed(
      MethodBindings bindings, WriterGroupTypeRemoveDataSetWriterDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveDataSetWriterMethodNode();
