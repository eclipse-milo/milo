 ...
 */
@FunctionalInterface
public interface PublishSubscribeTypeSetSecurityKeysDetailedHandler {
  /**
   ...
   * @param securityGroupId the input value; supplied null is retained
   * @param securityPolicyUri the input value; supplied null is retained
   * @param currentTokenId the input value; supplied null is retained
   * @param currentKey the input value; supplied null is retained
   * @param futureKeys the input value; supplied null is retained
   * @param timeToNextKey the input value; supplied null is retained
