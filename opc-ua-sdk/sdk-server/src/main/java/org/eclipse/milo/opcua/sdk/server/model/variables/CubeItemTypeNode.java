...
public class CubeItemTypeNode extends ArrayItemTypeNode implements CubeItemType {
  ...
  public PropertyTypeNode getXAxisDefinitionNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "XAxisDefinition");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:XAxisDefinition (declaration"
                    + " i=12065, owner i=12057) on "
                    + getNodeId());
          }
  ...
  public @Nullable AxisInformation getXAxisDefinition() {
    var node = getXAxisDefinitionNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:XAxisDefinition (declaration i=12065, owner i=12057)"
    ...
    if (!(decoded instanceof AxisInformation)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:XAxisDefinition (declaration i=12065, owner i=12057)");
    }
    return (AxisInformation) decoded;
  }
  ...
  public PropertyTypeNode getYAxisDefinitionNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "YAxisDefinition");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:YAxisDefinition (declaration"
                    + " i=12066, owner i=12057) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  public @Nullable AxisInformation getYAxisDefinition() {
    var node = getYAxisDefinitionNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:YAxisDefinition (declaration i=12066, owner i=12057)"
  ...
  public PropertyTypeNode getZAxisDefinitionNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ZAxisDefinition");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ZAxisDefinition (declaration"
                    + " i=12067, owner i=12057) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public @Nullable AxisInformation getZAxisDefinition() {
    var node = getZAxisDefinitionNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ZAxisDefinition (declaration i=12067, owner i=12057)"
  ...
  @Override
  public void setZAxisDefinition(@Nullable AxisInformation value) {
    var node = getZAxisDefinitionNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
