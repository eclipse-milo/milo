 ...
 */
@FunctionalInterface
public interface TrustListTypeRemoveCertificateDetailedHandler {
  /**
   ...
   * @param thumbprint the input value; supplied null is retained
   * @param isTrustedCertificate the input value; supplied null is retained
