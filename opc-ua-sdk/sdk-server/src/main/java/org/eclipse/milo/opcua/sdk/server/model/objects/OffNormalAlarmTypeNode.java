...
public class OffNormalAlarmTypeNode extends DiscreteAlarmTypeNode implements OffNormalAlarmType {
  ...
  public PropertyTypeNode getNormalStateNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "NormalState");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:NormalState (declaration"
  ...
  @Override
  public @Nullable NodeId getNormalState() {
    var node = getNormalStateNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NormalState (declaration i=11158, owner i=10637)"
  ...
  @Override
  public void setNormalState(@Nullable NodeId value) {
    var node = getNormalStateNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
