...
public class NonTransparentRedundancyTypeNode extends ServerRedundancyTypeNode
  ...
  public PropertyTypeNode getServerUriArrayNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ServerUriArray");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ServerUriArray (declaration"
  ...
  @Override
  public @Nullable String @Nullable [] getServerUriArray() {
    var node = getServerUriArrayNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ServerUriArray (declaration i=2040, owner i=2039)"
  ...
  @Override
  public void setServerUriArray(@Nullable String @Nullable [] value) {
    var node = getServerUriArrayNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
