...
public class NonTransparentRedundancyTypeNode extends ServerRedundancyTypeNode
  ...
  public @Nullable String @Nullable [] getServerUriArray() {
    return ServerNodeSupport.readArray(this, getServerUriArrayNode(), String.class, null);
  }

  @Override
  public void setServerUriArray(@Nullable String @Nullable [] value) {
    ServerNodeSupport.write(this, getServerUriArrayNode(), value, true, false, false);
  }
