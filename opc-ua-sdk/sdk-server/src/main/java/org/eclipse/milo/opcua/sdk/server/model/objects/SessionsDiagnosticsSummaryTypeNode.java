...
public class SessionsDiagnosticsSummaryTypeNode extends BaseObjectTypeNode
  ...
  public SessionDiagnosticsArrayTypeNode getSessionDiagnosticsArrayNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SessionDiagnosticsArray");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SessionDiagnosticsArray"
                    + " (declaration i=2027, owner i=2026) on "
                    + getNodeId());
          }
    ...
    if (!(parent instanceof SessionDiagnosticsArrayTypeNode)) {
      throw new UaRuntimeException(
    ...
    return (SessionDiagnosticsArrayTypeNode) parent;
  }

  @Override
  public @Nullable SessionDiagnosticsDataType @Nullable [] getSessionDiagnosticsArray() {
    var node = getSessionDiagnosticsArrayNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SessionDiagnosticsArray (declaration i=2027, owner i=2026)"
  ...
  public SessionSecurityDiagnosticsArrayTypeNode getSessionSecurityDiagnosticsArrayNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SessionSecurityDiagnosticsArray");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
    ...
    if (!(parent instanceof SessionSecurityDiagnosticsArrayTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
    ...
    return (SessionSecurityDiagnosticsArrayTypeNode) parent;
  }

  @Override
  public @Nullable SessionSecurityDiagnosticsDataType @Nullable []
      getSessionSecurityDiagnosticsArray() {
    var node = getSessionSecurityDiagnosticsArrayNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SessionSecurityDiagnosticsArray (declaration i=2028, owner"
