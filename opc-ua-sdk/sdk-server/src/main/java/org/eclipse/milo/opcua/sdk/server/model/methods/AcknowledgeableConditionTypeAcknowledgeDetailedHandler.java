 ...
 */
@FunctionalInterface
public interface AcknowledgeableConditionTypeAcknowledgeDetailedHandler {
  /**
   ...
   * @param eventId The identifier for the event to comment.; supplied null is retained
   * @param comment The comment to add to the condition.; supplied null is retained
