...
public class AnalogNumberUnitRangeTypeNode extends AnalogUnitRangeTypeNode
  ...
  public PropertyTypeNode getEuNumberRangeNode() {
    Optional<VariableNode> propertyNode =
        getPropertyNode(AnalogNumberUnitRangeType.EU_NUMBER_RANGE);
    return (PropertyTypeNode) propertyNode.orElse(null);
  }

  @Override
  public NumberRange getEuNumberRange() {
    return getProperty(AnalogNumberUnitRangeType.EU_NUMBER_RANGE).orElse(null);
  }

  @Override
  public void setEuNumberRange(NumberRange value) {
    setProperty(AnalogNumberUnitRangeType.EU_NUMBER_RANGE, value);
  }
}
