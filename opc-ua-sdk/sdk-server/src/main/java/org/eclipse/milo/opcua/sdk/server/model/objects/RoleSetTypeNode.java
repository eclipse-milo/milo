...
import org.eclipse.milo.opcua.sdk.server.model.methods.RoleSetTypeAddRoleDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.RoleSetTypeAddRoleHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.RoleSetTypeRemoveRoleDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.RoleSetTypeRemoveRoleHandler;
...
public class RoleSetTypeNode extends BaseObjectTypeNode implements RoleSetType {
  ...
  public UaMethodNode getAddRoleMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "AddRole");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:AddRole (declaration i=15997,"
                    + " owner i=15607) on "
                    + getNodeId());
          }
  ...
  @Override
  public MethodBinding bindAddRole(MethodBindings bindings, RoleSetTypeAddRoleHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddRoleMethodNode();
    if (methodNode == null) {
                ...
                @Nullable NodeId convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument RoleNodeId (effective property i=15999, DataType i=17)"
  ...
  @Override
  public MethodBinding bindAddRoleDetailed(
      MethodBindings bindings, RoleSetTypeAddRoleDetailedHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddRoleMethodNode();
    if (methodNode == null) {
  ...
  public UaMethodNode getRemoveRoleMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "RemoveRole");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:RemoveRole (declaration"
  ...
  @Override
  public MethodBinding bindRemoveRole(MethodBindings bindings, RoleSetTypeRemoveRoleHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveRoleMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
  ...
  @Override
  public MethodBinding bindRemoveRoleDetailed(
      MethodBindings bindings, RoleSetTypeRemoveRoleDetailedHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveRoleMethodNode();
    if (methodNode == null) {
