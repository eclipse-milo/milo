...
public class RoleSetTypeNode extends BaseObjectTypeNode implements RoleSetType {
  ...
  @Override
  public MethodBinding bindAddRole(MethodBindings bindings, RoleSetType.AddRoleHandler handler)
      throws UaException {
  ...
  public MethodBinding bindAddRoleDetailed(
      MethodBindings bindings, RoleSetType.AddRoleDetailedHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddRoleMethodNode();
    if (methodNode == null) {
  ...
  @Override
  public MethodBinding bindRemoveRole(
      MethodBindings bindings, RoleSetType.RemoveRoleHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindRemoveRoleDetailed(
      MethodBindings bindings, RoleSetType.RemoveRoleDetailedHandler handler) throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveRoleMethodNode();
    if (methodNode == null) {
