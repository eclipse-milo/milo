 ...
 */
@NullMarked
public final class IVlanIdTypeView extends ServerObjectView implements IVlanIdType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IVlanIdType> TYPE =
      ServerViewType.of(ExpandedNodeId.parse("i=25218"), IVlanIdType.class, IVlanIdTypeView::new);
  ...
  private IVlanIdTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
