...
import org.eclipse.milo.opcua.sdk.server.model.methods.KeyCredentialConfigurationTypeDeleteCredentialDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.KeyCredentialConfigurationTypeDeleteCredentialHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.KeyCredentialConfigurationTypeGetEncryptingKeyDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.KeyCredentialConfigurationTypeGetEncryptingKeyHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.KeyCredentialConfigurationTypeUpdateCredentialDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.KeyCredentialConfigurationTypeUpdateCredentialHandler;
...
public class KeyCredentialConfigurationTypeNode extends BaseObjectTypeNode
  ...
  public PropertyTypeNode getProfileUriNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ProfileUri");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ProfileUri (declaration"
  ...
  public @Nullable PropertyTypeNode getEndpointUrlsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "EndpointUrls");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:EndpointUrls (declaration"
  ...
  public @Nullable PropertyTypeNode getCredentialIdNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "CredentialId");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:CredentialId (declaration"
  ...
  public @Nullable PropertyTypeNode getServiceStatusNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ServiceStatus");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ServiceStatus (declaration"
  ...
  public @Nullable UaMethodNode getGetEncryptingKeyMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "GetEncryptingKey");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:GetEncryptingKey (declaration"
  ...
  @Override
  public MethodBinding bindGetEncryptingKey(
      MethodBindings bindings, KeyCredentialConfigurationTypeGetEncryptingKeyHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetEncryptingKeyMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            try {
              KeyCredentialConfigurationTypeGetEncryptingKeyOutputs outputs =
              ...
              Variant outputValue0;
              {
                ...
                {
                  Object methodValue = outputs.publicKey();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument PublicKey (effective property i=17536, DataType i=15) is"
              ...
              Variant outputValue1;
              {
                ...
                {
                  Object methodValue = outputs.revisedSecurityPolicyUri();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument RevisedSecurityPolicyUri (effective property i=17536,"
                              + " DataType i=12) is unavailable in the effective type tree;"
                              + " resolved DataType: "
                              + argumentDataTypeId);
                    }
                    Object numericElements =
  ...
  @Override
  public MethodBinding bindGetEncryptingKeyDetailed(
      MethodBindings bindings,
      KeyCredentialConfigurationTypeGetEncryptingKeyDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getGetEncryptingKeyMethodNode();
  ...
  public @Nullable UaMethodNode getUpdateCredentialMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "UpdateCredential");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:UpdateCredential (declaration"
  ...
  @Override
  public MethodBinding bindUpdateCredential(
      MethodBindings bindings, KeyCredentialConfigurationTypeUpdateCredentialHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getUpdateCredentialMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
  ...
  @Override
  public MethodBinding bindUpdateCredentialDetailed(
      MethodBindings bindings,
      KeyCredentialConfigurationTypeUpdateCredentialDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getUpdateCredentialMethodNode();
  ...
  public @Nullable UaMethodNode getDeleteCredentialMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "DeleteCredential");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:DeleteCredential (declaration"
  ...
  @Override
  public MethodBinding bindDeleteCredential(
      MethodBindings bindings, KeyCredentialConfigurationTypeDeleteCredentialHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getDeleteCredentialMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
  ...
  @Override
  public MethodBinding bindDeleteCredentialDetailed(
      MethodBindings bindings,
      KeyCredentialConfigurationTypeDeleteCredentialDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getDeleteCredentialMethodNode();
