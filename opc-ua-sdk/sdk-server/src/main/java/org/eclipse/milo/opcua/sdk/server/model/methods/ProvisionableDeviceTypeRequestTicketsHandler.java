 ...
 */
@FunctionalInterface
public interface ProvisionableDeviceTypeRequestTicketsHandler {
  /**
   ...
   */
  @Nullable String @Nullable [] invoke(AbstractMethodInvocationHandler.InvocationContext context)
      throws UaException;
}
