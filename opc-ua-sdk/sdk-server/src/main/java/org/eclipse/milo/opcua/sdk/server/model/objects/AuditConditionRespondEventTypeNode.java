...
public class AuditConditionRespondEventTypeNode extends AuditConditionEventTypeNode
  ...
  public PropertyTypeNode getSelectedResponseNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SelectedResponse");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SelectedResponse (declaration"
  ...
  @Override
  public @Nullable UInteger getSelectedResponse() {
    var node = getSelectedResponseNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SelectedResponse (declaration i=11852, owner i=8927)"
  ...
  @Override
  public void setSelectedResponse(@Nullable UInteger value) {
    var node = getSelectedResponseNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
