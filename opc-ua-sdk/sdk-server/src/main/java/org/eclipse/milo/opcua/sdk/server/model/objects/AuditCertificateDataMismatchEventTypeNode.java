...
public class AuditCertificateDataMismatchEventTypeNode extends AuditCertificateEventTypeNode
  ...
  public PropertyTypeNode getInvalidHostnameNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "InvalidHostname");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:InvalidHostname (declaration"
                    + " i=2083, owner i=2082) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable String getInvalidHostname() {
    var node = getInvalidHostnameNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:InvalidHostname (declaration i=2083, owner i=2082)"
  ...
  @Override
  public void setInvalidHostname(@Nullable String value) {
    var node = getInvalidHostnameNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
  ...
  public PropertyTypeNode getInvalidUriNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "InvalidUri");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:InvalidUri (declaration"
  ...
  @Override
  public @Nullable String getInvalidUri() {
    var node = getInvalidUriNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:InvalidUri (declaration i=2084, owner i=2082)"
  ...
  @Override
  public void setInvalidUri(@Nullable String value) {
    var node = getInvalidUriNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
