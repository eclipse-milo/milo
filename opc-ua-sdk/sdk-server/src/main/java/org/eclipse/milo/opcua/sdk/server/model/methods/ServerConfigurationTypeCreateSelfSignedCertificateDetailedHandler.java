 ...
 */
@FunctionalInterface
public interface ServerConfigurationTypeCreateSelfSignedCertificateDetailedHandler {
  /**
   ...
   * @param subjectName the input value; supplied null is retained
   * @param dnsNames the input value; supplied null is retained
   * @param ipAddresses the input value; supplied null is retained
   * @param lifetimeInDays the input value; supplied null is retained
   * @param keySizeInBits the input value; supplied null is retained
