...
public class TransitionTypeNode extends BaseObjectTypeNode implements TransitionType {
  ...
  public PropertyTypeNode getTransitionNumberNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "TransitionNumber");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:TransitionNumber (declaration"
                    + " i=2312, owner i=2310) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable UInteger getTransitionNumber() {
    var node = getTransitionNumberNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:TransitionNumber (declaration i=2312, owner i=2310)"
  ...
  @Override
  public void setTransitionNumber(@Nullable UInteger value) {
    var node = getTransitionNumberNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
