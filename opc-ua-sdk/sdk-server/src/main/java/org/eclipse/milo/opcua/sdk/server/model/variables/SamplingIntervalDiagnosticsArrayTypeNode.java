...
public class SamplingIntervalDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
  ...
  public SamplingIntervalDiagnosticsTypeNode getSamplingIntervalDiagnosticsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SamplingIntervalDiagnostics");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SamplingIntervalDiagnostics"
    ...
    if (!(parent instanceof SamplingIntervalDiagnosticsTypeNode)) {
      throw new UaRuntimeException(
    ...
    return (SamplingIntervalDiagnosticsTypeNode) parent;
  }

  @Override
  public @Nullable SamplingIntervalDiagnosticsDataType getSamplingIntervalDiagnostics() {
    var node = getSamplingIntervalDiagnosticsNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SamplingIntervalDiagnostics (declaration i=12779, owner"
