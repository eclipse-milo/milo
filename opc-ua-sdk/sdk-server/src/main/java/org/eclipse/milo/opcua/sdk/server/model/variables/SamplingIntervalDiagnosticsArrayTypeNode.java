...
public class SamplingIntervalDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
  ...
  @Override
  public @Nullable SamplingIntervalDiagnosticsDataType @Nullable [] getTypedValue() {
    return ServerNodeSupport.readArray(this, this, SamplingIntervalDiagnosticsDataType.class, null);
  }

  @Override
  public void setTypedValue(@Nullable SamplingIntervalDiagnosticsDataType @Nullable [] value) {
