...
public class SubscribedDataSetFolderTypeNode extends FolderTypeNode
  ...
  public MethodBinding bindAddSubscribedDataSet(
      MethodBindings bindings, SubscribedDataSetFolderType.AddSubscribedDataSetHandler handler)
      throws UaException {
  ...
  public MethodBinding bindAddSubscribedDataSetDetailed(
      ...
      SubscribedDataSetFolderType.AddSubscribedDataSetDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddSubscribedDataSetMethodNode();
  ...
  public MethodBinding bindRemoveSubscribedDataSet(
      MethodBindings bindings, SubscribedDataSetFolderType.RemoveSubscribedDataSetHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindRemoveSubscribedDataSetDetailed(
      MethodBindings bindings,
      SubscribedDataSetFolderType.RemoveSubscribedDataSetDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveSubscribedDataSetMethodNode();
  ...
  public MethodBinding bindAddDataSetFolder(
      MethodBindings bindings, SubscribedDataSetFolderType.AddDataSetFolderHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindAddDataSetFolderDetailed(
      MethodBindings bindings, SubscribedDataSetFolderType.AddDataSetFolderDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddDataSetFolderMethodNode();
  ...
  public MethodBinding bindRemoveDataSetFolder(
      MethodBindings bindings, SubscribedDataSetFolderType.RemoveDataSetFolderHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindRemoveDataSetFolderDetailed(
      MethodBindings bindings,
      SubscribedDataSetFolderType.RemoveDataSetFolderDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveDataSetFolderMethodNode();
