...
public class CertificateGroupFolderTypeNode extends FolderTypeNode
  ...
  public CertificateGroupTypeNode getDefaultApplicationGroupNode() {
    Optional<ObjectNode> component =
        getObjectComponent("http://opcfoundation.org/UA/", "DefaultApplicationGroup");
  ...
  public CertificateGroupTypeNode getDefaultHttpsGroupNode() {
    Optional<ObjectNode> component =
        getObjectComponent("http://opcfoundation.org/UA/", "DefaultHttpsGroup");
    return (CertificateGroupTypeNode) component.orElse(null);
  }
  ...
  public CertificateGroupTypeNode getDefaultUserTokenGroupNode() {
    Optional<ObjectNode> component =
        getObjectComponent("http://opcfoundation.org/UA/", "DefaultUserTokenGroup");
    return (CertificateGroupTypeNode) component.orElse(null);
  }
}
