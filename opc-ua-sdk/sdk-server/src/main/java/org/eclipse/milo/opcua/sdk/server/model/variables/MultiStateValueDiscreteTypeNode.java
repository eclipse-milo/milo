...
public class MultiStateValueDiscreteTypeNode extends DiscreteItemTypeNode
  ...
  public PropertyTypeNode getEnumValuesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "EnumValues");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:EnumValues (declaration"
                    + " i=11241, owner i=11238) on "
                    + getNodeId());
          }
  ...
  public @Nullable EnumValueType @Nullable [] getEnumValues() {
    ...
    EnumValueType[] typed = new EnumValueType[elements.length];
    for (int i = 0; i < elements.length; i++) {
      if (elements[i] != null && !(elements[i] instanceof EnumValueType)) {
        throw new UaRuntimeException(
            StatusCodes.Bad_TypeMismatch,
            "http://opcfoundation.org/UA/:EnumValues (declaration i=11241, owner i=11238)");
      }
      typed[i] = (EnumValueType) elements[i];
    }
    return typed;
  }
  ...
  public PropertyTypeNode getValueAsTextNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ValueAsText");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ValueAsText (declaration"
                    + " i=11461, owner i=11238) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public @Nullable LocalizedText getValueAsTextProperty() {
    var node = getValueAsTextNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ValueAsText (declaration i=11461, owner i=11238)"
  ...
  @Override
  public void setValueAsTextProperty(@Nullable LocalizedText value) {
    var node = getValueAsTextNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
