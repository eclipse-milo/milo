    ...
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            ...
            "http://opcfoundation.org/UA/:Counters (declaration i=19982, owner i=19968)"
                + " on "
                + getNodeId());
      }
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:Counters (declaration i=19982,"
                    + " owner i=19968) on "
                    + getNodeId());
          }
  ...
  public BaseObjectTypeNode getLiveValuesNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:LiveValues (declaration i=20013, owner i=19968)"
                + " on "
                + getNodeId());
      }
