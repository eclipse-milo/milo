...
public class AuditCancelEventTypeNode extends AuditSessionEventTypeNode
  ...
  public PropertyTypeNode getRequestHandleNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "RequestHandle");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:RequestHandle (declaration"
  ...
  @Override
  public @Nullable UInteger getRequestHandle() {
    var node = getRequestHandleNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:RequestHandle (declaration i=2079, owner i=2078)"
  ...
  @Override
  public void setRequestHandle(@Nullable UInteger value) {
    var node = getRequestHandleNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
