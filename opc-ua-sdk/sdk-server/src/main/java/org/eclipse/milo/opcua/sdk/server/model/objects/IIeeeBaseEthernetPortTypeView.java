...
import org.eclipse.milo.opcua.sdk.server.model.variables.AnalogUnitTypeView;
 ...
 */
@NullMarked
public final class IIeeeBaseEthernetPortTypeView extends ServerObjectView
    implements IIeeeBaseEthernetPortType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIeeeBaseEthernetPortType> TYPE =
      ServerViewType.of(
  ...
  private IIeeeBaseEthernetPortTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "Speed");
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "Duplex");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
  ...
  private UaVariableNode viewMember2() {
    views.checkOpen();
    var resolvedMember =
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "MaxFrameLength");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
  ...
  public AnalogUnitType getSpeedNode() {
    ...
    return child == null ? null : views.wrapVariable(child.getNodeId(), AnalogUnitTypeView.TYPE);
  }
