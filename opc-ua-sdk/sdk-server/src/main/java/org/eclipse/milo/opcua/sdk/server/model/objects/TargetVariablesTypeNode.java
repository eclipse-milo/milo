...
import org.eclipse.milo.opcua.sdk.server.model.methods.TargetVariablesTypeAddTargetVariablesDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TargetVariablesTypeAddTargetVariablesHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TargetVariablesTypeRemoveTargetVariablesDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.TargetVariablesTypeRemoveTargetVariablesHandler;
...
public class TargetVariablesTypeNode extends SubscribedDataSetTypeNode
  ...
  public PropertyTypeNode getTargetVariablesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "TargetVariables");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:TargetVariables (declaration"
                    + " i=15114, owner i=15111) on "
                    + getNodeId());
          }
  ...
  public @Nullable FieldTargetDataType @Nullable [] getTargetVariables() {
    var node = getTargetVariablesNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:TargetVariables (declaration i=15114, owner i=15111)"
    ...
    FieldTargetDataType[] typed = new FieldTargetDataType[elements.length];
    for (int i = 0; i < elements.length; i++) {
      if (elements[i] != null && !(elements[i] instanceof FieldTargetDataType)) {
        throw new UaRuntimeException(
            StatusCodes.Bad_TypeMismatch,
            "http://opcfoundation.org/UA/:TargetVariables (declaration i=15114, owner i=15111)");
      }
      typed[i] = (FieldTargetDataType) elements[i];
    }
    return typed;
  }
  ...
  public @Nullable UaMethodNode getAddTargetVariablesMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:AddTargetVariables (declaration i=15115, owner i=15111)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "AddTargetVariables");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:AddTargetVariables"
                    + " (declaration i=15115, owner i=15111) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  @Override
  public MethodBinding bindAddTargetVariables(
      MethodBindings bindings, TargetVariablesTypeAddTargetVariablesHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddTargetVariablesMethodNode();
    if (methodNode == null) {
                ...
                @Nullable StatusCode @Nullable [] convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument AddResults (effective property i=15117, DataType i=19)"
  ...
  @Override
  public MethodBinding bindAddTargetVariablesDetailed(
      MethodBindings bindings, TargetVariablesTypeAddTargetVariablesDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddTargetVariablesMethodNode();
  ...
  public @Nullable UaMethodNode getRemoveTargetVariablesMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "RemoveTargetVariables");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:RemoveTargetVariables"
                    + " (declaration i=15118, owner i=15111) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
    ...
    if (!(parent instanceof UaMethodNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:RemoveTargetVariables (declaration i=15118, owner i=15111)"
              + " on "
              + getNodeId());
    }
    return (UaMethodNode) parent;
  ...
  @Override
  public MethodBinding bindRemoveTargetVariables(
      MethodBindings bindings, TargetVariablesTypeRemoveTargetVariablesHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveTargetVariablesMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
                ...
                @Nullable StatusCode @Nullable [] convertedValue;
                {
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument RemoveResults (effective property i=15120, DataType"
  ...
  @Override
  public MethodBinding bindRemoveTargetVariablesDetailed(
      MethodBindings bindings, TargetVariablesTypeRemoveTargetVariablesDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveTargetVariablesMethodNode();
