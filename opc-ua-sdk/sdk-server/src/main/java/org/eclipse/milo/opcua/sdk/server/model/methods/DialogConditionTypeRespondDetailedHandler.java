 ...
 */
@FunctionalInterface
public interface DialogConditionTypeRespondDetailedHandler {
  /**
   ...
   * @param selectedResponse the input value; supplied null is retained
   * @return a non-null complete operation outcome
   * @throws UaException for an operation failure
   */
  MethodHandlerResult<@Nullable Void> invoke(
      AbstractMethodInvocationHandler.InvocationContext context, @Nullable Integer selectedResponse)
      throws UaException;
}
