...
public class TrustListOutOfDateAlarmTypeNode extends SystemOffNormalAlarmTypeNode
  ...
  public PropertyTypeNode getTrustListIdNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "TrustListId");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:TrustListId (declaration"
