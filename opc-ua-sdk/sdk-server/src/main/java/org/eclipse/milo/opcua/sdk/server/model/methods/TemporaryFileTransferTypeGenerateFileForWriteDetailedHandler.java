 ...
 */
@FunctionalInterface
public interface TemporaryFileTransferTypeGenerateFileForWriteDetailedHandler {
  /**
   ...
   * @param generateOptions the input value; supplied null is retained
  ...
  MethodHandlerResult<TemporaryFileTransferTypeGenerateFileForWriteOutputs> invoke(
      AbstractMethodInvocationHandler.InvocationContext context, @Nullable Object generateOptions)
      throws UaException;
}
