...
public class SubscriptionDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
  ...
  public SubscriptionDiagnosticsTypeNode getSubscriptionDiagnosticsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SubscriptionDiagnostics");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SubscriptionDiagnostics"
    ...
    if (!(parent instanceof SubscriptionDiagnosticsTypeNode)) {
      throw new UaRuntimeException(
    ...
    return (SubscriptionDiagnosticsTypeNode) parent;
  }

  @Override
  public @Nullable SubscriptionDiagnosticsDataType getSubscriptionDiagnostics() {
    var node = getSubscriptionDiagnosticsNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SubscriptionDiagnostics (declaration i=12784, owner i=2171)"
