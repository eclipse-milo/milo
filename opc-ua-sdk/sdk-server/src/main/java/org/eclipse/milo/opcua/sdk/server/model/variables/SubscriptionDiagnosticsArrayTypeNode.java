...
public class SubscriptionDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
  ...
  @Override
  public @Nullable SubscriptionDiagnosticsDataType @Nullable [] getTypedValue() {
    return ServerNodeSupport.readArray(this, this, SubscriptionDiagnosticsDataType.class, null);
  }

  @Override
  public void setTypedValue(@Nullable SubscriptionDiagnosticsDataType @Nullable [] value) {
