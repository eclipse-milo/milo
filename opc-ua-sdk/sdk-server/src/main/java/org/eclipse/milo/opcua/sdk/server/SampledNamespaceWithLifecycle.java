...
import org.eclipse.milo.opcua.sdk.server.sampling.SampledItem;
...
/**
 * A {@link ManagedNamespaceWithLifecycle} that provides built-in support for monitored item
 * sampling.
 *
 ...
 * handled automatically when the namespace starts or stops.
 *
 ...
 *
 * <pre>{@code
 * public class PlcNamespace extends SampledNamespaceWithLifecycle {
 *
 *     private final PlcConnection plc;
 *
 *     public PlcNamespace(OpcUaServer server, PlcConnection plc) {
 *         super(server, "urn:example:plc-namespace");
 *         this.plc = plc;
 *     }
 *
 *     @Override
 ...
 * @see SampledItem
 */
public abstract class SampledNamespaceWithLifecycle extends ManagedNamespaceWithLifecycle {

  private final SamplingManager samplingManager;

  /**
   * Create a new SampledNamespaceWithLifecycle at {@code namespaceUri}.
   *
   * @param server the {@link OpcUaServer} instance.
   * @param namespaceUri the URI assigned to this namespace.
   */
  public SampledNamespaceWithLifecycle(OpcUaServer server, String namespaceUri) {
  ...
  /**
   * Get the {@link SamplingManager} for this namespace.
   *
