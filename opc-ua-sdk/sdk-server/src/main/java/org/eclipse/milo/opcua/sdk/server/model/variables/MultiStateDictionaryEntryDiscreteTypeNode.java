...
public class MultiStateDictionaryEntryDiscreteTypeNode
  ...
  public PropertyTypeNode getValueAsDictionaryEntriesNode() {
    Optional<VariableNode> propertyNode =
        getPropertyNode(MultiStateDictionaryEntryDiscreteType.VALUE_AS_DICTIONARY_ENTRIES);
    return (PropertyTypeNode) propertyNode.orElse(null);
  }

  @Override
  public NodeId[] getValueAsDictionaryEntries() {
    return getProperty(MultiStateDictionaryEntryDiscreteType.VALUE_AS_DICTIONARY_ENTRIES)
        .orElse(null);
  }
