...
public class AuditDeleteReferencesEventTypeNode extends AuditNodeManagementEventTypeNode
  ...
  public PropertyTypeNode getReferencesToDeleteNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ReferencesToDelete");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:ReferencesToDelete"
  ...
  public @Nullable DeleteReferencesItem @Nullable [] getReferencesToDelete() {
    ...
    DeleteReferencesItem[] typed = new DeleteReferencesItem[elements.length];
    for (int i = 0; i < elements.length; i++) {
      if (elements[i] != null && !(elements[i] instanceof DeleteReferencesItem)) {
        throw new UaRuntimeException(
            StatusCodes.Bad_TypeMismatch,
            "http://opcfoundation.org/UA/:ReferencesToDelete (declaration i=2098, owner i=2097)");
      }
      typed[i] = (DeleteReferencesItem) elements[i];
    }
    return typed;
  }
