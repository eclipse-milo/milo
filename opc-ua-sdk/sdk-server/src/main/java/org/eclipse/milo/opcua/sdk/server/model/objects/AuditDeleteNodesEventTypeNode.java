...
public class AuditDeleteNodesEventTypeNode extends AuditNodeManagementEventTypeNode
  ...
  public PropertyTypeNode getNodesToDeleteNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "NodesToDelete");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:NodesToDelete (declaration"
  ...
  @Override
  public @Nullable DeleteNodesItem @Nullable [] getNodesToDelete() {
    var node = getNodesToDeleteNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NodesToDelete (declaration i=2094, owner i=2093)"
    ...
    DeleteNodesItem[] typed = new DeleteNodesItem[elements.length];
    for (int i = 0; i < elements.length; i++) {
      if (elements[i] != null && !(elements[i] instanceof DeleteNodesItem)) {
        throw new UaRuntimeException(
            StatusCodes.Bad_TypeMismatch,
            "http://opcfoundation.org/UA/:NodesToDelete (declaration i=2094, owner i=2093)");
      }
      typed[i] = (DeleteNodesItem) elements[i];
    }
    return typed;
  }

  @Override
  public void setNodesToDelete(@Nullable DeleteNodesItem @Nullable [] value) {
    var node = getNodesToDeleteNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
