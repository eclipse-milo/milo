 ...
 */
@FunctionalInterface
public interface FileDirectoryTypeMoveOrCopyDetailedHandler {
  /**
   ...
   * @param objectToMoveOrCopy the input value; supplied null is retained
   * @param targetDirectory the input value; supplied null is retained
   * @param createCopy the input value; supplied null is retained
   * @param newName the input value; supplied null is retained
