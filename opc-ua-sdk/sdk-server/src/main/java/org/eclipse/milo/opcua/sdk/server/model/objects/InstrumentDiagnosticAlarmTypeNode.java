...
/**
 * Node implementation of {@link InstrumentDiagnosticAlarmType}.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.24/#5.8.24.5">Model
 *     documentation</a>
 */
public class InstrumentDiagnosticAlarmTypeNode extends OffNormalAlarmTypeNode
    implements InstrumentDiagnosticAlarmType {
  public InstrumentDiagnosticAlarmTypeNode(
  ...
  @Override
  public void setMethods(InstrumentDiagnosticAlarmType.@Nullable Methods methods) {
