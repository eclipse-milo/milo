 ...
 */
@FunctionalInterface
public interface PubSubConnectionTypeRemoveGroupHandler {
  /**
   ...
   * @param groupId the input value; supplied null is retained
   * @throws UaException for an operation failure
   */
  void invoke(AbstractMethodInvocationHandler.InvocationContext context, @Nullable NodeId groupId)
      throws UaException;
}
