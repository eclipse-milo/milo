...
public class ProgramTransitionEventTypeNode extends TransitionEventTypeNode
  ...
  public BaseDataVariableTypeNode getIntermediateResultNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "IntermediateResult");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:IntermediateResult"
  ...
  @Override
  public @Nullable Object getIntermediateResult() {
    var node = getIntermediateResultNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:IntermediateResult (declaration i=2379, owner i=2378)"
  ...
  @Override
  public void setIntermediateResult(@Nullable Object value) {
    var node = getIntermediateResultNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
