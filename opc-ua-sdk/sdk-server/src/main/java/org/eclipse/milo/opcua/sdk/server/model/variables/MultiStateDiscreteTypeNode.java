...
public class MultiStateDiscreteTypeNode extends DiscreteItemTypeNode
  ...
  public PropertyTypeNode getEnumStringsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "EnumStrings");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:EnumStrings (declaration"
  ...
  @Override
  public @Nullable LocalizedText @Nullable [] getEnumStrings() {
    var node = getEnumStringsNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:EnumStrings (declaration i=2377, owner i=2376)"
  ...
  @Override
  public void setEnumStrings(@Nullable LocalizedText @Nullable [] value) {
    var node = getEnumStringsNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
