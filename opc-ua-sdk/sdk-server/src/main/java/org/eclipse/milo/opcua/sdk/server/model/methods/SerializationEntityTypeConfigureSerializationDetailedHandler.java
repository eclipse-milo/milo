 ...
 */
@FunctionalInterface
public interface SerializationEntityTypeConfigureSerializationDetailedHandler {
  /**
   ...
   * @param serializationFilterProperties the input value; supplied null is retained
