...
public class ProvisionableDeviceTypeNode extends BaseObjectTypeNode
  ...
  public MethodBinding bindRequestTickets(
      MethodBindings bindings, ProvisionableDeviceType.RequestTicketsHandler handler)
      throws UaException {
  ...
  public MethodBinding bindRequestTicketsDetailed(
      MethodBindings bindings, ProvisionableDeviceType.RequestTicketsDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRequestTicketsMethodNode();
  ...
  public MethodBinding bindSetRegistrarEndpoints(
      MethodBindings bindings, ProvisionableDeviceType.SetRegistrarEndpointsHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindSetRegistrarEndpointsDetailed(
      MethodBindings bindings, ProvisionableDeviceType.SetRegistrarEndpointsDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getSetRegistrarEndpointsMethodNode();
