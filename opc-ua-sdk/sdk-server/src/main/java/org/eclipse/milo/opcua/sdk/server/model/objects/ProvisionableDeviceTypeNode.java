...
import org.eclipse.milo.opcua.sdk.server.model.methods.ProvisionableDeviceTypeRequestTicketsDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.ProvisionableDeviceTypeRequestTicketsHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.ProvisionableDeviceTypeSetRegistrarEndpointsDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.ProvisionableDeviceTypeSetRegistrarEndpointsHandler;
...
public class ProvisionableDeviceTypeNode extends BaseObjectTypeNode
  ...
  public PropertyTypeNode getIsSingletonNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "IsSingleton");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:IsSingleton (declaration"
  ...
  public UaMethodNode getRequestTicketsMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "RequestTickets");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:RequestTickets (declaration"
  ...
  @Override
  public MethodBinding bindRequestTickets(
      MethodBindings bindings, ProvisionableDeviceTypeRequestTicketsHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRequestTicketsMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            try {
              @Nullable String @Nullable [] outputs = handler.invoke(context);
                  ...
                  try {
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument Tickets (effective property i=26874, DataType i=25726)"
  ...
  @Override
  public MethodBinding bindRequestTicketsDetailed(
      MethodBindings bindings, ProvisionableDeviceTypeRequestTicketsDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRequestTicketsMethodNode();
  ...
  public @Nullable UaMethodNode getSetRegistrarEndpointsMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SetRegistrarEndpoints");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:SetRegistrarEndpoints"
    ...
    if (!(parent instanceof UaMethodNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:SetRegistrarEndpoints (declaration i=26875, owner i=26871)"
              + " on "
              + getNodeId());
    }
    return (UaMethodNode) parent;
  ...
  @Override
  public MethodBinding bindSetRegistrarEndpoints(
      MethodBindings bindings, ProvisionableDeviceTypeSetRegistrarEndpointsHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getSetRegistrarEndpointsMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            StatusCode[] inputResults = new StatusCode[inputValues.length];
            Arrays.fill(inputResults, StatusCode.GOOD);
            @Nullable ApplicationDescription @Nullable [] callbackInput0 = null;
            if (inputValues.length > 0) {
              try {
                @Nullable ApplicationDescription @Nullable [] convertedInput0;
                {
                  ...
                  try {
                    ...
                    if (methodValue == null) {
                      ...
                      convertedInput0 = new ApplicationDescription[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < convertedInput0.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        convertedInput0[valueIndex] = (ApplicationDescription) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                ...
                @Nullable ApplicationDescription @Nullable [] projectedInput0;
                {
                  Object methodValue = inputValues[0].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    if (methodValue == null) {
                      ...
                      projectedInput0 = new ApplicationDescription[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < projectedInput0.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        projectedInput0[valueIndex] = (ApplicationDescription) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
  ...
  @Override
  public MethodBinding bindSetRegistrarEndpointsDetailed(
      MethodBindings bindings, ProvisionableDeviceTypeSetRegistrarEndpointsDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getSetRegistrarEndpointsMethodNode();
