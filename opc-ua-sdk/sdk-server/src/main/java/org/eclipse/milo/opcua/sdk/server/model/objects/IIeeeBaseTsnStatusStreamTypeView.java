 ...
 */
@NullMarked
public final class IIeeeBaseTsnStatusStreamTypeView extends ServerObjectView
    implements IIeeeBaseTsnStatusStreamType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIeeeBaseTsnStatusStreamType> TYPE =
      ServerViewType.of(
  ...
  private IIeeeBaseTsnStatusStreamTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
  ...
  private UaVariableNode viewMember3() {
    views.checkOpen();
    var resolvedMember =
        ((Supplier<UaVariableNode>)
                () -> {
   ...
   */
  @Override
  public @Nullable BaseDataVariableType getTalkerStatusNode() {
   ...
   */
  @Override
  public @Nullable BaseDataVariableType getListenerStatusNode() {
    this.views.checkOpen();
    views.checkOpen();
   ...
   */
  @Override
  public BaseDataVariableType getFailureCodeNode() {
    this.views.checkOpen();
    views.checkOpen();
   ...
   */
  @Override
  public BaseDataVariableType getFailureSystemIdentifierNode() {
    this.views.checkOpen();
    views.checkOpen();
