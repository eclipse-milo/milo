...
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishSubscribeTypeAddConnectionDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishSubscribeTypeAddConnectionHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishSubscribeTypeRemoveConnectionDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishSubscribeTypeRemoveConnectionHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishSubscribeTypeSetSecurityKeysDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.PublishSubscribeTypeSetSecurityKeysHandler;
...
public class PublishSubscribeTypeNode extends PubSubKeyServiceTypeNode
  ...
  public PropertyTypeNode getSupportedTransportProfilesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SupportedTransportProfiles");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SupportedTransportProfiles"
  ...
  public @Nullable PropertyTypeNode getDefaultDatagramPublisherIdNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "DefaultDatagramPublisherId");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:DefaultDatagramPublisherId"
  ...
  public @Nullable PropertyTypeNode getDefaultSecurityKeyServicesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "DefaultSecurityKeyServices");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:DefaultSecurityKeyServices"
  ...
  public @Nullable PropertyTypeNode getConfigurationPropertiesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ConfigurationProperties");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ConfigurationProperties"
  ...
  public @Nullable UaMethodNode getSetSecurityKeysMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SetSecurityKeys");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:SetSecurityKeys (declaration"
                    + " i=17296, owner i=14416) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  public MethodBinding bindSetSecurityKeys(
      MethodBindings bindings, PublishSubscribeTypeSetSecurityKeysHandler handler)
      throws UaException {
  ...
  public MethodBinding bindSetSecurityKeysDetailed(
      MethodBindings bindings, PublishSubscribeTypeSetSecurityKeysDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getSetSecurityKeysMethodNode();
  ...
  public @Nullable UaMethodNode getAddConnectionMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "AddConnection");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:AddConnection (declaration"
  ...
  public MethodBinding bindAddConnection(
      MethodBindings bindings, PublishSubscribeTypeAddConnectionHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindAddConnectionDetailed(
      MethodBindings bindings, PublishSubscribeTypeAddConnectionDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getAddConnectionMethodNode();
  ...
  public @Nullable UaMethodNode getRemoveConnectionMethodNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "RemoveConnection");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:RemoveConnection (declaration"
  ...
  public MethodBinding bindRemoveConnection(
      MethodBindings bindings, PublishSubscribeTypeRemoveConnectionHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
  ...
  public MethodBinding bindRemoveConnectionDetailed(
      MethodBindings bindings, PublishSubscribeTypeRemoveConnectionDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getRemoveConnectionMethodNode();
  ...
  public DataSetFolderTypeNode getPublishedDataSetsNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "PublishedDataSets");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:PublishedDataSets (declaration"
    ...
    if (!(parent instanceof DataSetFolderTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:PublishedDataSets (declaration i=14434, owner i=14416)"
              + " on "
    ...
    return (DataSetFolderTypeNode) parent;
  }
  ...
  public @Nullable SubscribedDataSetFolderTypeNode getSubscribedDataSetsNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:SubscribedDataSets (declaration i=23622, owner i=14416)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "SubscribedDataSets");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:SubscribedDataSets"
    ...
    if (!(parent instanceof SubscribedDataSetFolderTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:SubscribedDataSets (declaration i=23622, owner i=14416)"
              + " on "
    ...
    return (SubscribedDataSetFolderTypeNode) parent;
  }
  ...
  public @Nullable PubSubConfigurationTypeNode getPubSubConfigurationNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:PubSubConfiguration (declaration i=25403, owner i=14416)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "PubSubConfiguration");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:PubSubConfiguration"
    ...
    if (!(parent instanceof PubSubConfigurationTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:PubSubConfiguration (declaration i=25403, owner i=14416)"
              + " on "
    ...
    return (PubSubConfigurationTypeNode) parent;
  }
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:Status (declaration i=15844,"
                    + " owner i=14416) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
  ...
  public @Nullable PubSubDiagnosticsRootTypeNode getDiagnosticsNode() {
    ...
    if (!(parent instanceof PubSubDiagnosticsRootTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:Diagnostics (declaration i=18715, owner i=14416)"
              + " on "
    ...
    return (PubSubDiagnosticsRootTypeNode) parent;
  }
  ...
  public @Nullable PubSubCapabilitiesTypeNode getPubSubCapablitiesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "PubSubCapablities");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:PubSubCapablities (declaration"
    ...
    if (!(parent instanceof PubSubCapabilitiesTypeNode)) {
      throw new UaRuntimeException(
          StatusCodes.Bad_TypeMismatch,
          "http://opcfoundation.org/UA/:PubSubCapablities (declaration i=23642, owner i=14416)"
              + " on "
    ...
    return (PubSubCapabilitiesTypeNode) parent;
  }
  ...
  public @Nullable FolderTypeNode getDataSetClassesNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "DataSetClasses");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:DataSetClasses (declaration"
