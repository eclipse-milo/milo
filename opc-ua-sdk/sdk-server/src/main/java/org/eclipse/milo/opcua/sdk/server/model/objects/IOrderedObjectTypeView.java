...
import org.eclipse.milo.opcua.sdk.server.model.variables.PropertyTypeView;
 ...
 */
@NullMarked
public final class IOrderedObjectTypeView extends ServerObjectView implements IOrderedObjectType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IOrderedObjectType> TYPE =
      ServerViewType.of(
  ...
  private IOrderedObjectTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "NumberInList");
  ...
  @Override
  public PropertyType getNumberInListNode() {
  ...
  @Override
  public @Nullable Number getNumberInList() {
    this.views.checkOpen();
    views.checkOpen();
    var child = viewMember0();
    if (child == null) {
  ...
  @Override
  public void setNumberInList(@Nullable Number value) {
    this.views.checkOpen();
    views.checkOpen();
    var child = viewMember0();
    if (child == null) {
