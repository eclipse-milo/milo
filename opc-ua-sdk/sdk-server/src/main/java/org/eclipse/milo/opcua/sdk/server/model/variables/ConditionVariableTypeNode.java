...
public class ConditionVariableTypeNode extends BaseDataVariableTypeNode
  ...
  public PropertyTypeNode getSourceTimestampNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SourceTimestamp");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:SourceTimestamp (declaration"
                    + " i=9003, owner i=9002) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable DateTime getSourceTimestamp() {
    var node = getSourceTimestampNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SourceTimestamp (declaration i=9003, owner i=9002)"
  ...
  @Override
  public void setSourceTimestamp(@Nullable DateTime value) {
    var node = getSourceTimestampNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
