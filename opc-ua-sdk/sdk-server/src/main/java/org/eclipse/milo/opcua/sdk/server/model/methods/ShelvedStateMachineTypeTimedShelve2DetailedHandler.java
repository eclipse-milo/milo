 ...
 */
@FunctionalInterface
public interface ShelvedStateMachineTypeTimedShelve2DetailedHandler {
  /**
   ...
   * @param shelvingTime the input value; supplied null is retained
   * @param comment the input value; supplied null is retained
