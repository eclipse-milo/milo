...
public class AlarmRateVariableTypeNode extends BaseDataVariableTypeNode
  ...
  public PropertyTypeNode getRateNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "Rate");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:Rate (declaration i=17278,"
                    + " owner i=17277) on "
                    + getNodeId());
          }
  ...
  @Override
  public @Nullable UShort getRate() {
    var node = getRateNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Rate (declaration i=17278, owner i=17277)"
  ...
  @Override
  public void setRate(@Nullable UShort value) {
    var node = getRateNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
