...
public class BrokerDataSetWriterTransportTypeNode extends DataSetWriterTransportTypeNode
  ...
  public PropertyTypeNode getMetaDataUpdateTimeNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "MetaDataUpdateTime");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:MetaDataUpdateTime"
  ...
  @Override
  public @Nullable Double getMetaDataUpdateTime() {
    var node = getMetaDataUpdateTimeNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:MetaDataUpdateTime (declaration i=21141, owner i=21138)"
  ...
  @Override
  public void setMetaDataUpdateTime(@Nullable Double value) {
    var node = getMetaDataUpdateTimeNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
