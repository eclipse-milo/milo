 ...
 */
@FunctionalInterface
public interface PubSubConfigurationTypeCloseAndUpdateDetailedHandler {
  /**
   ...
   * @param requireCompleteUpdate the input value; supplied null is retained
   * @param configurationReferences the input value; supplied null is retained
