 ...
 */
@FunctionalInterface
public interface AliasNameCategoryTypeAddAliasesToCategoryDetailedHandler {
  /**
   ...
   * @param aliasNames the input value; supplied null is retained
   * @param targetNodes the input value; supplied null is retained
   * @param targetServers the input value; supplied null is retained
   * @param targetReferenceType the input value; supplied null is retained
