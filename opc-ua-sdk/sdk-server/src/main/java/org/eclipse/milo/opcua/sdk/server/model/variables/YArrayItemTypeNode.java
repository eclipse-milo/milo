...
public class YArrayItemTypeNode extends ArrayItemTypeNode implements YArrayItemType {
  ...
  @Override
  public @Nullable Variant @Nullable [] getYArrayItemValue() {
    return ServerNodeSupport.readArray(this, this, Variant.class, null);
  }

  @Override
  public void setYArrayItemValue(@Nullable Variant @Nullable [] value) {
    ServerNodeSupport.write(this, this, value, true, false, false);
  }
}
