 ...
 */
@NullMarked
public final class IBaseEthernetCapabilitiesTypeView extends ServerObjectView
    implements IBaseEthernetCapabilitiesType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IBaseEthernetCapabilitiesType> TYPE =
      ServerViewType.of(
  ...
  private IBaseEthernetCapabilitiesTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "VlanTagCapable");
  ...
  @Override
  public BaseDataVariableType getVlanTagCapableNode() {
  ...
  @Override
  public @Nullable Boolean getVlanTagCapable() {
    this.views.checkOpen();
    views.checkOpen();
    var child = viewMember0();
    if (child == null) {
  ...
  @Override
  public void setVlanTagCapable(@Nullable Boolean value) {
    this.views.checkOpen();
    views.checkOpen();
    var child = viewMember0();
    if (child == null) {
