 ...
 */
@FunctionalInterface
public interface KeyCredentialConfigurationTypeGetEncryptingKeyDetailedHandler {
  /**
   ...
   * @param requestedSecurityPolicyUri the input value; supplied null is retained
