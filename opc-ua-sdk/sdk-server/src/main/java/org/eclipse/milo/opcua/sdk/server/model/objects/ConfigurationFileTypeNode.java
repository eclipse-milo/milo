...
import org.eclipse.milo.opcua.sdk.server.model.methods.ConfigurationFileTypeCloseAndUpdateDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.ConfigurationFileTypeCloseAndUpdateHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.ConfigurationFileTypeConfirmUpdateDetailedHandler;
import org.eclipse.milo.opcua.sdk.server.model.methods.ConfigurationFileTypeConfirmUpdateHandler;
...
public class ConfigurationFileTypeNode extends FileTypeNode implements ConfigurationFileType {
  ...
  public PropertyTypeNode getLastUpdateTimeNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "LastUpdateTime");
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    ...
                    + " while resolving http://opcfoundation.org/UA/:LastUpdateTime (declaration"
  ...
  public @Nullable DateTime getLastUpdateTime() {
    var node = getLastUpdateTimeNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:LastUpdateTime (declaration i=15438, owner i=15437)"
  ...
  public PropertyTypeNode getCurrentVersionNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "CurrentVersion");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:CurrentVersion (declaration"
  ...
  public @Nullable UInteger getCurrentVersion() {
    var node = getCurrentVersionNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:CurrentVersion (declaration i=15439, owner i=15437)"
  ...
  public PropertyTypeNode getActivityTimeoutNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "ActivityTimeout");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ActivityTimeout (declaration"
                    + " i=15503, owner i=15437) on "
                    + getNodeId());
          }
          if (!(referenceTypeTree.isSubtypeOf(
              reference.getReferenceTypeId(), referenceId.orElseThrow()))) {
  ...
  public @Nullable Double getActivityTimeout() {
    var node = getActivityTimeoutNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ActivityTimeout (declaration i=15503, owner i=15437)"
  ...
  public PropertyTypeNode getSupportedDataTypeNode() {
    UaNode parent = this;
    {
      ...
      var browseName = new QualifiedName(namespaceIndex, "SupportedDataType");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:SupportedDataType (declaration"
  ...
  public @Nullable NodeId getSupportedDataType() {
    var node = getSupportedDataTypeNode();
    if (node == null) {
      throw new UaRuntimeException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SupportedDataType (declaration i=15504, owner i=15437)"
  ...
  public UaMethodNode getConfirmUpdateMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:ConfirmUpdate (declaration i=15508, owner i=15437)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "ConfirmUpdate");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:ConfirmUpdate (declaration"
  ...
  @Override
  public MethodBinding bindConfirmUpdate(
      MethodBindings bindings, ConfigurationFileTypeConfirmUpdateHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getConfirmUpdateMethodNode();
    if (methodNode == null) {
    ...
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            @Nullable UUID callbackInput0 = null;
            if (inputValues.length > 0) {
              try {
                @Nullable UUID convertedInput0;
                {
                  ...
                  try {
                    ...
                    convertedInput0 = (UUID) methodValue;
                ...
                @Nullable UUID projectedInput0;
                {
                  ...
                  try {
                    ...
                    projectedInput0 = (UUID) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
  ...
  @Override
  public MethodBinding bindConfirmUpdateDetailed(
      MethodBindings bindings, ConfigurationFileTypeConfirmUpdateDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getConfirmUpdateMethodNode();
  ...
  public UaMethodNode getCloseAndUpdateMethodNode() {
    UaNode parent = this;
    {
      ...
      if (namespaceIndex == null || referenceId.isEmpty()) {
        throw new UaRuntimeException(
            StatusCodes.Bad_NodeIdInvalid,
            "http://opcfoundation.org/UA/:CloseAndUpdate (declaration i=15505, owner i=15437)"
                + " on "
                + getNodeId());
      }
      var browseName = new QualifiedName(namespaceIndex, "CloseAndUpdate");
      var matches = new LinkedHashMap<NodeId, UaNode>();
      for (var reference : parent.getReferences()) {
        if (!reference.isForward()) {
          continue;
        ...
        if (!reference.getReferenceTypeId().equals(referenceId.orElseThrow())) {
          ...
          if (!referenceTypeTree.containsType(reference.getReferenceTypeId())) {
            throw new UaRuntimeException(
                ...
                "Unavailable ReferenceType "
                    + reference.getReferenceTypeId()
                    + " while resolving http://opcfoundation.org/UA/:CloseAndUpdate (declaration"
  ...
  @Override
  public MethodBinding bindCloseAndUpdate(
      MethodBindings bindings, ConfigurationFileTypeCloseAndUpdateHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getCloseAndUpdateMethodNode();
    if (methodNode == null) {
      throw new UaException(StatusCodes.Bad_NotFound, "Cannot bind an absent Method");
    }
    return bindings.bind(
        ...
        new AbstractMethodInvocationHandler(methodNode) {
          ...
          protected CallMethodResult invokeResult(
            ...
            @Nullable ConfigurationUpdateTargetType @Nullable [] callbackInput2 = null;
            if (inputValues.length > 2) {
              try {
                @Nullable ConfigurationUpdateTargetType @Nullable [] convertedInput2;
                {
                  ...
                  try {
                    ...
                    if (methodValue == null) {
                      ...
                      convertedInput2 =
                          new ConfigurationUpdateTargetType[Array.getLength(methodValue)];
                      for (int valueIndex = 0; valueIndex < convertedInput2.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        convertedInput2[valueIndex] = (ConfigurationUpdateTargetType) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                ...
                @Nullable ConfigurationUpdateTargetType @Nullable [] projectedInput2;
                {
                  Object methodValue = inputValues[2].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    if (methodValue == null) {
                      ...
                      for (int valueIndex = 0; valueIndex < projectedInput2.length; valueIndex++) {
                        Object valueElement = Array.get(methodValue, valueIndex);
                        projectedInput2[valueIndex] = (ConfigurationUpdateTargetType) valueElement;
                      }
                    }
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
            ...
            @Nullable Double callbackInput3 = null;
            if (inputValues.length > 3) {
              try {
                @Nullable Double convertedInput3;
                {
                  ...
                  try {
                    ...
                    convertedInput3 = (Double) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
                ...
                @Nullable Double projectedInput3;
                {
                  Object methodValue = inputValues[3].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    projectedInput3 = (Double) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
            ...
            @Nullable Double callbackInput4 = null;
            if (inputValues.length > 4) {
              try {
                @Nullable Double convertedInput4;
                {
                  ...
                  try {
                    ...
                    convertedInput4 = (Double) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
                ...
                @Nullable Double projectedInput4;
                {
                  Object methodValue = inputValues[4].getValue();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                    ...
                    projectedInput4 = (Double) methodValue;
                  } catch (UaSerializationException conversionFailure) {
                    throw new UaException(
                        conversionFailure.getStatusCode().getValue() == StatusCodes.Bad_OutOfRange
                            ? StatusCodes.Bad_OutOfRange
            ...
            try {
              ConfigurationFileTypeCloseAndUpdateOutputs outputs =
                  handler.invoke(
                      context,
                      callbackInput0,
                      callbackInput1,
              ...
              Variant outputValue0;
              {
                ...
                {
                  Object methodValue = outputs.updateResults();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument UpdateResults (effective property i=15507, DataType"
                              + " i=19) is unavailable in the effective type tree; resolved"
                              + " DataType: "
                              + argumentDataTypeId);
                    }
              ...
              Variant outputValue1;
              {
                ...
                {
                  Object methodValue = outputs.newVersion();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument NewVersion (effective property i=15507, DataType"
                              + " i=20998) is unavailable in the effective type tree; resolved"
                              + " DataType: "
                              + argumentDataTypeId);
                    }
                    Object numericElements =
              ...
              Variant outputValue2;
              {
                ...
                {
                  Object methodValue = outputs.updateId();
                  try {
                    if (methodValue instanceof Matrix && ((Matrix) methodValue).isNull()) {
                      methodValue = null;
                    }
                    ...
                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                      ...
                      throw new UaException(
                          StatusCodes.Bad_TypeMismatch,
                          "Method argument UpdateId (effective property i=15507, DataType i=14) is"
  ...
  @Override
  public MethodBinding bindCloseAndUpdateDetailed(
      MethodBindings bindings, ConfigurationFileTypeCloseAndUpdateDetailedHandler handler)
      throws UaException {
    Objects.requireNonNull(bindings, "bindings");
    Objects.requireNonNull(handler, "handler");
    UaMethodNode methodNode = getCloseAndUpdateMethodNode();
