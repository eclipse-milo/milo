 ...
 */
@NullMarked
public final class IIeeeTsnMacAddressTypeView extends ServerObjectView
    implements IIeeeTsnMacAddressType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<IIeeeTsnMacAddressType> TYPE =
      ServerViewType.of(
  ...
  private IIeeeTsnMacAddressTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
        ...
        ((Supplier<UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "DestinationAddress");
        ...
        ((Supplier<@Nullable UaVariableNode>)
                () -> {
                  UaNode parent = this.node;
                  {
                    ...
                    var browseName = new QualifiedName(namespaceIndex, "SourceAddress");
                    var matches = new LinkedHashMap<NodeId, UaNode>();
                    for (var reference : parent.getReferences()) {
                      if (!reference.isForward()) {
                        continue;
   ...
   */
  @Override
  public @Nullable BaseDataVariableType getSourceAddressNode() {
    this.views.checkOpen();
    views.checkOpen();
