...
public class IOrderedObjectTypeNode extends BaseInterfaceTypeNode implements IOrderedObjectType {
  ...
  @Override
  public @Nullable Variant getNumberInList() {
    return ServerNodeSupport.read(this, getNumberInListNode(), Variant.class, null);
  }

  @Override
  public void setNumberInList(@Nullable Variant value) {
    ServerNodeSupport.write(this, getNumberInListNode(), value, false, false, false);
  }
