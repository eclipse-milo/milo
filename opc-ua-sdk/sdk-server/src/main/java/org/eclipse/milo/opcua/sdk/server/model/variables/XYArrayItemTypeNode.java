...
public class XYArrayItemTypeNode extends ArrayItemTypeNode implements XYArrayItemType {
  ...
  @Override
  public @Nullable XVType @Nullable [] getXYArrayItemValue() {
    return ServerNodeSupport.readArray(this, this, XVType.class, null);
  }

  @Override
  public void setXYArrayItemValue(@Nullable XVType @Nullable [] value) {
