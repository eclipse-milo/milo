 ...
 *
 * <p>Selected <code>BaseInterfaceType</code> contract over one retained backing node. Obtain this
 ...
 */
@NullMarked
public final class BaseInterfaceTypeView extends ServerObjectView implements BaseInterfaceType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ServerViewType<BaseInterfaceType> TYPE =
      ServerViewType.of(
          ExpandedNodeId.parse("i=17602"), BaseInterfaceType.class, BaseInterfaceTypeView::new);
  ...
  private BaseInterfaceTypeView(ServerViews views, UaObjectNode node) {
    super(views, node);
  }
}
