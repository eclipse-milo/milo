 ...
 */
@FunctionalInterface
public interface ExtensionFieldsTypeAddExtensionFieldDetailedHandler {
  /**
   ...
   * @param fieldName the input value; supplied null is retained
   * @param fieldValue the input value; supplied null is retained
