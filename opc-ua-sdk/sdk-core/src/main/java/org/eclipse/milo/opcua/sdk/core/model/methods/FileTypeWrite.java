...
/**
 * Declared arguments and typed wire conversion for the Write Method of FileType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.2.5">Model
 *     documentation</a>
 */
public final class FileTypeWrite {
  private FileTypeWrite() {}
  ...
  public static record Inputs(@Nullable UInteger fileHandle, @Nullable ByteString data) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        ...
        MethodValues.encode(context, data, 1, ByteString.class, -1, new long[] {}, null)
      };
    }
