...
/**
 * Declared arguments and typed wire conversion for the RemoveDataSetReader Method of
 * ReaderGroupType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.6/#9.1.6.11">Model
 *     documentation</a>
 */
public final class ReaderGroupTypeRemoveDataSetReader {
  private ReaderGroupTypeRemoveDataSetReader() {}
  ...
  public static record Inputs(@Nullable NodeId dataSetReaderNodeId) {
    /**
