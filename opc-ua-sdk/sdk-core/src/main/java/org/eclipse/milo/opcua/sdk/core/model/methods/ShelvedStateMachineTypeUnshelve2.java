...
/**
 * Declared arguments and typed wire conversion for the Unshelve2 Method of ShelvedStateMachineType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.17/#5.8.17.3">Model
 *     documentation</a>
 */
public final class ShelvedStateMachineTypeUnshelve2 {
  private ShelvedStateMachineTypeUnshelve2() {}
  ...
  public static record Inputs(@Nullable LocalizedText comment) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, comment, 0, LocalizedText.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (LocalizedText)
              MethodValues.decode(
                  context, values, 0, LocalizedText.class, -1, new long[] {}, null));
    }
  }
}
