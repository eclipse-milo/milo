...
/**
 * Declared arguments and typed wire conversion for the Open Method of FileType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.2.2">Model
 *     documentation</a>
 */
public final class FileTypeOpen {
  private FileTypeOpen() {}
  ...
  public static record Inputs(@Nullable UByte mode) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, mode, 0, UByte.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (UByte) MethodValues.decode(context, values, 0, UByte.class, -1, new long[] {}, null));
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(@Nullable UInteger fileHandle) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
