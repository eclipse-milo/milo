...
/**
 * Declared arguments and typed wire conversion for the AddAliasesToCategory Method of
 * AliasNameCategoryType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part17/6.3.4">Model
 *     documentation</a>
 */
public final class AliasNameCategoryTypeAddAliasesToCategory {
  private AliasNameCategoryTypeAddAliasesToCategory() {}
  ...
  public static record Inputs(
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        ...
        MethodValues.encode(
            context, targetNodes, 1, ExpandedNodeId.class, 1, new long[] {0L}, null),
        MethodValues.encode(context, targetServers, 2, String.class, 1, new long[] {0L}, null),
        MethodValues.encode(context, targetReferenceType, 3, NodeId.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          ...
          (NodeId) MethodValues.decode(context, values, 3, NodeId.class, -1, new long[] {}, null));
    }
    ...
    public boolean equals(@Nullable Object other) {
      return other instanceof Inputs value
          && Arrays.deepEquals(
              new Object[] {aliasNames, targetNodes, targetServers, targetReferenceType},
              new Object[] {
                value.aliasNames, value.targetNodes, value.targetServers, value.targetReferenceType
              });
    }
