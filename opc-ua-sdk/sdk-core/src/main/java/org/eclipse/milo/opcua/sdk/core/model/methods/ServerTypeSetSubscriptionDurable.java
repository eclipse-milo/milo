...
/**
 * Declared arguments and typed wire conversion for the SetSubscriptionDurable Method of ServerType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part5/9.3">Model
 *     documentation</a>
 */
public final class ServerTypeSetSubscriptionDurable {
  private ServerTypeSetSubscriptionDurable() {}
  ...
  public static record Inputs(
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        ...
        MethodValues.encode(context, lifetimeInHours, 1, UInteger.class, -1, new long[] {}, null)
      };
    }
  ...
  public static record Outputs(@Nullable UInteger revisedLifetimeInHours) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, revisedLifetimeInHours, 0, UInteger.class, -1, new long[] {}, null)
      };
    }
