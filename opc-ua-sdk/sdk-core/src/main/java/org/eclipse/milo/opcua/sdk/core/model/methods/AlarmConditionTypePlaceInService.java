...
/**
 * Declared arguments and typed wire conversion for the PlaceInService Method of AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.14">Model
 *     documentation</a>
 */
public final class AlarmConditionTypePlaceInService {
  private AlarmConditionTypePlaceInService() {}
