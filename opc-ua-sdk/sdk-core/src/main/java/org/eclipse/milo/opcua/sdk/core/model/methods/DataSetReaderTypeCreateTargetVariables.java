...
/**
 * Declared arguments and typed wire conversion for the CreateTargetVariables Method of
 * DataSetReaderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.8/#9.1.8.5">Model
 *     documentation</a>
 */
public final class DataSetReaderTypeCreateTargetVariables {
  private DataSetReaderTypeCreateTargetVariables() {}
