...
/**
 * Declared arguments and typed wire conversion for the ReleaseContinuationPoint Method of
 * LogObjectType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part26/5.4">Model
 *     documentation</a>
 */
public final class LogObjectTypeReleaseContinuationPoint {
  private LogObjectTypeReleaseContinuationPoint() {}
  ...
  public static record Inputs(@Nullable ByteString continuationPointIn) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, continuationPointIn, 0, ByteString.class, -1, new long[] {}, null)
      };
    }
