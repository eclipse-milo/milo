...
/**
 * Declared arguments and typed wire conversion for the GenerateFileForWrite Method of
 * TemporaryFileTransferType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.4.4">Model
 *     documentation</a>
 */
public final class TemporaryFileTransferTypeGenerateFileForWrite {
  private TemporaryFileTransferTypeGenerateFileForWrite() {}
  ...
  public static record Inputs(@Nullable Variant generateOptions) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, generateOptions, 0, Variant.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (Variant)
              MethodValues.decode(context, values, 0, Variant.class, -1, new long[] {}, null));
    }
  }
