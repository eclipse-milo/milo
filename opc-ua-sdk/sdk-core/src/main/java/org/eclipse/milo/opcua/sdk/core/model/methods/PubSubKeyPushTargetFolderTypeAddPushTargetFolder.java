...
/**
 * Declared arguments and typed wire conversion for the AddPushTargetFolder Method of
 * PubSubKeyPushTargetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.7.4">Model
 *     documentation</a>
 */
public final class PubSubKeyPushTargetFolderTypeAddPushTargetFolder {
  private PubSubKeyPushTargetFolderTypeAddPushTargetFolder() {}
  ...
  public static record Outputs(@Nullable NodeId pushTargetFolderNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, pushTargetFolderNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
