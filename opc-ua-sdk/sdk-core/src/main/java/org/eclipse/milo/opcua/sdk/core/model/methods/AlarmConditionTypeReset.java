...
/**
 * Declared arguments and typed wire conversion for the Reset Method of AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.5">Model
 *     documentation</a>
 */
public final class AlarmConditionTypeReset {
  private AlarmConditionTypeReset() {}
