...
/**
 * Declared arguments and typed wire conversion for the AddDataSetReader Method of ReaderGroupType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.6/#9.1.6.10">Model
 *     documentation</a>
 */
public final class ReaderGroupTypeAddDataSetReader {
  private ReaderGroupTypeAddDataSetReader() {}
  ...
  public static Argument[] inputArguments(NamespaceTable namespaceTable) {
    return new Argument[] {
      new Argument(
          "Configuration",
          ExpandedNodeId.of(Namespaces.OPC_UA, 15623L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=15623")),
          -1,
          new UInteger[] {},
  ...
  public static record Inputs(@Nullable DataSetReaderDataType configuration) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, configuration, 0, DataSetReaderDataType.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (DataSetReaderDataType)
              MethodValues.decode(
                  context, values, 0, DataSetReaderDataType.class, -1, new long[] {}, null));
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(@Nullable NodeId dataSetReaderNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, dataSetReaderNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
