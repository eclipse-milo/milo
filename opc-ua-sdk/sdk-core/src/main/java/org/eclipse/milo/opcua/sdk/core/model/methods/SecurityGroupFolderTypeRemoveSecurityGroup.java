...
/**
 * Declared arguments and typed wire conversion for the RemoveSecurityGroup Method of
 * SecurityGroupFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.5.3">Model
 *     documentation</a>
 */
public final class SecurityGroupFolderTypeRemoveSecurityGroup {
  private SecurityGroupFolderTypeRemoveSecurityGroup() {}
  ...
  public static record Inputs(@Nullable NodeId securityGroupNodeId) {
    /**
