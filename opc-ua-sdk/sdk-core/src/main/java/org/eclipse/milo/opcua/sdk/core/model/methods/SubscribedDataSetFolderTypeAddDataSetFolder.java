...
/**
 * Declared arguments and typed wire conversion for the AddDataSetFolder Method of
 * SubscribedDataSetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.4">Model
 *     documentation</a>
 */
public final class SubscribedDataSetFolderTypeAddDataSetFolder {
  private SubscribedDataSetFolderTypeAddDataSetFolder() {}
  ...
  public static record Outputs(@Nullable NodeId dataSetFolderNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, dataSetFolderNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
