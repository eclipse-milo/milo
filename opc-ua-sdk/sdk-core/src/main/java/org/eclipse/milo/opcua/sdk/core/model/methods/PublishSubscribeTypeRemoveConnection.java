...
/**
 * Declared arguments and typed wire conversion for the RemoveConnection Method of
 * PublishSubscribeType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.3/#9.1.3.5">Model
 *     documentation</a>
 */
public final class PublishSubscribeTypeRemoveConnection {
  private PublishSubscribeTypeRemoveConnection() {}
  ...
  public static record Inputs(@Nullable NodeId connectionId) {
    /**
