...
/**
 * Declared arguments and typed wire conversion for the FindAliasVerbose Method of
 * AliasNameCategoryType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part17/6.3.3">Model
 *     documentation</a>
 */
public final class AliasNameCategoryTypeFindAliasVerbose {
  private AliasNameCategoryTypeFindAliasVerbose() {}
  ...
  public static Argument[] outputArguments(NamespaceTable namespaceTable) {
    return new Argument[] {
      new Argument(
          "AliasNodeList",
          ExpandedNodeId.of(Namespaces.OPC_UA, 24051L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=24051")),
          1,
  ...
  public static record Outputs(@Nullable AliasNameVerboseDataType @Nullable [] aliasNodeList) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, aliasNodeList, 0, AliasNameVerboseDataType.class, 1, new long[] {0L}, null)
      };
    }
    ...
    public static Outputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Outputs(
          (@Nullable AliasNameVerboseDataType[])
              MethodValues.decode(
                  context, values, 0, AliasNameVerboseDataType.class, 1, new long[] {0L}, null));
    }
