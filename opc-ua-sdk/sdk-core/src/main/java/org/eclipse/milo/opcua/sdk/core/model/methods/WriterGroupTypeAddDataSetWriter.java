...
/**
 * Declared arguments and typed wire conversion for the AddDataSetWriter Method of WriterGroupType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.6/#9.1.6.4">Model
 *     documentation</a>
 */
public final class WriterGroupTypeAddDataSetWriter {
  private WriterGroupTypeAddDataSetWriter() {}
  ...
  public static Argument[] inputArguments(NamespaceTable namespaceTable) {
    return new Argument[] {
      new Argument(
          "Configuration",
          ExpandedNodeId.of(Namespaces.OPC_UA, 15597L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=15597")),
          -1,
          new UInteger[] {},
  ...
  public static record Inputs(@Nullable DataSetWriterDataType configuration) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, configuration, 0, DataSetWriterDataType.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (DataSetWriterDataType)
              MethodValues.decode(
                  context, values, 0, DataSetWriterDataType.class, -1, new long[] {}, null));
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(@Nullable NodeId dataSetWriterNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, dataSetWriterNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
