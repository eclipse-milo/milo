...
/**
 * Declared arguments and typed wire conversion for the RemoveCertificate Method of TrustListType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part12/7.8.2/#7.8.2.7">Model
 *     documentation</a>
 */
public final class TrustListTypeRemoveCertificate {
  private TrustListTypeRemoveCertificate() {}
  ...
  public static record Inputs(@Nullable String thumbprint, @Nullable Boolean isTrustedCertificate) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, thumbprint, 0, String.class, -1, new long[] {}, null),
        MethodValues.encode(
            context, isTrustedCertificate, 1, Boolean.class, -1, new long[] {}, null)
      };
    }
