...
/**
 * Declared arguments and typed wire conversion for the Unsuppress Method of AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.10">Model
 *     documentation</a>
 */
public final class AlarmConditionTypeUnsuppress {
  private AlarmConditionTypeUnsuppress() {}
