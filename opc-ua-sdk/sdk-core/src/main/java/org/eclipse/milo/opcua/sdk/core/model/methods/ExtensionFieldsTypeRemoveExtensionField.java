...
/**
 * Declared arguments and typed wire conversion for the RemoveExtensionField Method of
 * ExtensionFieldsType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.4/#9.1.4.2.4">Model
 *     documentation</a>
 */
public final class ExtensionFieldsTypeRemoveExtensionField {
  private ExtensionFieldsTypeRemoveExtensionField() {}
  ...
  public static record Inputs(@Nullable NodeId fieldId) {
    /**
