...
/**
 * Declared arguments and typed wire conversion for the RemoveUser Method of UserManagementType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/5.2.7">Model
 *     documentation</a>
 */
public final class UserManagementTypeRemoveUser {
  private UserManagementTypeRemoveUser() {}
  ...
  public static record Inputs(@Nullable String userName) {
    /**
