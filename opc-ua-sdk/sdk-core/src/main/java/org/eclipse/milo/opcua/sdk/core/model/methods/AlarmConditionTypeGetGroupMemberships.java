...
/**
 * Declared arguments and typed wire conversion for the GetGroupMemberships Method of
 * AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.16">Model
 *     documentation</a>
 */
public final class AlarmConditionTypeGetGroupMemberships {
  private AlarmConditionTypeGetGroupMemberships() {}
  ...
  public static record Outputs(NodeId @Nullable [] groups) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, groups, 0, NodeId.class, 1, new long[] {0L}, null)
      };
    }
    ...
    public boolean equals(@Nullable Object other) {
      return other instanceof Outputs value
          && Arrays.deepEquals(new Object[] {groups}, new Object[] {value.groups});
    }

    @Override
    public int hashCode() {
      return Arrays.deepHashCode(new Object[] {groups});
    }

    @Override
    public String toString() {
      return "Outputs" + Arrays.deepToString(new Object[] {groups});
    }
  }
}
