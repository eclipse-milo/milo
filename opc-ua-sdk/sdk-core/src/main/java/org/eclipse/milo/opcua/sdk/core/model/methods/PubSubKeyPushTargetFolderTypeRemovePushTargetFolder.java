...
/**
 * Declared arguments and typed wire conversion for the RemovePushTargetFolder Method of
 * PubSubKeyPushTargetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.7.5">Model
 *     documentation</a>
 */
public final class PubSubKeyPushTargetFolderTypeRemovePushTargetFolder {
  private PubSubKeyPushTargetFolderTypeRemovePushTargetFolder() {}
  ...
  public static record Inputs(@Nullable NodeId pushTargetFolderNodeId) {
    /**
