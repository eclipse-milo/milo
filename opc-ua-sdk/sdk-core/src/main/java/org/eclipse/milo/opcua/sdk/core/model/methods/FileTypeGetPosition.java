...
/**
 * Declared arguments and typed wire conversion for the GetPosition Method of FileType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.2.6">Model
 *     documentation</a>
 */
public final class FileTypeGetPosition {
  private FileTypeGetPosition() {}
  ...
  public static record Outputs(@Nullable ULong position) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, position, 0, ULong.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Outputs fromVariants(EncodingContext context, Variant[] values)
      ...
      MethodValues.count(values, 1, 1);
      return new Outputs(
          (ULong) MethodValues.decode(context, values, 0, ULong.class, -1, new long[] {}, null));
    }
  }
}
