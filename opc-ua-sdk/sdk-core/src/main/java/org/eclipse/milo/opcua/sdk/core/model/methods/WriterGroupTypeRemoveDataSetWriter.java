...
/**
 * Declared arguments and typed wire conversion for the RemoveDataSetWriter Method of
 * WriterGroupType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.6/#9.1.6.5">Model
 *     documentation</a>
 */
public final class WriterGroupTypeRemoveDataSetWriter {
  private WriterGroupTypeRemoveDataSetWriter() {}
  ...
  public static record Inputs(@Nullable NodeId dataSetWriterNodeId) {
    /**
