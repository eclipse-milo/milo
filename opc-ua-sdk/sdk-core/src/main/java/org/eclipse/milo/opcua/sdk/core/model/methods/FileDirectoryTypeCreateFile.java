...
/**
 * Declared arguments and typed wire conversion for the CreateFile Method of FileDirectoryType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.3.4">Model
 *     documentation</a>
 */
public final class FileDirectoryTypeCreateFile {
  private FileDirectoryTypeCreateFile() {}
  ...
  public static record Inputs(@Nullable String fileName, @Nullable Boolean requestFileOpen) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, fileName, 0, String.class, -1, new long[] {}, null),
        MethodValues.encode(context, requestFileOpen, 1, Boolean.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          ...
          (Boolean)
              MethodValues.decode(context, values, 1, Boolean.class, -1, new long[] {}, null));
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(@Nullable NodeId fileNodeId, @Nullable UInteger fileHandle) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, fileNodeId, 0, NodeId.class, -1, new long[] {}, null),
        MethodValues.encode(context, fileHandle, 1, UInteger.class, -1, new long[] {}, null)
      };
    }
