...
/**
 * Declared arguments and typed wire conversion for the Disable Method of PubSubStatusType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.10/#9.1.10.3">Model
 *     documentation</a>
 */
public final class PubSubStatusTypeDisable {
  private PubSubStatusTypeDisable() {}
