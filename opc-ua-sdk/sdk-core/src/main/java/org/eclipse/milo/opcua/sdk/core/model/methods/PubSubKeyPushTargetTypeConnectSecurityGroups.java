...
/**
 * Declared arguments and typed wire conversion for the ConnectSecurityGroups Method of
 * PubSubKeyPushTargetType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.6.3">Model
 *     documentation</a>
 */
public final class PubSubKeyPushTargetTypeConnectSecurityGroups {
  private PubSubKeyPushTargetTypeConnectSecurityGroups() {}
  ...
  public static record Outputs(StatusCode @Nullable [] connectResults) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, connectResults, 0, StatusCode.class, 1, new long[] {0L}, null)
      };
    }
    ...
    public boolean equals(@Nullable Object other) {
      return other instanceof Outputs value
          && Arrays.deepEquals(new Object[] {connectResults}, new Object[] {value.connectResults});
    }

    @Override
    public int hashCode() {
      return Arrays.deepHashCode(new Object[] {connectResults});
    }

    @Override
    public String toString() {
      return "Outputs" + Arrays.deepToString(new Object[] {connectResults});
    }
  }
}
