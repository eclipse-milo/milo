...
/**
 * Declared arguments and typed wire conversion for the DeletePriorityMappingEntry Method of
 * PriorityMappingTableType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part22/5.5.2/#5.5.2.4">Model
 *     documentation</a>
 */
public final class PriorityMappingTableTypeDeletePriorityMappingEntry {
  private PriorityMappingTableTypeDeletePriorityMappingEntry() {}
  ...
  public static record Inputs(@Nullable String mappingUri, @Nullable String priorityLabel) {
    /**
