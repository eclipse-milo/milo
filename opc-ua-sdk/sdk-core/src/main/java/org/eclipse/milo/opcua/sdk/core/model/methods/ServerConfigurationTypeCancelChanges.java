...
/**
 * Declared arguments and typed wire conversion for the CancelChanges Method of
 * ServerConfigurationType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part12/7.10.11">Model
 *     documentation</a>
 */
public final class ServerConfigurationTypeCancelChanges {
  private ServerConfigurationTypeCancelChanges() {}
