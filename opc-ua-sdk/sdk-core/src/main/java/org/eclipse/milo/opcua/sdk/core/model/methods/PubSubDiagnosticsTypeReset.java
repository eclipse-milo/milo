...
/**
 * Declared arguments and typed wire conversion for the Reset Method of PubSubDiagnosticsType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.11/#9.1.11.3">Model
 *     documentation</a>
 */
public final class PubSubDiagnosticsTypeReset {
  private PubSubDiagnosticsTypeReset() {}
