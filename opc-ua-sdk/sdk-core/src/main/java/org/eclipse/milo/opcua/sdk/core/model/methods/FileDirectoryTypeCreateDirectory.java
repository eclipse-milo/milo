...
/**
 * Declared arguments and typed wire conversion for the CreateDirectory Method of FileDirectoryType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.3.3">Model
 *     documentation</a>
 */
public final class FileDirectoryTypeCreateDirectory {
  private FileDirectoryTypeCreateDirectory() {}
  ...
  public static record Inputs(@Nullable String directoryName) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, directoryName, 0, String.class, -1, new long[] {}, null)
      };
    }
  ...
  public static record Outputs(@Nullable NodeId directoryNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, directoryNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
