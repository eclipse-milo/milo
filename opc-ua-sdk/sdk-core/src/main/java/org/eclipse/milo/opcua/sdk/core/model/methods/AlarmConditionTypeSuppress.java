...
/**
 * Declared arguments and typed wire conversion for the Suppress Method of AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.8">Model
 *     documentation</a>
 */
public final class AlarmConditionTypeSuppress {
  private AlarmConditionTypeSuppress() {}
