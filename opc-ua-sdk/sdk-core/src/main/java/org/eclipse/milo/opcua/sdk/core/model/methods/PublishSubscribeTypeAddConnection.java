...
/**
 * Declared arguments and typed wire conversion for the AddConnection Method of
 * PublishSubscribeType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.3/#9.1.3.4">Model
 *     documentation</a>
 */
public final class PublishSubscribeTypeAddConnection {
  private PublishSubscribeTypeAddConnection() {}
  ...
  public static Argument[] inputArguments(NamespaceTable namespaceTable) {
    return new Argument[] {
      new Argument(
          "Configuration",
          ExpandedNodeId.of(Namespaces.OPC_UA, 15617L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=15617")),
          -1,
          new UInteger[] {},
  ...
  public static record Inputs(@Nullable PubSubConnectionDataType configuration) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, configuration, 0, PubSubConnectionDataType.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (PubSubConnectionDataType)
              MethodValues.decode(
                  context, values, 0, PubSubConnectionDataType.class, -1, new long[] {}, null));
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(@Nullable NodeId connectionId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, connectionId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
