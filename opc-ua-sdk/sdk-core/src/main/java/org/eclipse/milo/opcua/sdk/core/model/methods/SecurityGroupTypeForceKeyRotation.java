...
/**
 * Declared arguments and typed wire conversion for the ForceKeyRotation Method of
 * SecurityGroupType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.4.3">Model
 *     documentation</a>
 */
public final class SecurityGroupTypeForceKeyRotation {
  private SecurityGroupTypeForceKeyRotation() {}
