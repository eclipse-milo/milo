...
/**
 * Declared arguments and typed wire conversion for the Delete Method of FileDirectoryType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.3.5">Model
 *     documentation</a>
 */
public final class FileDirectoryTypeDelete {
  private FileDirectoryTypeDelete() {}
  ...
  public static record Inputs(@Nullable NodeId objectToDelete) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, objectToDelete, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
