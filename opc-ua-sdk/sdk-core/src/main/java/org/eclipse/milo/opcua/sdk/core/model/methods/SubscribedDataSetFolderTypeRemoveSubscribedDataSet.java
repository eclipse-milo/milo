...
/**
 * Declared arguments and typed wire conversion for the RemoveSubscribedDataSet Method of
 * SubscribedDataSetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.3">Model
 *     documentation</a>
 */
public final class SubscribedDataSetFolderTypeRemoveSubscribedDataSet {
  private SubscribedDataSetFolderTypeRemoveSubscribedDataSet() {}
  ...
  public static record Inputs(@Nullable NodeId subscribedDataSetNodeId) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, subscribedDataSetNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
