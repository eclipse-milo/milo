...
/**
 * Declared arguments and typed wire conversion for the ApplyChanges Method of
 * ServerConfigurationType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part12/7.10.9">Model
 *     documentation</a>
 */
public final class ServerConfigurationTypeApplyChanges {
  private ServerConfigurationTypeApplyChanges() {}
