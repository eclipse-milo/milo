...
/**
 * Declared arguments and typed wire conversion for the RemoveTargetVariables Method of
 * TargetVariablesType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.2.3">Model
 *     documentation</a>
 */
public final class TargetVariablesTypeRemoveTargetVariables {
  private TargetVariablesTypeRemoveTargetVariables() {}
  ...
  public static record Inputs(
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            ...
            new long[] {},
            null),
        MethodValues.encode(context, targetsToRemove, 1, UInteger.class, 1, new long[] {0L}, null)
      };
    }
    ...
    public boolean equals(@Nullable Object other) {
      return other instanceof Inputs value
          && Arrays.deepEquals(
              new Object[] {configurationVersion, targetsToRemove},
              new Object[] {value.configurationVersion, value.targetsToRemove});
    }

    @Override
    public int hashCode() {
      return Arrays.deepHashCode(new Object[] {configurationVersion, targetsToRemove});
    }

    @Override
    public String toString() {
      return "Inputs" + Arrays.deepToString(new Object[] {configurationVersion, targetsToRemove});
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(StatusCode @Nullable [] removeResults) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, removeResults, 0, StatusCode.class, 1, new long[] {0L}, null)
      };
    }
    ...
    public boolean equals(@Nullable Object other) {
      return other instanceof Outputs value
          && Arrays.deepEquals(new Object[] {removeResults}, new Object[] {value.removeResults});
    }

    @Override
    public int hashCode() {
      return Arrays.deepHashCode(new Object[] {removeResults});
    }

    @Override
    public String toString() {
      return "Outputs" + Arrays.deepToString(new Object[] {removeResults});
    }
  }
}
