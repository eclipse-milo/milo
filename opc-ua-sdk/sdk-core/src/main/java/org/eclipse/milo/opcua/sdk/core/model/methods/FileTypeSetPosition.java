...
/**
 * Declared arguments and typed wire conversion for the SetPosition Method of FileType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.2.7">Model
 *     documentation</a>
 */
public final class FileTypeSetPosition {
  private FileTypeSetPosition() {}
    ...
    return new Argument[] {
      ...
      new Argument(
          ...
          ExpandedNodeId.of(Namespaces.OPC_UA, 9L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=9")),
          -1,
          new UInteger[] {},
          new LocalizedText(null, ""))
    };
  ...
  public static record Inputs(@Nullable UInteger fileHandle, @Nullable ULong position) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        ...
        MethodValues.encode(context, position, 1, ULong.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          ...
          (ULong) MethodValues.decode(context, values, 1, ULong.class, -1, new long[] {}, null));
    }
  }
}
