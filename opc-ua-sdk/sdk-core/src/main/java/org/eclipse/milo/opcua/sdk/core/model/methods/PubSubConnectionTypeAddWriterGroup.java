...
/**
 * Declared arguments and typed wire conversion for the AddWriterGroup Method of
 * PubSubConnectionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.5/#9.1.5.3">Model
 *     documentation</a>
 */
public final class PubSubConnectionTypeAddWriterGroup {
  private PubSubConnectionTypeAddWriterGroup() {}
  ...
  public static Argument[] inputArguments(NamespaceTable namespaceTable) {
    return new Argument[] {
      new Argument(
          "Configuration",
          ExpandedNodeId.of(Namespaces.OPC_UA, 15480L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=15480")),
          -1,
          new UInteger[] {},
  ...
  public static record Inputs(@Nullable WriterGroupDataType configuration) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, configuration, 0, WriterGroupDataType.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (WriterGroupDataType)
              MethodValues.decode(
                  context, values, 0, WriterGroupDataType.class, -1, new long[] {}, null));
    }
  }
