...
/**
 * Declared arguments and typed wire conversion for the RemoveRole Method of RoleSetType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/4.2.3">Model
 *     documentation</a>
 */
public final class RoleSetTypeRemoveRole {
  private RoleSetTypeRemoveRole() {}
  ...
  public static record Inputs(@Nullable NodeId roleNodeId) {
    /**
