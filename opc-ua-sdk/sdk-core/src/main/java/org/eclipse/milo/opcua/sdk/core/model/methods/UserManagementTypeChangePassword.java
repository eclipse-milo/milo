...
/**
 * Declared arguments and typed wire conversion for the ChangePassword Method of UserManagementType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/5.2.8">Model
 *     documentation</a>
 */
public final class UserManagementTypeChangePassword {
  private UserManagementTypeChangePassword() {}
  ...
  public static record Inputs(@Nullable String oldPassword, @Nullable String newPassword) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, oldPassword, 0, String.class, -1, new long[] {}, null),
        MethodValues.encode(context, newPassword, 1, String.class, -1, new long[] {}, null)
      };
    }
