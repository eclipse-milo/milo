...
/**
 * Declared arguments and typed wire conversion for the TimedShelve2 Method of
 * ShelvedStateMachineType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.17/#5.8.17.5">Model
 *     documentation</a>
 */
public final class ShelvedStateMachineTypeTimedShelve2 {
  private ShelvedStateMachineTypeTimedShelve2() {}
  ...
  public static record Inputs(@Nullable Double shelvingTime, @Nullable LocalizedText comment) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, shelvingTime, 0, Double.class, -1, new long[] {}, null),
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (Double) MethodValues.decode(context, values, 0, Double.class, -1, new long[] {}, null),
          (LocalizedText)
              MethodValues.decode(
