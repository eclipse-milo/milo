...
/**
 * Declared arguments and typed wire conversion for the GetSecurityGroup Method of
 * PubSubKeyServiceType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.3.3">Model
 *     documentation</a>
 */
public final class PubSubKeyServiceTypeGetSecurityGroup {
  private PubSubKeyServiceTypeGetSecurityGroup() {}
  ...
  public static record Inputs(@Nullable String securityGroupId) {
    /**
  ...
  public static record Outputs(@Nullable NodeId securityGroupNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, securityGroupNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
