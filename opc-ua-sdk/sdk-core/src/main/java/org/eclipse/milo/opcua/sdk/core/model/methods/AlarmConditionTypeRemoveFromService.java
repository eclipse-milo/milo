...
/**
 * Declared arguments and typed wire conversion for the RemoveFromService Method of
 * AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.12">Model
 *     documentation</a>
 */
public final class AlarmConditionTypeRemoveFromService {
  private AlarmConditionTypeRemoveFromService() {}
