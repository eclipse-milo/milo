...
/**
 * Declared arguments and typed wire conversion for the RemoveApplication Method of RoleType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/4.4.8">Model
 *     documentation</a>
 */
public final class RoleTypeRemoveApplication {
  private RoleTypeRemoveApplication() {}
  ...
  public static record Inputs(@Nullable String applicationUri) {
    /**
