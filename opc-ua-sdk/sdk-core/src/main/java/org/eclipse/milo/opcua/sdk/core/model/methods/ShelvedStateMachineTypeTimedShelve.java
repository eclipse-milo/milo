...
/**
 * Declared arguments and typed wire conversion for the TimedShelve Method of
 * ShelvedStateMachineType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.17/#5.8.17.4">Model
 *     documentation</a>
 */
public final class ShelvedStateMachineTypeTimedShelve {
  private ShelvedStateMachineTypeTimedShelve() {}
  ...
  public static record Inputs(@Nullable Double shelvingTime) {
    /**
