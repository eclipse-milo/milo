...
/**
 * Declared arguments and typed wire conversion for the AddRole Method of RoleSetType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/4.2.2">Model
 *     documentation</a>
 */
public final class RoleSetTypeAddRole {
  private RoleSetTypeAddRole() {}
  ...
  public static record Inputs(@Nullable String roleName, @Nullable String namespaceUri) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, roleName, 0, String.class, -1, new long[] {}, null),
        MethodValues.encode(context, namespaceUri, 1, String.class, -1, new long[] {}, null)
      };
    }
  ...
  public static record Outputs(@Nullable NodeId roleNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, roleNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
