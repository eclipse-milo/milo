...
/**
 * Declared arguments and typed wire conversion for the RemovePublishedDataSet Method of
 * DataSetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.4/#9.1.4.5.6">Model
 *     documentation</a>
 */
public final class DataSetFolderTypeRemovePublishedDataSet {
  private DataSetFolderTypeRemovePublishedDataSet() {}
  ...
  public static record Inputs(@Nullable NodeId dataSetNodeId) {
    /**
