...
/**
 * Declared arguments and typed wire conversion for the RemoveIdentity Method of RoleType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/4.4.6">Model
 *     documentation</a>
 */
public final class RoleTypeRemoveIdentity {
  private RoleTypeRemoveIdentity() {}
    ...
    return new Argument[] {
      new Argument(
          ...
          ExpandedNodeId.of(Namespaces.OPC_UA, 15634L)
              ...
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=15634")),
          -1,
          new UInteger[] {},
  ...
  public static record Inputs(@Nullable IdentityMappingRuleType rule) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, rule, 0, IdentityMappingRuleType.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (IdentityMappingRuleType)
              MethodValues.decode(
                  context, values, 0, IdentityMappingRuleType.class, -1, new long[] {}, null));
    }
  }
}
