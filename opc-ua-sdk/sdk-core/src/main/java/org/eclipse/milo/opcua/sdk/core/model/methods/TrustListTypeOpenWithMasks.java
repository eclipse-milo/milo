...
/**
 * Declared arguments and typed wire conversion for the OpenWithMasks Method of TrustListType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part12/7.8.2/#7.8.2.3">Model
 *     documentation</a>
 */
public final class TrustListTypeOpenWithMasks {
  private TrustListTypeOpenWithMasks() {}
  ...
  public static record Inputs(@Nullable UInteger masks) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, masks, 0, UInteger.class, -1, new long[] {}, null)
      };
    }
