...
/**
 * Declared arguments and typed wire conversion for the TriggerKeyUpdate Method of
 * PubSubKeyPushTargetType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.6.6">Model
 *     documentation</a>
 */
public final class PubSubKeyPushTargetTypeTriggerKeyUpdate {
  private PubSubKeyPushTargetTypeTriggerKeyUpdate() {}
