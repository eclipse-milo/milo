...
/**
 * Declared arguments and typed wire conversion for the ConfirmUpdate Method of
 * ConfigurationFileType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part12/7.8.5/#7.8.5.3">Model
 *     documentation</a>
 */
public final class ConfigurationFileTypeConfirmUpdate {
  private ConfigurationFileTypeConfirmUpdate() {}
  ...
  public static record Inputs(@Nullable UUID updateId) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, updateId, 0, UUID.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (UUID) MethodValues.decode(context, values, 0, UUID.class, -1, new long[] {}, null));
    }
  }
}
