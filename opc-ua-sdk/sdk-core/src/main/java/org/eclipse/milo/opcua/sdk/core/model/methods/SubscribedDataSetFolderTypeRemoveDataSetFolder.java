...
/**
 * Declared arguments and typed wire conversion for the RemoveDataSetFolder Method of
 * SubscribedDataSetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.9/#9.1.9.4.5">Model
 *     documentation</a>
 */
public final class SubscribedDataSetFolderTypeRemoveDataSetFolder {
  private SubscribedDataSetFolderTypeRemoveDataSetFolder() {}
  ...
  public static record Inputs(@Nullable NodeId dataSetFolderNodeId) {
    /**
