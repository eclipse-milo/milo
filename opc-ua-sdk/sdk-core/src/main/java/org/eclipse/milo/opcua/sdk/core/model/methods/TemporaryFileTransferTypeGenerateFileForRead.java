...
/**
 * Declared arguments and typed wire conversion for the GenerateFileForRead Method of
 * TemporaryFileTransferType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part20/4.4.3">Model
 *     documentation</a>
 */
public final class TemporaryFileTransferTypeGenerateFileForRead {
  private TemporaryFileTransferTypeGenerateFileForRead() {}
  ...
  public static record Outputs(
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        ...
        MethodValues.encode(
            context, completionStateMachine, 2, NodeId.class, -1, new long[] {}, null)
      };
    }
