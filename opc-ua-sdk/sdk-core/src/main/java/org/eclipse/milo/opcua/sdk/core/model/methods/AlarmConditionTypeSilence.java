...
/**
 * Declared arguments and typed wire conversion for the Silence Method of AlarmConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.7">Model
 *     documentation</a>
 */
public final class AlarmConditionTypeSilence {
  private AlarmConditionTypeSilence() {}
