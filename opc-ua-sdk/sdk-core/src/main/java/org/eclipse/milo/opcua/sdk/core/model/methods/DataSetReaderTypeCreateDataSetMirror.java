...
/**
 * Declared arguments and typed wire conversion for the CreateDataSetMirror Method of
 * DataSetReaderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.8/#9.1.8.6">Model
 *     documentation</a>
 */
public final class DataSetReaderTypeCreateDataSetMirror {
  private DataSetReaderTypeCreateDataSetMirror() {}
    ...
    return new Argument[] {
      ...
      new Argument(
          ...
          ExpandedNodeId.of(Namespaces.OPC_UA, 96L)
              .toNodeId(namespaceTable)
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=96")),
          1,
  ...
  public static record Inputs(
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, parentNodeName, 0, String.class, -1, new long[] {}, null),
        MethodValues.encode(
            context, rolePermissions, 1, RolePermissionType.class, 1, new long[] {0L}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          ...
          (@Nullable RolePermissionType[])
              MethodValues.decode(
                  context, values, 1, RolePermissionType.class, 1, new long[] {0L}, null));
    }
    ...
    public boolean equals(@Nullable Object other) {
      return other instanceof Inputs value
          && Arrays.deepEquals(
              new Object[] {parentNodeName, rolePermissions},
              new Object[] {value.parentNodeName, value.rolePermissions});
    }

    @Override
    public int hashCode() {
      return Arrays.deepHashCode(new Object[] {parentNodeName, rolePermissions});
    }

    @Override
    public String toString() {
      return "Inputs" + Arrays.deepToString(new Object[] {parentNodeName, rolePermissions});
    }
  }

  /** Outputs values in declared order. */
  public static record Outputs(@Nullable NodeId parentNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, parentNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
