...
/**
 * Outputs of the <code>AddPublishedEvents</code> Method, in declaration order.
 *
 ...
 */
@NullMarked
public interface DataSetFolderTypeAddPublishedEventsOutputs {
  /**
  ...
  static DataSetFolderTypeAddPublishedEventsOutputs of(
    ...
    @Nullable ConfigurationVersionDataType configurationVersionValue =
        DataSetFolderTypeAddPublishedEventsOutputs.snapshot(configurationVersion);
    @Nullable NodeId dataSetNodeIdValue =
        DataSetFolderTypeAddPublishedEventsOutputs.snapshot(dataSetNodeId);
    return new DataSetFolderTypeAddPublishedEventsOutputs() {
      @Override
      public @Nullable ConfigurationVersionDataType configurationVersion() {
        return DataSetFolderTypeAddPublishedEventsOutputs.snapshot(configurationVersionValue);
      }

      @Override
      public @Nullable NodeId dataSetNodeId() {
        return DataSetFolderTypeAddPublishedEventsOutputs.snapshot(dataSetNodeIdValue);
      }
    };
  }
