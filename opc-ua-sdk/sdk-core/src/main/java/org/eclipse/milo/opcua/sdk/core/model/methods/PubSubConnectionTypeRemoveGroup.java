...
/**
 * Declared arguments and typed wire conversion for the RemoveGroup Method of PubSubConnectionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/9.1.5/#9.1.5.5">Model
 *     documentation</a>
 */
public final class PubSubConnectionTypeRemoveGroup {
  private PubSubConnectionTypeRemoveGroup() {}
  ...
  public static record Inputs(@Nullable NodeId groupId) {
    /**
