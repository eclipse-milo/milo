...
/**
 * Declared arguments and typed wire conversion for the OneShotShelve Method of
 * ShelvedStateMachineType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.8.17/#5.8.17.6">Model
 *     documentation</a>
 */
public final class ShelvedStateMachineTypeOneShotShelve {
  private ShelvedStateMachineTypeOneShotShelve() {}
