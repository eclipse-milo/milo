...
/**
 * Declared arguments and typed wire conversion for the RemovePushTarget Method of
 * PubSubKeyPushTargetFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.7.3">Model
 *     documentation</a>
 */
public final class PubSubKeyPushTargetFolderTypeRemovePushTarget {
  private PubSubKeyPushTargetFolderTypeRemovePushTarget() {}
  ...
  public static record Inputs(@Nullable NodeId pushTargetId) {
    /**
