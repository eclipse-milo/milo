...
/**
 * Declared arguments and typed wire conversion for the Respond Method of DialogConditionType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part9/5.6.3">Model
 *     documentation</a>
 */
public final class DialogConditionTypeRespond {
  private DialogConditionTypeRespond() {}
  ...
  public static record Inputs(@Nullable Integer selectedResponse) {
    /**
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (Integer)
              MethodValues.decode(context, values, 0, Integer.class, -1, new long[] {}, null));
    }
  }
}
