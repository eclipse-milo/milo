...
/**
 * Declared arguments and typed wire conversion for the RemoveEndpoint Method of RoleType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part18/4.4.10">Model
 *     documentation</a>
 */
public final class RoleTypeRemoveEndpoint {
  private RoleTypeRemoveEndpoint() {}
    ...
    return new Argument[] {
      new Argument(
          ...
          ExpandedNodeId.of(Namespaces.OPC_UA, 15528L)
              ...
              .orElseThrow(() -> new IllegalArgumentException("missing namespace for i=15528")),
          -1,
          new UInteger[] {},
  ...
  public static record Inputs(@Nullable EndpointType endpoint) {
    /**
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(context, endpoint, 0, EndpointType.class, -1, new long[] {}, null)
      };
    }
    ...
    public static Inputs fromVariants(EncodingContext context, Variant[] values)
      ...
      return new Inputs(
          (EndpointType)
              MethodValues.decode(context, values, 0, EndpointType.class, -1, new long[] {}, null));
    }
  }
}
