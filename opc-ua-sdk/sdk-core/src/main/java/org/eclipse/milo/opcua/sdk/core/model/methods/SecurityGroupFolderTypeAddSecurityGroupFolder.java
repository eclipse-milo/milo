...
/**
 * Declared arguments and typed wire conversion for the AddSecurityGroupFolder Method of
 * SecurityGroupFolderType.
 *
 * @see <a href="https://reference.opcfoundation.org/v105/Core/docs/Part14/8.5.4">Model
 *     documentation</a>
 */
public final class SecurityGroupFolderTypeAddSecurityGroupFolder {
  private SecurityGroupFolderTypeAddSecurityGroupFolder() {}
  ...
  public static record Inputs(@Nullable String name) {
    /**
  ...
  public static record Outputs(@Nullable NodeId securityGroupFolderNodeId) {
    /**
     * Encodes every declared position.
     *
     * @throws UaException if a value violates its declaration or cannot be encoded.
    ...
    public Variant[] toVariants(EncodingContext context) throws UaException {
      return new Variant[] {
        MethodValues.encode(
            context, securityGroupFolderNodeId, 0, NodeId.class, -1, new long[] {}, null)
      };
    }
