...
public class PubSubStatusTypeNode extends BaseObjectTypeNode implements PubSubStatusType {
   ...
   */
  public static ClientViews createViews(PubSubStatusTypeNode node) {
  ...
  public @Nullable PubSubState getState() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:State (declaration i=14644, owner i=14643)"
              + " on "
              + getNodeId());
    }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:State (declaration i=14644, owner"
                                    + " i=14643) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:State (declaration i=14644,"
                                              + " owner i=14643) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:State"
                                                        + " (declaration i=14644, owner i=14643) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
  ...
  public @Nullable UaMethodNode getEnableMethodNode() throws UaException {
    try {
      return getEnableMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getEnableMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Enable (declaration i=14645, owner"
                                    + " i=14643) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Enable"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Enable (declaration"
                                              + " i=14645, owner i=14643) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:Enable"
                                                                + " (declaration i=14645, owner"
                                                                + " i=14643) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Enable"
                                                        + " (declaration i=14645, owner i=14643) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:Enable (declaration i=14645, owner i=14643)"));
            } else {
  ...
  @NullMarked
  @Override
  public void callEnable() throws UaException {
    callEnableDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callEnableAsync() {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callEnableDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callEnableDetailed() throws UaException {
    return callEnableDetailed(MethodCallOptions.NONE);
  }
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callEnableDetailed(MethodCallOptions options)
      throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callEnableDetailedAsync(options);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callEnableDetailedAsync() {
    return callEnableDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  @Override
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callEnableDetailedAsync(MethodCallOptions options) {
    ...
    try {
      ...
      var lookup = getEnableMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: Enable"));
                }
                var inputMetadata =
  ...
  public @Nullable UaMethodNode getDisableMethodNode() throws UaException {
    try {
      return getDisableMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getDisableMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Disable (declaration i=14646, owner"
                                    + " i=14643) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Disable"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Disable (declaration"
                                              + " i=14646, owner i=14643) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:Disable"
                                                                + " (declaration i=14646, owner"
                                                                + " i=14643) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Disable"
                                                        + " (declaration i=14646, owner i=14643) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:Disable (declaration i=14646, owner i=14643)"));
            } else {
              result.complete((UaMethodNode) node);
            }
          });
  ...
  @NullMarked
  @Override
  public void callDisable() throws UaException {
    callDisableDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callDisableAsync() {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callDisableDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callDisableDetailed() throws UaException {
    return callDisableDetailed(MethodCallOptions.NONE);
  }
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callDisableDetailed(MethodCallOptions options)
      throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callDisableDetailedAsync(options);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callDisableDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  @Override
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callDisableDetailedAsync(MethodCallOptions options) {
    CompletableFuture<MethodCallResult<@Nullable Void>> result = new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      var lookup = getDisableMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: Disable"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
