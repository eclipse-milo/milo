 ...
 */
@NullMarked
public final class BaseInterfaceTypeView extends ClientObjectView implements BaseInterfaceType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ClientViewType<BaseInterfaceType> TYPE =
      ClientViewType.of(
  ...
  private BaseInterfaceTypeView(ClientViews views, UaObjectNode node) {
    super(views, node);
  }
}
