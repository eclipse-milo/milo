...
public class ExclusiveDeviationAlarmTypeNode extends ExclusiveLimitAlarmTypeNode
   ...
   */
  public static ClientViews createViews(ExclusiveDeviationAlarmTypeNode node) {
  ...
  public @Nullable NodeId getSetpointNode() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:SetpointNode (declaration i=9905, owner i=9764)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SetpointNode (declaration i=9905, owner"
                            + " i=9764) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:SetpointNode (declaration i=9905,"
                                    + " owner i=9764) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:SetpointNode"
                                                        + " (declaration i=9905, owner i=9764) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  public @Nullable NodeId getBaseSetpointNode() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:BaseSetpointNode (declaration i=16817, owner i=9764)"
              + " on "
              + getNodeId());
    }
    return (NodeId) node.getValue().getValue().getValue();
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:BaseSetpointNode (declaration i=16817, owner"
                            + " i=9764) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:BaseSetpointNode"
                                              + " (declaration i=16817, owner i=9764) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:BaseSetpointNode"
                                              + " (declaration i=16817, owner i=9764)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
