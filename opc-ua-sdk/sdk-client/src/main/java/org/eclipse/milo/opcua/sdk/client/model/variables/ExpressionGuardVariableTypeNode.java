...
/**
 * Node implementation of {@link ExpressionGuardVariableType}.
 *
...
public class ExpressionGuardVariableTypeNode extends GuardVariableTypeNode
  ...
  public PropertyTypeNode getExpressionNode() throws UaException {
    return ClientNodeSupport.await(getExpressionNodeAsync());
  }
  ...
  public @Nullable ContentFilter readExpression() throws UaException {
    return ClientNodeSupport.await(readExpressionAsync());
  }

  @Override
  public void writeExpression(@Nullable ContentFilter value) throws UaException {
    ClientNodeSupport.good(
        ClientNodeSupport.await(writeExpressionAsync(value)),
        "http://opcfoundation.org/UA/}Expression");
  }
  ...
  @Override
  public CompletableFuture<StatusCode> writeExpressionAsync(@Nullable ContentFilter value) {
    return ClientNodeSupport.defer(
        () ->
            ClientNodeSupport.compose(
                getExpressionNodeAsync(),
