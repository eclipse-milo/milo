...
public class JsonDataSetReaderMessageTypeNode extends DataSetReaderMessageTypeNode
   ...
   */
  public static ClientViews createViews(JsonDataSetReaderMessageTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable JsonNetworkMessageContentMask getNetworkMessageContentMask() throws UaException {
    PropertyTypeNode node = getNetworkMessageContentMaskNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NetworkMessageContentMask (declaration i=21131, owner"
              + " i=21130) on "
              + getNodeId());
    }
    ...
    return getNetworkMessageContentMaskNodeAsync()
        ...
        .thenApply(
            v -> {
              ...
              try {
                return (JsonNetworkMessageContentMask) v.getValue().getValue();
  ...
  public CompletableFuture<StatusCode> writeNetworkMessageContentMaskAsync(
      @Nullable JsonNetworkMessageContentMask networkMessageContentMask) {
    return getNetworkMessageContentMaskNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                        ...
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NetworkMessageContentMask"
                                    + " (declaration i=21131, owner i=21130) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "NetworkMessageContentMask"))
                                  }));
                      return client
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NetworkMessageContentMask"
                                              + " (declaration i=21131, owner i=21130)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:NetworkMessageContentMask (declaration i=21131,"
                          + " owner i=21130)"));
            } else {
  ...
  @Override
  public @Nullable JsonDataSetMessageContentMask getDataSetMessageContentMask() throws UaException {
    PropertyTypeNode node = getDataSetMessageContentMaskNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:DataSetMessageContentMask (declaration i=21132, owner"
              + " i=21130) on "
              + getNodeId());
    }
  ...
  @Override
  public @Nullable JsonDataSetMessageContentMask readDataSetMessageContentMask()
      throws UaException {
    try {
  ...
  @Override
  public void writeDataSetMessageContentMask(@Nullable JsonDataSetMessageContentMask value)
      throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable JsonDataSetMessageContentMask>
    ...
    return getDataSetMessageContentMaskNodeAsync()
        ...
        .thenApply(
            v -> {
              ...
              try {
                return (JsonDataSetMessageContentMask) v.getValue().getValue();
              } catch (UaRuntimeException e) {
                throw new CompletionException(new UaException(e));
              }
            });
  ...
  public CompletableFuture<StatusCode> writeDataSetMessageContentMaskAsync(
      @Nullable JsonDataSetMessageContentMask dataSetMessageContentMask) {
    return getDataSetMessageContentMaskNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                        ...
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:DataSetMessageContentMask"
                                    + " (declaration i=21132, owner i=21130) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "DataSetMessageContentMask"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:DataSetMessageContentMask"
                                              + " (declaration i=21132, owner i=21130)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:DataSetMessageContentMask (declaration i=21132,"
                          + " owner i=21130)"));
            } else {
              result.complete((PropertyTypeNode) node);
            }
