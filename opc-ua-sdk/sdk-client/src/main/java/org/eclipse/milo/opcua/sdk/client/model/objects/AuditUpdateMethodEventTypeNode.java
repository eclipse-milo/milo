...
public class AuditUpdateMethodEventTypeNode extends AuditEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditUpdateMethodEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable NodeId getMethodId() throws UaException {
  ...
  @Override
  public void setMethodId(@Nullable NodeId value) throws UaException {
    PropertyTypeNode node = getMethodIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeMethodIdAsync(@Nullable NodeId methodId) {
    return getMethodIdNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:StatusCodeId (declaration i=19305, owner"
                            + " i=2127) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:InputArguments (declaration i=2129, owner"
                            + " i=2127) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:OutputArguments (declaration i=19306, owner"
                            + " i=2127) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
