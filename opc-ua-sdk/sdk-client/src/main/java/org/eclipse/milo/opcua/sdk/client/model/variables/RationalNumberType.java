...
public interface RationalNumberType extends BaseDataVariableType {
   ...
   *     representation
   */
  @Nullable Integer getNumerator() throws UaException;
   ...
   *     fails, or a checked conversion fails
   */
  void setNumerator(@Nullable Integer value) throws UaException;
   ...
   *     representation
   */
  @Nullable UInteger getDenominator() throws UaException;
   ...
   *     fails, or a checked conversion fails
   */
  void setDenominator(@Nullable UInteger value) throws UaException;
