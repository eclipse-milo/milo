...
public class PubSubKeyPushTargetFolderTypeNode extends FolderTypeNode
   ...
   */
  public static ClientViews createViews(PubSubKeyPushTargetFolderTypeNode node) {
  ...
  public UaMethodNode getAddPushTargetMethodNode() throws UaException {
    try {
      return getAddPushTargetMethodNodeAsync().get();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getAddPushTargetMethodNodeAsync() {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:AddPushTarget (declaration i=25366,"
                                    + " owner i=25346) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddPushTarget"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:AddPushTarget (declaration"
                                              + " i=25366, owner i=25346) on "
                                              + getNodeId()));
                                }
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:AddPushTarget"
                                                + " (declaration i=25366, owner i=25346) on "
                                                + getNodeId()));
                                  }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:AddPushTarget (declaration i=25366, owner"
                          + " i=25346)"));
            } else {
  ...
  @NullMarked
  @Override
  public @Nullable NodeId callAddPushTarget(
      ...
      throws UaException {
    return callAddPushTargetDetailed(
            applicationUri,
            endpointUrl,
            securityPolicyUri,
            userTokenType,
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable NodeId> callAddPushTargetAsync(
      @Nullable String applicationUri,
      @Nullable String endpointUrl,
      @Nullable String securityPolicyUri,
      @Nullable UserTokenPolicy userTokenType,
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable NodeId> callAddPushTargetDetailed(
      @Nullable String applicationUri,
      @Nullable String endpointUrl,
      @Nullable String securityPolicyUri,
      @Nullable UserTokenPolicy userTokenType,
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
      callAddPushTargetDetailedAsync(
          ...
          @Nullable UShort requestedKeyCount,
          @Nullable Double retryInterval) {
    return callAddPushTargetDetailedAsync(
        MethodCallOptions.NONE,
        applicationUri,
        endpointUrl,
        securityPolicyUri,
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    try {
      ...
      rawInputs.add(applicationUri);
      rawInputs.add(endpointUrl);
      rawInputs.add(securityPolicyUri);
      rawInputs.add(userTokenType);
      rawInputs.add(requestedKeyCount);
      rawInputs.add(retryInterval);
      var lookup = getAddPushTargetMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddPushTarget"));
                }
                var inputMetadata =
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument ApplicationUri (effective property"
                                              + " i=25367, DataType i=12) is unavailable in the"
                                ...
                                @Nullable String convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument EndpointUrl (effective property i=25367,"
                            ...
                            if (rawInputs.size() > 3) {
                              Variant encoded3;
                              {
                                @Nullable UserTokenPolicy convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument UserTokenType (effective property"
                                              + " i=25367, DataType i=304) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                    ...
                                    convertedValue = (UserTokenPolicy) methodValue;
                                  } catch (UaSerializationException conversionFailure) {
                                    throw new UaException(
                                        conversionFailure.getStatusCode().getValue()
                                                == StatusCodes.Bad_OutOfRange
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          ...
                                          "Method argument RequestedKeyCount (effective property"
                                              + " i=25367, DataType i=5) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                ...
                                @Nullable Double convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument RetryInterval (effective property"
                                              + " i=25367, DataType i=290) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
  ...
  public UaMethodNode getRemovePushTargetMethodNode() throws UaException {
    try {
      return getRemovePushTargetMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getRemovePushTargetMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemovePushTarget (declaration"
                                    + " i=25369, owner i=25346) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RemovePushTarget"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RemovePushTarget"
                                              + " (declaration i=25369, owner i=25346) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RemovePushTarget"
                                              + " (declaration i=25369, owner i=25346)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RemovePushTarget (declaration i=25369, owner"
                          + " i=25346)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public void callRemovePushTarget(@Nullable NodeId pushTargetId) throws UaException {
    callRemovePushTargetDetailed(pushTargetId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemovePushTargetAsync(
      @Nullable NodeId pushTargetId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemovePushTargetDetailedAsync(pushTargetId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemovePushTargetDetailed(
      @Nullable NodeId pushTargetId) throws UaException {
    return callRemovePushTargetDetailed(MethodCallOptions.NONE, pushTargetId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemovePushTargetDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callRemovePushTargetDetailedAsync(options, pushTargetId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemovePushTargetDetailedAsync(MethodCallOptions.NONE, pushTargetId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(pushTargetId);
      var lookup = getRemovePushTargetMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemovePushTarget"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument PushTargetId (effective property"
                                              + " i=25370, DataType i=17) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
  ...
  public @Nullable UaMethodNode getAddPushTargetFolderMethodNode() throws UaException {
    try {
      return getAddPushTargetFolderMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AddPushTargetFolder (declaration"
                                    + " i=25371, owner i=25346) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddPushTargetFolder"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AddPushTargetFolder"
                                              + " (declaration i=25371, owner i=25346) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:AddPushTargetFolder"
                                              + " (declaration i=25371, owner i=25346)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @NullMarked
  @Override
  public @Nullable NodeId callAddPushTargetFolder(@Nullable String name) throws UaException {
    return callAddPushTargetFolderDetailed(name).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable NodeId> callAddPushTargetFolderAsync(
      @Nullable String name) {
    CompletableFuture<@Nullable NodeId> result = new CompletableFuture<>();
    var call = callAddPushTargetFolderDetailedAsync(name);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable NodeId> callAddPushTargetFolderDetailed(
      @Nullable String name) throws UaException {
    return callAddPushTargetFolderDetailed(MethodCallOptions.NONE, name);
  }
  ...
  public MethodCallResult<? extends @Nullable NodeId> callAddPushTargetFolderDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callAddPushTargetFolderDetailedAsync(options, name);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    return callAddPushTargetFolderDetailedAsync(MethodCallOptions.NONE, name);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    try {
      ...
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(name);
      var lookup = getAddPushTargetFolderMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddPushTargetFolder"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable String convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Name (effective property i=25372,"
                                              + " DataType i=12) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
  ...
  public @Nullable UaMethodNode getRemovePushTargetFolderMethodNode() throws UaException {
    try {
      return getRemovePushTargetFolderMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemovePushTargetFolder (declaration"
                                    + " i=25374, owner i=25346) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RemovePushTargetFolder"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RemovePushTargetFolder"
                                              + " (declaration i=25374, owner i=25346) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RemovePushTargetFolder"
                                              + " (declaration i=25374, owner i=25346)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RemovePushTargetFolder (declaration i=25374,"
                          + " owner i=25346)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public void callRemovePushTargetFolder(@Nullable NodeId pushTargetFolderNodeId)
      throws UaException {
    callRemovePushTargetFolderDetailed(pushTargetFolderNodeId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemovePushTargetFolderAsync(
      @Nullable NodeId pushTargetFolderNodeId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemovePushTargetFolderDetailedAsync(pushTargetFolderNodeId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemovePushTargetFolderDetailed(
      @Nullable NodeId pushTargetFolderNodeId) throws UaException {
    return callRemovePushTargetFolderDetailed(MethodCallOptions.NONE, pushTargetFolderNodeId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemovePushTargetFolderDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callRemovePushTargetFolderDetailedAsync(options, pushTargetFolderNodeId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemovePushTargetFolderDetailedAsync(MethodCallOptions.NONE, pushTargetFolderNodeId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(pushTargetFolderNodeId);
      var lookup = getRemovePushTargetFolderMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemovePushTargetFolder"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument PushTargetFolderNodeId (effective"
                                              + " property i=25375, DataType i=17) is unavailable"
