...
public class ConfigurationFileTypeNode extends FileTypeNode implements ConfigurationFileType {
   ...
   */
  public static ClientViews createViews(ConfigurationFileTypeNode node) {
  ...
  public @Nullable DateTime getLastUpdateTime() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:LastUpdateTime (declaration i=15438, owner i=15437)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:LastUpdateTime (declaration i=15438, owner"
                            + " i=15437) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:LastUpdateTime (declaration i=15438,"
                                    + " owner i=15437) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:LastUpdateTime"
                                                + " (declaration i=15438, owner i=15437) on "
                                                + getNodeId()));
                                  }
  ...
  @Override
  public @Nullable UInteger getCurrentVersion() throws UaException {
    PropertyTypeNode node = getCurrentVersionNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:CurrentVersion (declaration i=15439, owner i=15437)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setCurrentVersion(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getCurrentVersionNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:CurrentVersion (declaration i=15439, owner"
                            + " i=15437) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeCurrentVersionAsync(@Nullable UInteger currentVersion) {
    return getCurrentVersionNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:CurrentVersion (declaration i=15439,"
                                    + " owner i=15437) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "CurrentVersion"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:CurrentVersion (declaration"
                                              + " i=15439, owner i=15437) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:CurrentVersion"
                                                + " (declaration i=15439, owner i=15437) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  public @Nullable Double getActivityTimeout() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ActivityTimeout (declaration i=15503, owner i=15437)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ActivityTimeout (declaration i=15503, owner"
                            + " i=15437) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ActivityTimeout (declaration i=15503,"
                                    + " owner i=15437) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ActivityTimeout"
                                              + " (declaration i=15503, owner i=15437) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ActivityTimeout"
                                              + " (declaration i=15503, owner i=15437)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable NodeId getSupportedDataType() throws UaException {
    PropertyTypeNode node = getSupportedDataTypeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SupportedDataType (declaration i=15504, owner i=15437)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setSupportedDataType(@Nullable NodeId value) throws UaException {
    PropertyTypeNode node = getSupportedDataTypeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SupportedDataType (declaration i=15504, owner"
                            + " i=15437) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeSupportedDataTypeAsync(
      @Nullable NodeId supportedDataType) {
    return getSupportedDataTypeNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:SupportedDataType (declaration"
                                    + " i=15504, owner i=15437) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SupportedDataType"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SupportedDataType"
                                              + " (declaration i=15504, owner i=15437) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:SupportedDataType"
                                              + " (declaration i=15504, owner i=15437)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  public UaMethodNode getConfirmUpdateMethodNode() throws UaException {
    try {
      return getConfirmUpdateMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getConfirmUpdateMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConfirmUpdate (declaration i=15508,"
                                    + " owner i=15437) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConfirmUpdate"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ConfirmUpdate (declaration"
                                              + " i=15508, owner i=15437) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:ConfirmUpdate"
                                                + " (declaration i=15508, owner i=15437) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ConfirmUpdate (declaration i=15508, owner"
                          + " i=15437)"));
            } else {
   ...
   *
   * @param updateId ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callConfirmUpdate(@Nullable UUID updateId) throws UaException {
    callConfirmUpdateDetailed(updateId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callConfirmUpdateAsync(
      @Nullable UUID updateId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callConfirmUpdateDetailedAsync(updateId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callConfirmUpdateDetailed(
      @Nullable UUID updateId) throws UaException {
    return callConfirmUpdateDetailed(MethodCallOptions.NONE, updateId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callConfirmUpdateDetailed(
    ...
    var awaitedMethod = callConfirmUpdateDetailedAsync(options, updateId);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callConfirmUpdateDetailedAsync(MethodCallOptions.NONE, updateId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      rawInputs.add(updateId);
      var lookup = getConfirmUpdateMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ConfirmUpdate"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(ExpandedNodeId.parse("i=14"))
                                ...
                                @Nullable UUID convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument UpdateId (effective property i=15511,"
                                              + " DataType i=14) is unavailable in the effective"
                                    ...
                                    convertedValue = (UUID) methodValue;
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:CloseAndUpdate (declaration i=15505,"
                                    + " owner i=15437) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:CloseAndUpdate"
                                                + " (declaration i=15505, owner i=15437) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:CloseAndUpdate (declaration i=15505, owner"
                          + " i=15437)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * @param versionToUpdate ; the supplied payload may be null.
   * @param targets ; the supplied payload may be null.
   * @param revertAfterTime ; the supplied payload may be null.
   * @param restartDelayTime ; the supplied payload may be null.
  ...
  @NullMarked
  @Override
  public ConfigurationFileTypeCloseAndUpdateOutputs callCloseAndUpdate(
      ...
      throws UaException {
    return callCloseAndUpdateDetailed(
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends ConfigurationFileTypeCloseAndUpdateOutputs>
      callCloseAndUpdateAsync(
          ...
          @Nullable Double revertAfterTime,
          @Nullable Double restartDelayTime) {
    CompletableFuture<ConfigurationFileTypeCloseAndUpdateOutputs> result =
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends ConfigurationFileTypeCloseAndUpdateOutputs>
  ...
  public CompletableFuture<
      ...
      callCloseAndUpdateDetailedAsync(
          ...
          @Nullable Double revertAfterTime,
          @Nullable Double restartDelayTime) {
    return callCloseAndUpdateDetailedAsync(
        MethodCallOptions.NONE,
        fileHandle,
        versionToUpdate,
        targets,
  ...
  public CompletableFuture<
      ...
      callCloseAndUpdateDetailedAsync(
          ...
          @Nullable Double revertAfterTime,
          @Nullable Double restartDelayTime) {
    CompletableFuture<MethodCallResult<ConfigurationFileTypeCloseAndUpdateOutputs>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(fileHandle);
      rawInputs.add(versionToUpdate);
      rawInputs.add(targets);
      rawInputs.add(revertAfterTime);
      rawInputs.add(restartDelayTime);
      ...
      CompletableFuture<MethodCallResult<ConfigurationFileTypeCloseAndUpdateOutputs>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                ...
                var inputMetadata =
                    ClientDataTypes.read(
                        ...
                        List.<ExpandedNodeId>of(
                                ...
                                ExpandedNodeId.parse("i=20998"),
                                ExpandedNodeId.parse("i=15538"),
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                                ...
                                @Nullable UInteger convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument FileHandle (effective property i=15506,"
                                ...
                                @Nullable UInteger convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument VersionToUpdate (effective property"
                                              + " i=15506, DataType i=20998) is unavailable in the"
                            ...
                            if (rawInputs.size() > 2) {
                              Variant encoded2;
                              {
                                @Nullable ConfigurationUpdateTargetType @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Targets (effective property i=15506,"
                                              + " DataType i=15538) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                    ...
                                    if (methodValue == null) {
                                      ...
                                      for (int valueIndex = 0;
                                        ...
                                        convertedValue[valueIndex] =
                                            (ConfigurationUpdateTargetType) valueElement;
                                      }
                                    }
                                  } catch (UaSerializationException conversionFailure) {
                                    throw new UaException(
                                ...
                                @Nullable Double convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument RevertAfterTime (effective property"
                                              + " i=15506, DataType i=290) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                ...
                                @Nullable Double convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument RestartDelayTime (effective property"
                                              + " i=15506, DataType i=290) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                                    ...
                                                    try {
                                                      return MethodCallResult.decode(
                                                          ...
                                                          outputArguments -> {
                                                            ...
                                                            return ConfigurationFileTypeCloseAndUpdateOutputs
                                                                .of(decoded0, decoded1, decoded2);
                                                          });
                                                    } catch (UaException failure) {
                                                      throw new CompletionException(failure);
                                                    }
