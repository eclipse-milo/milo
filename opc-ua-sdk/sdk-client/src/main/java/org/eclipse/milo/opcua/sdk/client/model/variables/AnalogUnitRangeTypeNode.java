...
public class AnalogUnitRangeTypeNode extends AnalogItemTypeNode implements AnalogUnitRangeType {
  public AnalogUnitRangeTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
  ...
  public @Nullable EUInformation getEngineeringUnitsProperty() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:EngineeringUnits (declaration i=17575, owner i=17570)"
              + " on "
              + getNodeId());
    }
  ...
  public @Nullable EUInformation readEngineeringUnitsProperty() throws UaException {
    try {
      return readEngineeringUnitsPropertyAsync().get();
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EngineeringUnits (declaration i=17575, owner"
                            + " i=17570) on "
                            + getNodeId()));
              }
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:EngineeringUnits"
                                              + " (declaration i=17575, owner i=17570) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:EngineeringUnits"
                                              + " (declaration i=17575, owner i=17570)"));
                                }
