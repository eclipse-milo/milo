...
public class PubSubDiagnosticsRootTypeNode extends PubSubDiagnosticsTypeNode
    implements PubSubDiagnosticsRootType {
  public PubSubDiagnosticsRootTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(PubSubDiagnosticsRootTypeNode node) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:LiveValues (declaration i=19777,"
                                    + " owner i=19732) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:LiveValues"
                                                        + " (declaration i=19777, owner i=19732) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:LiveValues (declaration i=19777, owner"
                          + " i=19732)"));
            } else {
