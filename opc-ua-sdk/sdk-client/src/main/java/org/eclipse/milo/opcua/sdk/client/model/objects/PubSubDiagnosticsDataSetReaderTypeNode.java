...
public class PubSubDiagnosticsDataSetReaderTypeNode extends PubSubDiagnosticsTypeNode
    implements PubSubDiagnosticsDataSetReaderType {
  public PubSubDiagnosticsDataSetReaderTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(PubSubDiagnosticsDataSetReaderTypeNode node) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:Counters (declaration i=20041, owner"
                                    + " i=20027) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Counters"
                                                        + " (declaration i=20041, owner i=20027) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:LiveValues (declaration i=20072,"
                                    + " owner i=20027) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:LiveValues"
                                                        + " (declaration i=20072, owner i=20027) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:LiveValues (declaration i=20072, owner"
                          + " i=20027)"));
            } else {
              result.complete((BaseObjectTypeNode) node);
            }
