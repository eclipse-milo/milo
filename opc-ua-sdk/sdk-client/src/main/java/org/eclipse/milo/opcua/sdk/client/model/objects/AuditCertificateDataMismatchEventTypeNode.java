...
public class AuditCertificateDataMismatchEventTypeNode extends AuditCertificateEventTypeNode
    implements AuditCertificateDataMismatchEventType {
  public AuditCertificateDataMismatchEventTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(AuditCertificateDataMismatchEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String getInvalidHostname() throws UaException {
    PropertyTypeNode node = getInvalidHostnameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:InvalidHostname (declaration i=2083, owner i=2082)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setInvalidHostname(@Nullable String value) throws UaException {
    PropertyTypeNode node = getInvalidHostnameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable String readInvalidHostname() throws UaException {
    try {
  ...
  @Override
  public void writeInvalidHostname(@Nullable String value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable String> readInvalidHostnameAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:InvalidHostname (declaration i=2083, owner"
                            + " i=2082) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeInvalidHostnameAsync(@Nullable String invalidHostname) {
    return getInvalidHostnameNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:InvalidHostname (declaration i=2083,"
                                    + " owner i=2082) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "InvalidHostname"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:InvalidHostname"
                                              + " (declaration i=2083, owner i=2082) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:InvalidHostname"
                                              + " (declaration i=2083, owner i=2082)"));
                                }
  ...
  @Override
  public @Nullable String getInvalidUri() throws UaException {
    PropertyTypeNode node = getInvalidUriNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:InvalidUri (declaration i=2084, owner i=2082)"
              + " on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
  ...
  @Override
  public void setInvalidUri(@Nullable String value) throws UaException {
    PropertyTypeNode node = getInvalidUriNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable String readInvalidUri() throws UaException {
    try {
  ...
  @Override
  public void writeInvalidUri(@Nullable String value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable String> readInvalidUriAsync() {
  ...
  @Override
  public CompletableFuture<StatusCode> writeInvalidUriAsync(@Nullable String invalidUri) {
    return getInvalidUriNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:InvalidUri (declaration i=2084, owner"
                                    + " i=2082) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "InvalidUri"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:InvalidUri (declaration"
                                              + " i=2084, owner i=2082) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:InvalidUri"
                                                                + " (declaration i=2084, owner"
                                                                + " i=2082) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:InvalidUri"
                                                        + " (declaration i=2084, owner i=2082) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
