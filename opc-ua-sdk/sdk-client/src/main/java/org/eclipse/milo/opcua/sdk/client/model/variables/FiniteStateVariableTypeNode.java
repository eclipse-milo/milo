...
public class FiniteStateVariableTypeNode extends StateVariableTypeNode
    implements FiniteStateVariableType {
  public FiniteStateVariableTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
  ...
  @Override
  public @Nullable NodeId getId() throws UaException {
    PropertyTypeNode node = getIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Id (declaration i=2761, owner i=2760)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setId(@Nullable NodeId value) throws UaException {
    PropertyTypeNode node = getIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable NodeId readId() throws UaException {
    try {
  ...
  @Override
  public void writeId(@Nullable NodeId value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable NodeId> readIdAsync() {
  ...
  @Override
  public CompletableFuture<StatusCode> writeIdAsync(@Nullable NodeId id) {
    return getIdNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:Id (declaration i=2761,"
                                              + " owner i=2760) on "
                                              + getNodeId()));
                                }
