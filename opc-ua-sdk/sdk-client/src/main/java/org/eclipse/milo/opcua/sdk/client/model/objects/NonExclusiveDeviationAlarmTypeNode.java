...
public class NonExclusiveDeviationAlarmTypeNode extends NonExclusiveLimitAlarmTypeNode
  ...
  public @Nullable NodeId readSetpointNode() throws UaException {
    return ClientMembers.await(readSetpointNodeAsync(), false);
  }
  ...
  public PropertyTypeNode getSetpointNodeNode() throws UaException {
    return ClientMembers.await(getSetpointNodeNodeAsync(), false);
  }
  ...
  public @Nullable NodeId readBaseSetpointNode() throws UaException {
    return ClientMembers.await(readBaseSetpointNodeAsync(), false);
  }
  ...
  public @Nullable PropertyTypeNode getBaseSetpointNodeNode() throws UaException {
    return ClientMembers.await(getBaseSetpointNodeNodeAsync(), false);
  }
