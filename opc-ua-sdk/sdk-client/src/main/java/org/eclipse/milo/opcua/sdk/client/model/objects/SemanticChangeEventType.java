...
public interface SemanticChangeEventType extends BaseEventType {
   ...
   *     representation
   */
  @Nullable SemanticChangeStructureDataType @Nullable [] getChanges() throws UaException;
   ...
   *     fails, or a checked conversion fails
   */
  void setChanges(@Nullable SemanticChangeStructureDataType @Nullable [] value) throws UaException;
