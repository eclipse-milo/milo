...
public class RoleSetTypeNode extends BaseObjectTypeNode implements RoleSetType {
   ...
   */
  public static ClientViews createViews(RoleSetTypeNode node) {
  ...
  public UaMethodNode getAddRoleMethodNode() throws UaException {
    try {
      return getAddRoleMethodNodeAsync().get();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getAddRoleMethodNodeAsync() {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:AddRole (declaration i=15997, owner"
                                    + " i=15607) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddRole"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:AddRole (declaration"
                                              + " i=15997, owner i=15607) on "
                                              + getNodeId()));
                                }
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:AddRole"
                                                                + " (declaration i=15997, owner"
                                                                + " i=15607) on "
                                                                + getNodeId()));
                                                  }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:AddRole"
                                                        + " (declaration i=15997, owner i=15607) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:AddRole (declaration i=15997, owner i=15607)"));
            } else {
   ...
   *
   * @param roleName ; the supplied payload may be null.
   * @param namespaceUri ; the supplied payload may be null.
  ...
  @NullMarked
  @Override
  public @Nullable NodeId callAddRole(@Nullable String roleName, @Nullable String namespaceUri)
      throws UaException {
    return callAddRoleDetailed(roleName, namespaceUri).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable NodeId> callAddRoleAsync(
      @Nullable String roleName, @Nullable String namespaceUri) {
    CompletableFuture<@Nullable NodeId> result = new CompletableFuture<>();
    var call = callAddRoleDetailedAsync(roleName, namespaceUri);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable NodeId> callAddRoleDetailed(
      @Nullable String roleName, @Nullable String namespaceUri) throws UaException {
    return callAddRoleDetailed(MethodCallOptions.NONE, roleName, namespaceUri);
  }
  ...
  public MethodCallResult<? extends @Nullable NodeId> callAddRoleDetailed(
    ...
    var awaitedMethod = callAddRoleDetailedAsync(options, roleName, namespaceUri);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    return callAddRoleDetailedAsync(MethodCallOptions.NONE, roleName, namespaceUri);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    try {
      ...
      rawInputs.add(roleName);
      rawInputs.add(namespaceUri);
      var lookup = getAddRoleMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddRole"));
                }
                var inputMetadata =
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument RoleName (effective property i=15998,"
                                ...
                                @Nullable String convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument NamespaceUri (effective property"
                                              + " i=15998, DataType i=12) is unavailable in the"
  ...
  public UaMethodNode getRemoveRoleMethodNode() throws UaException {
    try {
      return getRemoveRoleMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getRemoveRoleMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemoveRole (declaration i=16000,"
                                    + " owner i=15607) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RemoveRole"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RemoveRole (declaration"
                                              + " i=16000, owner i=15607) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:RemoveRole"
                                                                + " (declaration i=16000, owner"
                                                                + " i=15607) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:RemoveRole"
                                                        + " (declaration i=16000, owner i=15607) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RemoveRole (declaration i=16000, owner"
                          + " i=15607)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param roleNodeId ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callRemoveRole(@Nullable NodeId roleNodeId) throws UaException {
    callRemoveRoleDetailed(roleNodeId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemoveRoleAsync(
      @Nullable NodeId roleNodeId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemoveRoleDetailedAsync(roleNodeId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemoveRoleDetailed(
      @Nullable NodeId roleNodeId) throws UaException {
    return callRemoveRoleDetailed(MethodCallOptions.NONE, roleNodeId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemoveRoleDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callRemoveRoleDetailedAsync(options, roleNodeId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemoveRoleDetailedAsync(MethodCallOptions.NONE, roleNodeId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(roleNodeId);
      var lookup = getRemoveRoleMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemoveRole"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument RoleNodeId (effective property i=16001,"
