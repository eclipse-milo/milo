                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ValueAsDictionaryEntries"
                                              + " (declaration i=19090, owner i=19084)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:ValueAsDictionaryEntries (declaration i=19090,"
                          + " owner i=19084)"));
            } else {
