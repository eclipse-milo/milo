...
public class ConditionTypeNode extends BaseEventTypeNode implements ConditionType {
   ...
   */
  public static ClientViews createViews(ConditionTypeNode node) {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConditionClassId (declaration i=11112, owner"
                            + " i=2782) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ConditionClassId (declaration"
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionClassId"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ConditionClassId"
                                              + " (declaration i=11112, owner i=2782) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ConditionClassId"
                                              + " (declaration i=11112, owner i=2782)"));
                                }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConditionClassName (declaration i=11113,"
                            + " owner i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConditionClassName (declaration"
                                    + " i=11113, owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionClassName"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ConditionClassName"
                                              + " (declaration i=11113, owner i=2782)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ConditionClassName (declaration i=11113, owner"
                          + " i=2782)"));
            } else {
              result.complete((PropertyTypeNode) node);
            }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConditionSubClassId (declaration i=16363,"
                            + " owner i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConditionSubClassId (declaration"
                                    + " i=16363, owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionSubClassId"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ConditionSubClassId"
                                              + " (declaration i=16363, owner i=2782)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConditionSubClassName (declaration i=16364,"
                            + " owner i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConditionSubClassName (declaration"
                                    + " i=16364, owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionSubClassName"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ConditionSubClassName"
                                              + " (declaration i=16364, owner i=2782)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable String getConditionName() throws UaException {
  ...
  @Override
  public void setConditionName(@Nullable String value) throws UaException {
    PropertyTypeNode node = getConditionNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConditionName (declaration i=9009, owner"
                            + " i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeConditionNameAsync(@Nullable String conditionName) {
    return getConditionNameNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConditionName (declaration i=9009,"
                                    + " owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionName"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ConditionName (declaration"
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:ConditionName"
                                                + " (declaration i=9009, owner i=2782) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable NodeId getBranchId() throws UaException {
  ...
  @Override
  public void setBranchId(@Nullable NodeId value) throws UaException {
    PropertyTypeNode node = getBranchIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeBranchIdAsync(@Nullable NodeId branchId) {
    return getBranchIdNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:BranchId (declaration i=9010, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "BranchId"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:BranchId (declaration"
                                              + " i=9010, owner i=2782) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:BranchId"
                                                        + " (declaration i=9010, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable Boolean getRetain() throws UaException {
  ...
  @Override
  public void setRetain(@Nullable Boolean value) throws UaException {
    PropertyTypeNode node = getRetainNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeRetainAsync(@Nullable Boolean retain) {
    return getRetainNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Retain (declaration i=3874, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Retain"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Retain (declaration i=3874,"
                                              + " owner i=2782) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:Retain (declaration"
                                                + " i=3874, owner i=2782) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Retain"
                                                        + " (declaration i=3874, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable Boolean getSupportsFilteredRetain() throws UaException {
  ...
  @Override
  public void setSupportsFilteredRetain(@Nullable Boolean value) throws UaException {
    PropertyTypeNode node = getSupportsFilteredRetainNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable Boolean readSupportsFilteredRetain() throws UaException {
    try {
  ...
  @Override
  public void writeSupportsFilteredRetain(@Nullable Boolean value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable Boolean> readSupportsFilteredRetainAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SupportsFilteredRetain (declaration i=32060,"
                            + " owner i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  public CompletableFuture<StatusCode> writeSupportsFilteredRetainAsync(
      @Nullable Boolean supportsFilteredRetain) {
    return getSupportsFilteredRetainNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:SupportsFilteredRetain (declaration"
                                    + " i=32060, owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SupportsFilteredRetain"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:SupportsFilteredRetain"
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:SupportsFilteredRetain"
                                              + " (declaration i=32060, owner i=2782)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ClientUserId (declaration i=9026, owner"
                            + " i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ClientUserId (declaration i=9026,"
                                    + " owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:ClientUserId"
                                                        + " (declaration i=9026, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EnabledState (declaration i=9011, owner"
                            + " i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:EnabledState (declaration i=9011,"
                                    + " owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:EnabledState"
                                                        + " (declaration i=9011, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable StatusCode getQuality() throws UaException {
  ...
  @Override
  public void setQuality(@Nullable StatusCode value) throws UaException {
    ConditionVariableTypeNode node = getQualityNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeQualityAsync(@Nullable StatusCode quality) {
    return getQualityNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  public CompletableFuture<? extends ConditionVariableTypeNode> getQualityNodeAsync() {
    CompletableFuture<ConditionVariableTypeNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
          lookup.thenCompose(
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Quality (declaration i=9020, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Quality"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Quality (declaration"
                                              + " i=9020, owner i=2782) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Quality"
                                                        + " (declaration i=9020, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
      ...
      hop0.whenComplete(
          (node, failure) -> {
            if (failure != null) {
              result.completeExceptionally(failure);
            } else if (node != null && !(node instanceof ConditionVariableTypeNode)) {
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:Quality (declaration i=9020, owner i=2782)"));
            } else {
              result.complete((ConditionVariableTypeNode) node);
            }
          });
    } catch (Exception e) {
      result.completeExceptionally(e);
  ...
  @Override
  public @Nullable UShort getLastSeverity() throws UaException {
  ...
  @Override
  public void setLastSeverity(@Nullable UShort value) throws UaException {
    ConditionVariableTypeNode node = getLastSeverityNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:LastSeverity (declaration i=9022, owner"
                            + " i=2782) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeLastSeverityAsync(@Nullable UShort lastSeverity) {
    return getLastSeverityNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:LastSeverity (declaration i=9022,"
                                    + " owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "LastSeverity"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:LastSeverity (declaration"
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:LastSeverity"
                                                        + " (declaration i=9022, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Comment (declaration i=9024, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Comment"
                                                        + " (declaration i=9024, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getDisableMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Disable (declaration i=9028, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Disable"
                                                        + " (declaration i=9028, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getEnableMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Enable (declaration i=9027, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Enable (declaration i=9027,"
                                              + " owner i=2782) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Enable"
                                                        + " (declaration i=9027, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  public UaMethodNode getAddCommentMethodNode() throws UaException {
    try {
      return getAddCommentMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getAddCommentMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AddComment (declaration i=9029, owner"
                                    + " i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddComment"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AddComment (declaration"
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:AddComment"
                                                                + " (declaration i=9029, owner"
                                                                + " i=2782) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:AddComment"
                                                        + " (declaration i=9029, owner i=2782) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @NullMarked
  @Override
  public void callAddComment(@Nullable ByteString eventId, @Nullable LocalizedText comment)
      throws UaException {
    callAddCommentDetailed(eventId, comment).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callAddCommentAsync(
      @Nullable ByteString eventId, @Nullable LocalizedText comment) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callAddCommentDetailedAsync(eventId, comment);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callAddCommentDetailed(
      @Nullable ByteString eventId, @Nullable LocalizedText comment) throws UaException {
    return callAddCommentDetailed(MethodCallOptions.NONE, eventId, comment);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callAddCommentDetailed(
      ...
      throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callAddCommentDetailedAsync(options, eventId, comment);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callAddCommentDetailedAsync(MethodCallOptions.NONE, eventId, comment);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      var lookup = getAddCommentMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddComment"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable ByteString convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument EventId (effective property i=9030,"
                                ...
                                @Nullable LocalizedText convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Comment (effective property i=9030,"
  ...
  @NullMarked
  @Override
  public UaMethodNode getConditionRefreshMethodNode() throws UaException {
    try {
      return getConditionRefreshMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getConditionRefreshMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConditionRefresh (declaration i=3875,"
                                    + " owner i=2782) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionRefresh"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ConditionRefresh"
                                              + " (declaration i=3875, owner i=2782) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ConditionRefresh"
                                              + " (declaration i=3875, owner i=2782)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ConditionRefresh (declaration i=3875, owner"
                          + " i=2782)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param subscriptionId The identifier for the subscription to refresh.; the supplied payload may
   *     be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callConditionRefresh(@Nullable UInteger subscriptionId) throws UaException {
    callConditionRefreshDetailed(subscriptionId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callConditionRefreshAsync(
      @Nullable UInteger subscriptionId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callConditionRefreshDetailedAsync(subscriptionId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callConditionRefreshDetailed(
      @Nullable UInteger subscriptionId) throws UaException {
    return callConditionRefreshDetailed(MethodCallOptions.NONE, subscriptionId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callConditionRefreshDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callConditionRefreshDetailedAsync(options, subscriptionId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callConditionRefreshDetailedAsync(MethodCallOptions.NONE, subscriptionId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      var lookup = getConditionRefreshMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ConditionRefresh"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(ExpandedNodeId.parse("i=288"))
                            .subList(0, rawInputs.size()),
                        rawInputs.toArray());
                result.whenComplete(
                    (cancelledValue, cancelledFailure) -> {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          ...
                                          "Method argument SubscriptionId (effective property"
                                              + " i=3876, DataType i=288) is unavailable in the"
  ...
  @NullMarked
  @Override
  public UaMethodNode getConditionRefresh2MethodNode() throws UaException {
    try {
      return getConditionRefresh2MethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getConditionRefresh2MethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConditionRefresh2 (declaration"
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConditionRefresh2"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ConditionRefresh2"
                                              + " (declaration i=12912, owner i=2782) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ConditionRefresh2"
                                              + " (declaration i=12912, owner i=2782)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ConditionRefresh2 (declaration i=12912, owner"
                          + " i=2782)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * @param subscriptionId The identifier for the subscription to refresh.; the supplied payload may
   *     be null.
   * @param monitoredItemId The identifier for the monitored item to refresh.; the supplied payload
   *     may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callConditionRefresh2(
      @Nullable UInteger subscriptionId, @Nullable UInteger monitoredItemId) throws UaException {
    callConditionRefresh2Detailed(subscriptionId, monitoredItemId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callConditionRefresh2Async(
      @Nullable UInteger subscriptionId, @Nullable UInteger monitoredItemId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callConditionRefresh2DetailedAsync(subscriptionId, monitoredItemId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callConditionRefresh2Detailed(
      @Nullable UInteger subscriptionId, @Nullable UInteger monitoredItemId) throws UaException {
    return callConditionRefresh2Detailed(MethodCallOptions.NONE, subscriptionId, monitoredItemId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callConditionRefresh2Detailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod =
        callConditionRefresh2DetailedAsync(options, subscriptionId, monitoredItemId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callConditionRefresh2DetailedAsync(
          @Nullable UInteger subscriptionId, @Nullable UInteger monitoredItemId) {
    return callConditionRefresh2DetailedAsync(
        MethodCallOptions.NONE, subscriptionId, monitoredItemId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(subscriptionId);
      rawInputs.add(monitoredItemId);
      var lookup = getConditionRefresh2MethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ConditionRefresh2"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(
                                ExpandedNodeId.parse("i=288"), ExpandedNodeId.parse("i=288"))
                            .subList(0, rawInputs.size()),
                        rawInputs.toArray());
                result.whenComplete(
                    (cancelledValue, cancelledFailure) -> {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SubscriptionId (effective property"
                                              + " i=12913, DataType i=288) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                ...
                                @Nullable UInteger convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument MonitoredItemId (effective property"
                                              + " i=12913, DataType i=288) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
