...
public class NDimensionArrayItemTypeNode extends ArrayItemTypeNode
  ...
  @Override
  public @Nullable AxisInformation @Nullable [] getAxisDefinition() throws UaException {
    PropertyTypeNode node = getAxisDefinitionNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:AxisDefinition (declaration i=12076, owner i=12068)"
              + " on "
              + getNodeId());
    }
    return (AxisInformation[])
        decodeValue(
            node.getValue().getValue().getValue(), AxisInformation.class, ValueRanks.OneDimension);
  }

  @Override
  public void setAxisDefinition(@Nullable AxisInformation @Nullable [] value) throws UaException {
    PropertyTypeNode node = getAxisDefinitionNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
    ...
    node.setValue(new Variant(encodeValue(value, AxisInformation.class, ValueRanks.OneDimension)));
  }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:AxisDefinition (declaration i=12076, owner"
                            + " i=12068) on "
                            + getNodeId()));
              }
        ...
        .thenApply(
            v -> {
              ...
              try {
                return (AxisInformation[])
                    decodeValue(
                        v.getValue().getValue(), AxisInformation.class, ValueRanks.OneDimension);
  ...
  public CompletableFuture<StatusCode> writeAxisDefinitionAsync(
      @Nullable AxisInformation @Nullable [] axisDefinition) {
    return getAxisDefinitionNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
              ...
              try {
                DataValue value =
                    DataValue.valueOnly(
                        new Variant(
                            encodeValue(
                                axisDefinition, AxisInformation.class, ValueRanks.OneDimension)));
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:AxisDefinition (declaration i=12076,"
                                    + " owner i=12068) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AxisDefinition"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:AxisDefinition (declaration"
                                              + " i=12076, owner i=12068) on "
                                              + getNodeId()));
                                }
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:AxisDefinition"
                                                + " (declaration i=12076, owner i=12068) on "
                                                + getNodeId()));
                                  }
