...
public class NetworkAddressTypeNode extends BaseObjectTypeNode implements NetworkAddressType {
   ...
   */
  public static ClientViews createViews(NetworkAddressTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String getNetworkInterface() throws UaException {
    SelectionListTypeNode node = getNetworkInterfaceNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NetworkInterface (declaration i=21146, owner i=21145)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setNetworkInterface(@Nullable String value) throws UaException {
    SelectionListTypeNode node = getNetworkInterfaceNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:NetworkInterface (declaration i=21146, owner"
                            + " i=21145) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeNetworkInterfaceAsync(
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NetworkInterface (declaration"
                                    + " i=21146, owner i=21145) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "NetworkInterface"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NetworkInterface"
                                              + " (declaration i=21146, owner i=21145) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NetworkInterface"
                                              + " (declaration i=21146, owner i=21145)"));
                                }
