...
public class UnitTypeNode extends BaseObjectTypeNode implements UnitType {
   ...
   */
  public static ClientViews createViews(UnitTypeNode node) {
  ...
  public @Nullable LocalizedText getSymbol() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:Symbol (declaration i=32443, owner i=32442)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public @Nullable String getUnitSystem() throws UaException {
    PropertyTypeNode node = getUnitSystemNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:UnitSystem (declaration i=32445, owner i=32442)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setUnitSystem(@Nullable String value) throws UaException {
    PropertyTypeNode node = getUnitSystemNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  public @Nullable String readUnitSystem() throws UaException {
    return ClientMembers.await(readUnitSystemAsync(), false);
  }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:UnitSystem (declaration i=32445, owner"
                            + " i=32442) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeUnitSystemAsync(@Nullable String unitSystem) {
    return getUnitSystemNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  public PropertyTypeNode getUnitSystemNode() throws UaException {
    return ClientMembers.await(getUnitSystemNodeAsync(), false);
  }
  ...
  @Override
  public @Nullable String getDiscipline() throws UaException {
    PropertyTypeNode node = getDisciplineNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Discipline (declaration i=32446, owner i=32442)"
              + " on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
  ...
  @Override
  public void setDiscipline(@Nullable String value) throws UaException {
    PropertyTypeNode node = getDisciplineNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  public @Nullable String readDiscipline() throws UaException {
    return ClientMembers.await(readDisciplineAsync(), false);
  }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:Discipline (declaration i=32446, owner"
                            + " i=32442) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeDisciplineAsync(@Nullable String discipline) {
    return getDisciplineNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  public @Nullable PropertyTypeNode getDisciplineNode() throws UaException {
    return ClientMembers.await(getDisciplineNodeAsync(), false);
  }
