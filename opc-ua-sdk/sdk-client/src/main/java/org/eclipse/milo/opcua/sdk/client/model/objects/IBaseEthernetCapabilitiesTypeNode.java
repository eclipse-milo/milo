...
public class IBaseEthernetCapabilitiesTypeNode extends BaseInterfaceTypeNode
   ...
   */
  public static ClientViews createViews(IBaseEthernetCapabilitiesTypeNode node) {
  ...
  @Override
  public CompletableFuture<StatusCode> writeVlanTagCapableAsync(@Nullable Boolean vlanTagCapable) {
    return getVlanTagCapableNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "VlanTagCapable"))
                                  }));
                      return client
