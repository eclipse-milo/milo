...
public class ProvisionableDeviceTypeNode extends BaseObjectTypeNode
   ...
   */
  public static ClientViews createViews(ProvisionableDeviceTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable Boolean getIsSingleton() throws UaException {
    PropertyTypeNode node = getIsSingletonNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:IsSingleton (declaration i=26872, owner i=26871)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setIsSingleton(@Nullable Boolean value) throws UaException {
    PropertyTypeNode node = getIsSingletonNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:IsSingleton (declaration i=26872, owner"
                            + " i=26871) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeIsSingletonAsync(@Nullable Boolean isSingleton) {
    return getIsSingletonNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:IsSingleton (declaration i=26872,"
                                    + " owner i=26871) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "IsSingleton"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:IsSingleton (declaration"
                                              + " i=26872, owner i=26871) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:IsSingleton"
                                                        + " (declaration i=26872, owner i=26871) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
  ...
  public UaMethodNode getRequestTicketsMethodNode() throws UaException {
    try {
      return getRequestTicketsMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getRequestTicketsMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RequestTickets (declaration i=26873,"
                                    + " owner i=26871) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RequestTickets"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RequestTickets (declaration"
                                              + " i=26873, owner i=26871) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:RequestTickets"
                                                + " (declaration i=26873, owner i=26871) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RequestTickets (declaration i=26873, owner"
                          + " i=26871)"));
            } else {
  ...
  @NullMarked
  @Override
  public @Nullable String @Nullable [] callRequestTickets() throws UaException {
    return callRequestTicketsDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable String @Nullable []> callRequestTicketsAsync() {
    CompletableFuture<@Nullable String @Nullable []> result = new CompletableFuture<>();
    var call = callRequestTicketsDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable String @Nullable []> callRequestTicketsDetailed()
      throws UaException {
    return callRequestTicketsDetailed(MethodCallOptions.NONE);
  }
  ...
  public MethodCallResult<? extends @Nullable String @Nullable []> callRequestTicketsDetailed(
    ...
    var awaitedMethod = callRequestTicketsDetailedAsync(options);
    try {
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable String @Nullable []>>
      callRequestTicketsDetailedAsync() {
    return callRequestTicketsDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable String @Nullable []>>
    ...
    CompletableFuture<MethodCallResult<@Nullable String @Nullable []>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      var lookup = getRequestTicketsMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
      ...
      CompletableFuture<MethodCallResult<@Nullable String @Nullable []>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RequestTickets"));
                }
                var inputMetadata =
                                                    ...
                                                    try {
                                                      return MethodCallResult.decode(
                                                          ...
                                                          outputArguments -> {
                                                            ...
                                                            @Nullable String @Nullable [] decoded0;
                                                            {
                                                              Object methodValue =
  ...
  public @Nullable UaMethodNode getSetRegistrarEndpointsMethodNode() throws UaException {
    try {
      return getSetRegistrarEndpointsMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:SetRegistrarEndpoints (declaration"
                                    + " i=26875, owner i=26871) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SetRegistrarEndpoints"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:SetRegistrarEndpoints"
                                              + " (declaration i=26875, owner i=26871) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:SetRegistrarEndpoints"
                                              + " (declaration i=26875, owner i=26871)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:SetRegistrarEndpoints (declaration i=26875,"
                          + " owner i=26871)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param registrars ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callSetRegistrarEndpoints(@Nullable ApplicationDescription @Nullable [] registrars)
      throws UaException {
    callSetRegistrarEndpointsDetailed(registrars).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callSetRegistrarEndpointsAsync(
      @Nullable ApplicationDescription @Nullable [] registrars) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callSetRegistrarEndpointsDetailedAsync(registrars);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callSetRegistrarEndpointsDetailed(
      @Nullable ApplicationDescription @Nullable [] registrars) throws UaException {
    return callSetRegistrarEndpointsDetailed(MethodCallOptions.NONE, registrars);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callSetRegistrarEndpointsDetailed(
      ...
      throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callSetRegistrarEndpointsDetailedAsync(options, registrars);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callSetRegistrarEndpointsDetailedAsync(
          @Nullable ApplicationDescription @Nullable [] registrars) {
    return callSetRegistrarEndpointsDetailedAsync(MethodCallOptions.NONE, registrars);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(registrars);
      var lookup = getSetRegistrarEndpointsMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: SetRegistrarEndpoints"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(ExpandedNodeId.parse("i=308"))
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                            ...
                            if (rawInputs.size() > 0) {
                              Variant encoded0;
                              {
                                @Nullable ApplicationDescription @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Registrars (effective property i=26876,"
                                              + " DataType i=308) is unavailable in the effective"
