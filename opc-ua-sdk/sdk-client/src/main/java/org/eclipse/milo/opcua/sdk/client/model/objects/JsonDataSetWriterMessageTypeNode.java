...
public class JsonDataSetWriterMessageTypeNode extends DataSetWriterMessageTypeNode
    implements JsonDataSetWriterMessageType {
  public JsonDataSetWriterMessageTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(JsonDataSetWriterMessageTypeNode node) {
  ...
  public @Nullable JsonDataSetMessageContentMask getDataSetMessageContentMask() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:DataSetMessageContentMask (declaration i=21129, owner"
              + " i=21128) on "
              + getNodeId());
    }
                        ...
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:DataSetMessageContentMask"
                                    + " (declaration i=21129, owner i=21128) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:DataSetMessageContentMask"
                                              + " (declaration i=21129, owner i=21128)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:DataSetMessageContentMask (declaration i=21129,"
                          + " owner i=21128)"));
            } else {
