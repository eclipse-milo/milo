...
public class AuditConditionConfirmEventTypeNode extends AuditConditionEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditConditionConfirmEventTypeNode node) {
  ...
  public @Nullable ByteString getConditionEventId() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:ConditionEventId (declaration i=17224, owner i=8961)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConditionEventId (declaration i=17224, owner"
                            + " i=8961) on "
                            + getNodeId()));
              }
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ConditionEventId"
                                              + " (declaration i=17224, owner i=8961) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ConditionEventId"
                                              + " (declaration i=17224, owner i=8961)"));
                                }
  ...
  public @Nullable LocalizedText getComment() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Comment (declaration i=11854, owner i=8961)"
              + " on "
              + getNodeId());
    }
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Comment (declaration i=11854, owner"
                                    + " i=8961) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Comment"
                                                        + " (declaration i=11854, owner i=8961) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
