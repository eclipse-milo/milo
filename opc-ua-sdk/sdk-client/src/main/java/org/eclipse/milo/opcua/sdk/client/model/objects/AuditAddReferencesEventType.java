...
public interface AuditAddReferencesEventType extends AuditNodeManagementEventType {
  ...
  @Nullable AddReferencesItem @Nullable [] getReferencesToAdd() throws UaException;

  /** Sets the existing node's local value. */
  void setReferencesToAdd(@Nullable AddReferencesItem @Nullable [] value) throws UaException;
