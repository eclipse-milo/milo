...
public class AuditChannelEventTypeNode extends AuditSecurityEventTypeNode
    implements AuditChannelEventType {
  public AuditChannelEventTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(AuditChannelEventTypeNode node) {
  ...
  public @Nullable String getSecureChannelId() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:SecureChannelId (declaration i=2745, owner i=2059)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SecureChannelId (declaration i=2745, owner"
                            + " i=2059) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:SecureChannelId (declaration i=2745,"
                                    + " owner i=2059) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SecureChannelId"
                                              + " (declaration i=2745, owner i=2059) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SecureChannelId"
                                              + " (declaration i=2745, owner i=2059)"));
                                }
