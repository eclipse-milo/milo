...
public class AcknowledgeableConditionTypeNode extends ConditionTypeNode
   ...
   */
  public static ClientViews createViews(AcknowledgeableConditionTypeNode node) {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EnabledState (declaration i=9073, owner"
                            + " i=2881) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:EnabledState (declaration i=9073,"
                                    + " owner i=2881) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:EnabledState"
                                                        + " (declaration i=9073, owner i=2881) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable LocalizedText getAckedState() throws UaException {
  ...
  @Override
  public void setAckedState(@Nullable LocalizedText value) throws UaException {
    TwoStateVariableTypeNode node = getAckedStateNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeAckedStateAsync(@Nullable LocalizedText ackedState) {
    return getAckedStateNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AckedState (declaration i=9093, owner"
                                    + " i=2881) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AckedState"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AckedState (declaration"
                                              + " i=9093, owner i=2881) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:AckedState"
                                                        + " (declaration i=9093, owner i=2881) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable LocalizedText getConfirmedState() throws UaException {
  ...
  @Override
  public void setConfirmedState(@Nullable LocalizedText value) throws UaException {
    TwoStateVariableTypeNode node = getConfirmedStateNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ConfirmedState (declaration i=9102, owner"
                            + " i=2881) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeConfirmedStateAsync(
      @Nullable LocalizedText confirmedState) {
    return getConfirmedStateNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConfirmedState (declaration i=9102,"
                                    + " owner i=2881) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConfirmedState"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ConfirmedState (declaration"
                                              + " i=9102, owner i=2881) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:ConfirmedState"
                                                + " (declaration i=9102, owner i=2881) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  public UaMethodNode getAcknowledgeMethodNode() throws UaException {
    try {
      return getAcknowledgeMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getAcknowledgeMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Acknowledge (declaration i=9111,"
                                    + " owner i=2881) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Acknowledge"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Acknowledge (declaration"
                                              + " i=9111, owner i=2881) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:Acknowledge"
                                                                + " (declaration i=9111, owner"
                                                                + " i=2881) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Acknowledge"
                                                        + " (declaration i=9111, owner i=2881) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:Acknowledge (declaration i=9111, owner"
                          + " i=2881)"));
            } else {
   ...
   *
   * @param eventId The identifier for the event to comment.; the supplied payload may be null.
   * @param comment The comment to add to the condition.; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callAcknowledge(@Nullable ByteString eventId, @Nullable LocalizedText comment)
      throws UaException {
    callAcknowledgeDetailed(eventId, comment).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callAcknowledgeAsync(
      @Nullable ByteString eventId, @Nullable LocalizedText comment) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callAcknowledgeDetailedAsync(eventId, comment);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callAcknowledgeDetailed(
      @Nullable ByteString eventId, @Nullable LocalizedText comment) throws UaException {
    return callAcknowledgeDetailed(MethodCallOptions.NONE, eventId, comment);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callAcknowledgeDetailed(
    ...
    var awaitedMethod = callAcknowledgeDetailedAsync(options, eventId, comment);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callAcknowledgeDetailedAsync(MethodCallOptions.NONE, eventId, comment);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      rawInputs.add(eventId);
      rawInputs.add(comment);
      var lookup = getAcknowledgeMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: Acknowledge"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(
                                ExpandedNodeId.parse("i=15"), ExpandedNodeId.parse("i=21"))
                                ...
                                @Nullable ByteString convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument EventId (effective property i=9112,"
                                ...
                                @Nullable LocalizedText convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Comment (effective property i=9112,"
  ...
  public @Nullable UaMethodNode getConfirmMethodNode() throws UaException {
    try {
      return getConfirmMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getConfirmMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Confirm (declaration i=9113, owner"
                                    + " i=2881) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Confirm"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Confirm (declaration"
                                              + " i=9113, owner i=2881) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:Confirm"
                                                                + " (declaration i=9113, owner"
                                                                + " i=2881) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Confirm"
                                                        + " (declaration i=9113, owner i=2881) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @NullMarked
  @Override
  public void callConfirm(@Nullable ByteString eventId, @Nullable LocalizedText comment)
      throws UaException {
    callConfirmDetailed(eventId, comment).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callConfirmAsync(
      @Nullable ByteString eventId, @Nullable LocalizedText comment) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callConfirmDetailedAsync(eventId, comment);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callConfirmDetailed(
      @Nullable ByteString eventId, @Nullable LocalizedText comment) throws UaException {
    return callConfirmDetailed(MethodCallOptions.NONE, eventId, comment);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callConfirmDetailed(
      ...
      throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callConfirmDetailedAsync(options, eventId, comment);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  @Override
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callConfirmDetailedAsync(@Nullable ByteString eventId, @Nullable LocalizedText comment) {
    return callConfirmDetailedAsync(MethodCallOptions.NONE, eventId, comment);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      rawInputs.add(eventId);
      rawInputs.add(comment);
      var lookup = getConfirmMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: Confirm"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable ByteString convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument EventId (effective property i=9114,"
                                              + " DataType i=15) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                ...
                                @Nullable LocalizedText convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Comment (effective property i=9114,"
                                              + " DataType i=21) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
