...
public class AuditDeleteNodesEventTypeNode extends AuditNodeManagementEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditDeleteNodesEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable DeleteNodesItem @Nullable [] getNodesToDelete() throws UaException {
    PropertyTypeNode node = getNodesToDeleteNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NodesToDelete (declaration i=2094, owner i=2093)"
              + " on "
              + getNodeId());
    }
    return (DeleteNodesItem[])
        decodeValue(
            node.getValue().getValue().getValue(), DeleteNodesItem.class, ValueRanks.OneDimension);
  }

  @Override
  public void setNodesToDelete(@Nullable DeleteNodesItem @Nullable [] value) throws UaException {
    PropertyTypeNode node = getNodesToDeleteNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
    ...
    node.setValue(new Variant(encodeValue(value, DeleteNodesItem.class, ValueRanks.OneDimension)));
  }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:NodesToDelete (declaration i=2094, owner"
                            + " i=2093) on "
                            + getNodeId()));
              }
        ...
        .thenApply(
            v -> {
              ...
              try {
                return (DeleteNodesItem[])
                    decodeValue(
                        v.getValue().getValue(), DeleteNodesItem.class, ValueRanks.OneDimension);
  ...
  public CompletableFuture<StatusCode> writeNodesToDeleteAsync(
      @Nullable DeleteNodesItem @Nullable [] nodesToDelete) {
    return getNodesToDeleteNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
              ...
              try {
                DataValue value =
                    DataValue.valueOnly(
                        new Variant(
                            encodeValue(
                                nodesToDelete, DeleteNodesItem.class, ValueRanks.OneDimension)));
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NodesToDelete (declaration i=2094,"
                                    + " owner i=2093) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "NodesToDelete"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NodesToDelete (declaration"
                                              + " i=2094, owner i=2093) on "
                                              + getNodeId()));
                                }
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:NodesToDelete"
                                                + " (declaration i=2094, owner i=2093) on "
                                                + getNodeId()));
                                  }
