...
public interface IIeeeTsnInterfaceConfigurationTalkerType
   ...
   *     representation
   */
  @Nullable UInteger getTimeAwareOffset() throws UaException;
   ...
   *     fails, or a checked conversion fails
   */
  void setTimeAwareOffset(@Nullable UInteger value) throws UaException;
   ...
   *     fails, or a checked conversion fails
   */
  @Nullable BaseDataVariableType getTimeAwareOffsetNode() throws UaException;
   ...
   */
  CompletableFuture<? extends @Nullable BaseDataVariableType> getTimeAwareOffsetNodeAsync();
}
