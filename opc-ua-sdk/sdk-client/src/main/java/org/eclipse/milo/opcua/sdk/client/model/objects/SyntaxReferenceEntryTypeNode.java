...
public class SyntaxReferenceEntryTypeNode extends DictionaryEntryTypeNode
    implements SyntaxReferenceEntryType {
  public SyntaxReferenceEntryTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(SyntaxReferenceEntryTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String getCommonName() throws UaException {
    PropertyTypeNode node = getCommonNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:CommonName (declaration i=32441, owner i=32439)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setCommonName(@Nullable String value) throws UaException {
    PropertyTypeNode node = getCommonNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable String readCommonName() throws UaException {
    try {
  ...
  @Override
  public void writeCommonName(@Nullable String value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable String> readCommonNameAsync() {
    return getCommonNameNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:CommonName (declaration i=32441, owner"
                            + " i=32439) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeCommonNameAsync(@Nullable String commonName) {
    return getCommonNameNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
              ...
              try {
                DataValue value = DataValue.valueOnly(new Variant(commonName));
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:CommonName (declaration i=32441,"
                                    + " owner i=32439) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "CommonName"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:CommonName (declaration"
                                              + " i=32441, owner i=32439) on "
                                              + getNodeId()));
                                }
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:CommonName"
                                                                + " (declaration i=32441, owner"
                                                                + " i=32439) on "
                                                                + getNodeId()));
                                                  }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:CommonName"
                                                        + " (declaration i=32441, owner i=32439) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
