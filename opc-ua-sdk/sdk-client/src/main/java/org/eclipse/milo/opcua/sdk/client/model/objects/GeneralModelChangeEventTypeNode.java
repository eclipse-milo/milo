...
public class GeneralModelChangeEventTypeNode extends BaseModelChangeEventTypeNode
   ...
   */
  public static ClientViews createViews(GeneralModelChangeEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable ModelChangeStructureDataType @Nullable [] getChanges() throws UaException {
    PropertyTypeNode node = getChangesNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Changes (declaration i=2134, owner i=2133)"
              + " on "
              + getNodeId());
    }
  ...
  public void setChanges(@Nullable ModelChangeStructureDataType @Nullable [] value)
    ...
    node.setValue(
        new Variant(
            encodeValue(value, ModelChangeStructureDataType.class, ValueRanks.OneDimension)));
  }
  ...
  public CompletableFuture<StatusCode> writeChangesAsync(
      @Nullable ModelChangeStructureDataType @Nullable [] changes) {
    return getChangesNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:Changes (declaration i=2134, owner"
                                    + " i=2133) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Changes"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:Changes (declaration"
                                              + " i=2134, owner i=2133) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Changes"
                                                        + " (declaration i=2134, owner i=2133) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
