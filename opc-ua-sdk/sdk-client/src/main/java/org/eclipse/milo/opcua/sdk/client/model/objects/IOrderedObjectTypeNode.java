...
public class IOrderedObjectTypeNode extends BaseInterfaceTypeNode implements IOrderedObjectType {
   ...
   */
  public static ClientViews createViews(IOrderedObjectTypeNode node) {
  ...
  public @Nullable Number getNumberInList() throws UaException {
    ...
    return (Number) node.getValue().getValue().getValue();
  }
    ...
    return getNumberInListNodeAsync()
        ...
        .thenApply(
            v -> {
              ...
              try {
                return (Number) v.getValue().getValue();
  ...
  @Override
  public CompletableFuture<StatusCode> writeNumberInListAsync(@Nullable Number numberInList) {
    return getNumberInListNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NumberInList (declaration i=23517,"
                                    + " owner i=23513) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "NumberInList"))
                                  }));
                      return client
