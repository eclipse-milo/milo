...
public class KeyCredentialConfigurationFolderTypeNode extends FolderTypeNode
  ...
  public @Nullable UaMethodNode getCreateCredentialMethodNode() throws UaException {
    try {
      return getCreateCredentialMethodNodeAsync().get();
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:CreateCredential (declaration"
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "CreateCredential"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:CreateCredential"
                                              + " (declaration i=17522, owner i=17496) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:CreateCredential"
                                              + " (declaration i=17522, owner i=17496)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:CreateCredential (declaration i=17522, owner"
                          + " i=17496)"));
            } else {
   ...
   * @param resourceUri ; the supplied payload may be null.
   * @param profileUri ; the supplied payload may be null.
   * @param endpointUrls ; the supplied payload may be null.
