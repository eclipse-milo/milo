...
public class PubSubKeyPushTargetTypeNode extends BaseObjectTypeNode
   ...
   */
  public static ClientViews createViews(PubSubKeyPushTargetTypeNode node) {
  ...
  public @Nullable String getApplicationUri() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:ApplicationUri (declaration i=25634, owner i=25337)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ApplicationUri (declaration i=25634, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ApplicationUri (declaration i=25634,"
                                    + " owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ApplicationUri"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ApplicationUri (declaration"
                                              + " i=25634, owner i=25337) on "
                                              + getNodeId()));
                                }
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:ApplicationUri"
                                                + " (declaration i=25634, owner i=25337) on "
                                                + getNodeId()));
                                  }
  ...
  public @Nullable String getEndpointUrl() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:EndpointUrl (declaration i=25635, owner i=25337)"
              + " on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EndpointUrl (declaration i=25635, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:EndpointUrl (declaration i=25635,"
                                    + " owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "EndpointUrl"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:EndpointUrl (declaration"
                                              + " i=25635, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:EndpointUrl"
                                                        + " (declaration i=25635, owner i=25337) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
  ...
  public @Nullable String getSecurityPolicyUri() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SecurityPolicyUri (declaration i=25340, owner i=25337)"
              + " on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SecurityPolicyUri (declaration i=25340, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:SecurityPolicyUri (declaration"
                                    + " i=25340, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SecurityPolicyUri"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SecurityPolicyUri"
                                              + " (declaration i=25340, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:SecurityPolicyUri"
                                              + " (declaration i=25340, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable UserTokenPolicy getUserTokenType() throws UaException {
    PropertyTypeNode node = getUserTokenTypeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:UserTokenType (declaration i=25636, owner i=25337)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setUserTokenType(@Nullable UserTokenPolicy value) throws UaException {
    PropertyTypeNode node = getUserTokenTypeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:UserTokenType (declaration i=25636, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeUserTokenTypeAsync(
            ...
            node -> {
              ...
              try {
                DataValue value =
                    DataValue.valueOnly(
                        new Variant(
                            encodeValue(userTokenType, UserTokenPolicy.class, ValueRanks.Scalar)));
                return node.writeAttributeAsync(AttributeId.Value, value);
              } catch (Exception e) {
                return CompletableFuture.failedFuture(e);
              }
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:UserTokenType (declaration i=25636,"
                                    + " owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "UserTokenType"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:UserTokenType (declaration"
                                              + " i=25636, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:UserTokenType"
                                                + " (declaration i=25636, owner i=25337) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable UShort getRequestedKeyCount() throws UaException {
    PropertyTypeNode node = getRequestedKeyCountNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:RequestedKeyCount (declaration i=25637, owner i=25337)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setRequestedKeyCount(@Nullable UShort value) throws UaException {
    PropertyTypeNode node = getRequestedKeyCountNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:RequestedKeyCount (declaration i=25637, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeRequestedKeyCountAsync(
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RequestedKeyCount (declaration"
                                    + " i=25637, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RequestedKeyCount"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:RequestedKeyCount"
                                              + " (declaration i=25637, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RequestedKeyCount"
                                              + " (declaration i=25637, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable Double getRetryInterval() throws UaException {
    PropertyTypeNode node = getRetryIntervalNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:RetryInterval (declaration i=25638, owner i=25337)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setRetryInterval(@Nullable Double value) throws UaException {
    PropertyTypeNode node = getRetryIntervalNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:RetryInterval (declaration i=25638, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeRetryIntervalAsync(@Nullable Double retryInterval) {
    return getRetryIntervalNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RetryInterval (declaration i=25638,"
                                    + " owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RetryInterval"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RetryInterval (declaration"
                                              + " i=25638, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:RetryInterval"
                                                + " (declaration i=25638, owner i=25337) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable DateTime getLastPushExecutionTime() throws UaException {
    PropertyTypeNode node = getLastPushExecutionTimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:LastPushExecutionTime (declaration i=25639, owner i=25337)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setLastPushExecutionTime(@Nullable DateTime value) throws UaException {
    PropertyTypeNode node = getLastPushExecutionTimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:LastPushExecutionTime (declaration i=25639,"
                            + " owner i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  public CompletableFuture<StatusCode> writeLastPushExecutionTimeAsync(
      @Nullable DateTime lastPushExecutionTime) {
    return getLastPushExecutionTimeNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:LastPushExecutionTime (declaration"
                                    + " i=25639, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "LastPushExecutionTime"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:LastPushExecutionTime"
                                              + " (declaration i=25639, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:LastPushExecutionTime"
                                              + " (declaration i=25639, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable DateTime getLastPushErrorTime() throws UaException {
    PropertyTypeNode node = getLastPushErrorTimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:LastPushErrorTime (declaration i=25640, owner i=25337)"
              + " on "
              + getNodeId());
    }
    return (DateTime) node.getValue().getValue().getValue();
  ...
  @Override
  public void setLastPushErrorTime(@Nullable DateTime value) throws UaException {
    PropertyTypeNode node = getLastPushErrorTimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:LastPushErrorTime (declaration i=25640, owner"
                            + " i=25337) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeLastPushErrorTimeAsync(
      @Nullable DateTime lastPushErrorTime) {
    return getLastPushErrorTimeNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:LastPushErrorTime (declaration"
                                    + " i=25640, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "LastPushErrorTime"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:LastPushErrorTime"
                                              + " (declaration i=25640, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:LastPushErrorTime"
                                              + " (declaration i=25640, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  public UaMethodNode getConnectSecurityGroupsMethodNode() throws UaException {
    try {
      return getConnectSecurityGroupsMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getConnectSecurityGroupsMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ConnectSecurityGroups (declaration"
                                    + " i=25641, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ConnectSecurityGroups"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ConnectSecurityGroups"
                                              + " (declaration i=25641, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ConnectSecurityGroups"
                                              + " (declaration i=25641, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ConnectSecurityGroups (declaration i=25641,"
                          + " owner i=25337)"));
            } else {
   ...
   *
   * @param securityGroupIds ; the supplied payload may be null.
  ...
  @NullMarked
  @Override
  public @Nullable StatusCode @Nullable [] callConnectSecurityGroups(
      @Nullable NodeId @Nullable [] securityGroupIds) throws UaException {
    return callConnectSecurityGroupsDetailed(securityGroupIds).requireGood();
  }
  ...
  public CompletableFuture<? extends @Nullable StatusCode @Nullable []>
      callConnectSecurityGroupsAsync(@Nullable NodeId @Nullable [] securityGroupIds) {
    CompletableFuture<@Nullable StatusCode @Nullable []> result = new CompletableFuture<>();
    var call = callConnectSecurityGroupsDetailedAsync(securityGroupIds);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
      callConnectSecurityGroupsDetailed(@Nullable NodeId @Nullable [] securityGroupIds)
          throws UaException {
    return callConnectSecurityGroupsDetailed(MethodCallOptions.NONE, securityGroupIds);
  }
  ...
  @Override
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
      callConnectSecurityGroupsDetailed(
          MethodCallOptions options, @Nullable NodeId @Nullable [] securityGroupIds)
          throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callConnectSecurityGroupsDetailedAsync(options, securityGroupIds);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
    ...
    return callConnectSecurityGroupsDetailedAsync(MethodCallOptions.NONE, securityGroupIds);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
    ...
    try {
      ...
      rawInputs.add(securityGroupIds);
      var lookup = getConnectSecurityGroupsMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ConnectSecurityGroups"));
                }
                var inputMetadata =
                                ...
                                @Nullable NodeId @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SecurityGroupIds (effective property"
                                              + " i=25642, DataType i=17) is unavailable in the"
  ...
  public UaMethodNode getDisconnectSecurityGroupsMethodNode() throws UaException {
    try {
      return getDisconnectSecurityGroupsMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getDisconnectSecurityGroupsMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:DisconnectSecurityGroups (declaration"
                                    + " i=25644, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "DisconnectSecurityGroups"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:DisconnectSecurityGroups"
                                              + " (declaration i=25644, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:DisconnectSecurityGroups"
                                              + " (declaration i=25644, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:DisconnectSecurityGroups (declaration i=25644,"
                          + " owner i=25337)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public @Nullable StatusCode @Nullable [] callDisconnectSecurityGroups(
      @Nullable NodeId @Nullable [] securityGroupIds) throws UaException {
    return callDisconnectSecurityGroupsDetailed(securityGroupIds).requireGood();
  }
  ...
  @Override
  public CompletableFuture<? extends @Nullable StatusCode @Nullable []>
      callDisconnectSecurityGroupsAsync(@Nullable NodeId @Nullable [] securityGroupIds) {
    CompletableFuture<@Nullable StatusCode @Nullable []> result = new CompletableFuture<>();
    var call = callDisconnectSecurityGroupsDetailedAsync(securityGroupIds);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
      callDisconnectSecurityGroupsDetailed(@Nullable NodeId @Nullable [] securityGroupIds)
          throws UaException {
    return callDisconnectSecurityGroupsDetailed(MethodCallOptions.NONE, securityGroupIds);
  }
  ...
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
      callDisconnectSecurityGroupsDetailed(
          ...
          throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callDisconnectSecurityGroupsDetailedAsync(options, securityGroupIds);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
    ...
    return callDisconnectSecurityGroupsDetailedAsync(MethodCallOptions.NONE, securityGroupIds);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
    ...
    try {
      ...
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(securityGroupIds);
      var lookup = getDisconnectSecurityGroupsMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: DisconnectSecurityGroups"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SecurityGroupIds (effective property"
                                              + " i=25645, DataType i=17) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
  ...
  public UaMethodNode getTriggerKeyUpdateMethodNode() throws UaException {
    try {
      return getTriggerKeyUpdateMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getTriggerKeyUpdateMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:TriggerKeyUpdate (declaration"
                                    + " i=25647, owner i=25337) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "TriggerKeyUpdate"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:TriggerKeyUpdate"
                                              + " (declaration i=25647, owner i=25337) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:TriggerKeyUpdate"
                                              + " (declaration i=25647, owner i=25337)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:TriggerKeyUpdate (declaration i=25647, owner"
                          + " i=25337)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public void callTriggerKeyUpdate() throws UaException {
    callTriggerKeyUpdateDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callTriggerKeyUpdateAsync() {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callTriggerKeyUpdateDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callTriggerKeyUpdateDetailed()
      throws UaException {
    return callTriggerKeyUpdateDetailed(MethodCallOptions.NONE);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callTriggerKeyUpdateDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callTriggerKeyUpdateDetailedAsync(options);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callTriggerKeyUpdateDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      var lookup = getTriggerKeyUpdateMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: TriggerKeyUpdate"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
