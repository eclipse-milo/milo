  ...
  public @Nullable NodeId getId() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:Id (declaration i=2768, owner i=2767)"
              + " on "
              + getNodeId());
    }
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:Id (declaration i=2768,"
                                              + " owner i=2767) on "
                                              + getNodeId()));
                                }
