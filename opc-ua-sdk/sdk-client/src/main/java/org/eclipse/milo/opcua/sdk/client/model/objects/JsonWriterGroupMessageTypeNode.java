...
public class JsonWriterGroupMessageTypeNode extends WriterGroupMessageTypeNode
   ...
   */
  public static ClientViews createViews(JsonWriterGroupMessageTypeNode node) {
  ...
  public @Nullable JsonNetworkMessageContentMask getNetworkMessageContentMask() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:NetworkMessageContentMask (declaration i=21127, owner"
              + " i=21126) on "
              + getNodeId());
    }
                        ...
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NetworkMessageContentMask"
                                    + " (declaration i=21127, owner i=21126) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NetworkMessageContentMask"
                                              + " (declaration i=21127, owner i=21126)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:NetworkMessageContentMask (declaration i=21127,"
                          + " owner i=21126)"));
            } else {
