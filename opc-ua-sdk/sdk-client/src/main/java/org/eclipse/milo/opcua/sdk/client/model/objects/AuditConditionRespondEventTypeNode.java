...
public class AuditConditionRespondEventTypeNode extends AuditConditionEventTypeNode
    implements AuditConditionRespondEventType {
  public AuditConditionRespondEventTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
   ...
   */
  public static ClientViews createViews(AuditConditionRespondEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable UInteger getSelectedResponse() throws UaException {
    PropertyTypeNode node = getSelectedResponseNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SelectedResponse (declaration i=11852, owner i=8927)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setSelectedResponse(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getSelectedResponseNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable UInteger readSelectedResponse() throws UaException {
    try {
  ...
  @Override
  public void writeSelectedResponse(@Nullable UInteger value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable UInteger> readSelectedResponseAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SelectedResponse (declaration i=11852, owner"
                            + " i=8927) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeSelectedResponseAsync(
      @Nullable UInteger selectedResponse) {
    return getSelectedResponseNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:SelectedResponse (declaration"
                                    + " i=11852, owner i=8927) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SelectedResponse"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SelectedResponse"
                                              + " (declaration i=11852, owner i=8927) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SelectedResponse"
                                              + " (declaration i=11852, owner i=8927)"));
                                }
