...
public class SecurityGroupFolderTypeNode extends FolderTypeNode implements SecurityGroupFolderType {
   ...
   */
  public static ClientViews createViews(SecurityGroupFolderTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String @Nullable [] getSupportedSecurityPolicyUris() throws UaException {
    PropertyTypeNode node = getSupportedSecurityPolicyUrisNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SupportedSecurityPolicyUris (declaration i=25317, owner"
              + " i=15452) on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SupportedSecurityPolicyUris (declaration"
                            + " i=25317, owner i=15452) on "
                            + getNodeId()));
              }
  ...
  public CompletableFuture<StatusCode> writeSupportedSecurityPolicyUrisAsync(
      @Nullable String @Nullable [] supportedSecurityPolicyUris) {
    return getSupportedSecurityPolicyUrisNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                        ...
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:SupportedSecurityPolicyUris"
                                    + " (declaration i=25317, owner i=15452) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "SupportedSecurityPolicyUris"))
                                  }));
                      return client
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SupportedSecurityPolicyUris"
                                              + " (declaration i=25317, owner i=15452)"));
                                }
  ...
  public UaMethodNode getAddSecurityGroupMethodNode() throws UaException {
    try {
      return getAddSecurityGroupMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getAddSecurityGroupMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AddSecurityGroup (declaration"
                                    + " i=15461, owner i=15452) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddSecurityGroup"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AddSecurityGroup"
                                              + " (declaration i=15461, owner i=15452) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:AddSecurityGroup"
                                              + " (declaration i=15461, owner i=15452)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:AddSecurityGroup (declaration i=15461, owner"
                          + " i=15452)"));
            } else {
   ...
   *
   * @param securityGroupName ; the supplied payload may be null.
   * @param keyLifetime ; the supplied payload may be null.
   * @param securityPolicyUri ; the supplied payload may be null.
   * @param maxFutureKeyCount ; the supplied payload may be null.
   * @param maxPastKeyCount ; the supplied payload may be null.
  ...
  @NullMarked
  @Override
  public SecurityGroupFolderTypeAddSecurityGroupOutputs callAddSecurityGroup(
      ...
      throws UaException {
    return callAddSecurityGroupDetailed(
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends SecurityGroupFolderTypeAddSecurityGroupOutputs>
      callAddSecurityGroupAsync(
          ...
          @Nullable UInteger maxFutureKeyCount,
          @Nullable UInteger maxPastKeyCount) {
    CompletableFuture<SecurityGroupFolderTypeAddSecurityGroupOutputs> result =
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends SecurityGroupFolderTypeAddSecurityGroupOutputs>
  ...
  public CompletableFuture<
      ...
      callAddSecurityGroupDetailedAsync(
          ...
          @Nullable UInteger maxFutureKeyCount,
          @Nullable UInteger maxPastKeyCount) {
    return callAddSecurityGroupDetailedAsync(
        MethodCallOptions.NONE,
        securityGroupName,
        keyLifetime,
        securityPolicyUri,
  ...
  public CompletableFuture<
      ...
      callAddSecurityGroupDetailedAsync(
          ...
          @Nullable UInteger maxFutureKeyCount,
          @Nullable UInteger maxPastKeyCount) {
    CompletableFuture<MethodCallResult<SecurityGroupFolderTypeAddSecurityGroupOutputs>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(securityGroupName);
      rawInputs.add(keyLifetime);
      rawInputs.add(securityPolicyUri);
      rawInputs.add(maxFutureKeyCount);
      rawInputs.add(maxPastKeyCount);
      var lookup = getAddSecurityGroupMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
      ...
      CompletableFuture<MethodCallResult<SecurityGroupFolderTypeAddSecurityGroupOutputs>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddSecurityGroup"));
                }
                var inputMetadata =
                                ...
                                @Nullable String convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SecurityGroupName (effective property"
                                              + " i=15462, DataType i=12) is unavailable in the"
                                ...
                                @Nullable Double convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument KeyLifetime (effective property i=15462,"
                                ...
                                @Nullable UInteger convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument MaxFutureKeyCount (effective property"
                                              + " i=15462, DataType i=7) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                ...
                                @Nullable UInteger convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument MaxPastKeyCount (effective property"
                                              + " i=15462, DataType i=7) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                                    ...
                                                    try {
                                                      return MethodCallResult.decode(
                                                          ...
                                                          outputArguments -> {
                                                            ...
                                                            return SecurityGroupFolderTypeAddSecurityGroupOutputs
  ...
  public UaMethodNode getRemoveSecurityGroupMethodNode() throws UaException {
    try {
      return getRemoveSecurityGroupMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getRemoveSecurityGroupMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemoveSecurityGroup (declaration"
                                    + " i=15464, owner i=15452) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RemoveSecurityGroup"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RemoveSecurityGroup"
                                              + " (declaration i=15464, owner i=15452) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RemoveSecurityGroup"
                                              + " (declaration i=15464, owner i=15452)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RemoveSecurityGroup (declaration i=15464, owner"
                          + " i=15452)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param securityGroupNodeId ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callRemoveSecurityGroup(@Nullable NodeId securityGroupNodeId) throws UaException {
    callRemoveSecurityGroupDetailed(securityGroupNodeId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemoveSecurityGroupAsync(
      @Nullable NodeId securityGroupNodeId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemoveSecurityGroupDetailedAsync(securityGroupNodeId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemoveSecurityGroupDetailed(
      @Nullable NodeId securityGroupNodeId) throws UaException {
    return callRemoveSecurityGroupDetailed(MethodCallOptions.NONE, securityGroupNodeId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemoveSecurityGroupDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callRemoveSecurityGroupDetailedAsync(options, securityGroupNodeId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemoveSecurityGroupDetailedAsync(MethodCallOptions.NONE, securityGroupNodeId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(securityGroupNodeId);
      var lookup = getRemoveSecurityGroupMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemoveSecurityGroup"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SecurityGroupNodeId (effective property"
                                              + " i=15465, DataType i=17) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
  ...
  public @Nullable UaMethodNode getAddSecurityGroupFolderMethodNode() throws UaException {
    try {
      return getAddSecurityGroupFolderMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AddSecurityGroupFolder (declaration"
                                    + " i=25312, owner i=15452) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddSecurityGroupFolder"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AddSecurityGroupFolder"
                                              + " (declaration i=25312, owner i=15452) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:AddSecurityGroupFolder"
                                              + " (declaration i=25312, owner i=15452)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:AddSecurityGroupFolder (declaration i=25312,"
                          + " owner i=15452)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public @Nullable NodeId callAddSecurityGroupFolder(@Nullable String name) throws UaException {
    return callAddSecurityGroupFolderDetailed(name).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable NodeId> callAddSecurityGroupFolderAsync(
      @Nullable String name) {
    CompletableFuture<@Nullable NodeId> result = new CompletableFuture<>();
    var call = callAddSecurityGroupFolderDetailedAsync(name);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable NodeId> callAddSecurityGroupFolderDetailed(
      @Nullable String name) throws UaException {
    return callAddSecurityGroupFolderDetailed(MethodCallOptions.NONE, name);
  }
  ...
  public MethodCallResult<? extends @Nullable NodeId> callAddSecurityGroupFolderDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callAddSecurityGroupFolderDetailedAsync(options, name);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    return callAddSecurityGroupFolderDetailedAsync(MethodCallOptions.NONE, name);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    try {
      ...
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(name);
      var lookup = getAddSecurityGroupFolderMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddSecurityGroupFolder"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable String convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument Name (effective property i=25313,"
  ...
  public @Nullable UaMethodNode getRemoveSecurityGroupFolderMethodNode() throws UaException {
    try {
      return getRemoveSecurityGroupFolderMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemoveSecurityGroupFolder"
                                    + " (declaration i=25315, owner i=15452) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "RemoveSecurityGroupFolder"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RemoveSecurityGroupFolder"
                                              + " (declaration i=25315, owner i=15452)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RemoveSecurityGroupFolder (declaration i=25315,"
                          + " owner i=15452)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param securityGroupFolderNodeId ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callRemoveSecurityGroupFolder(@Nullable NodeId securityGroupFolderNodeId)
      throws UaException {
    callRemoveSecurityGroupFolderDetailed(securityGroupFolderNodeId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemoveSecurityGroupFolderAsync(
      @Nullable NodeId securityGroupFolderNodeId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemoveSecurityGroupFolderDetailedAsync(securityGroupFolderNodeId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemoveSecurityGroupFolderDetailed(
      @Nullable NodeId securityGroupFolderNodeId) throws UaException {
    return callRemoveSecurityGroupFolderDetailed(MethodCallOptions.NONE, securityGroupFolderNodeId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemoveSecurityGroupFolderDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod =
        callRemoveSecurityGroupFolderDetailedAsync(options, securityGroupFolderNodeId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemoveSecurityGroupFolderDetailedAsync(
        MethodCallOptions.NONE, securityGroupFolderNodeId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(securityGroupFolderNodeId);
      var lookup = getRemoveSecurityGroupFolderMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemoveSecurityGroupFolder"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SecurityGroupFolderNodeId (effective"
                                              + " property i=25316, DataType i=17) is unavailable"
