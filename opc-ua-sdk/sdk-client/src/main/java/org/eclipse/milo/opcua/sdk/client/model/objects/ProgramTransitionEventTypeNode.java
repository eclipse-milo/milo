...
public class ProgramTransitionEventTypeNode extends TransitionEventTypeNode
   ...
   */
  public static ClientViews createViews(ProgramTransitionEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable Object getIntermediateResult() throws UaException {
    BaseDataVariableTypeNode node = getIntermediateResultNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:IntermediateResult (declaration i=2379, owner i=2378)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setIntermediateResult(@Nullable Object value) throws UaException {
    BaseDataVariableTypeNode node = getIntermediateResultNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable Object readIntermediateResult() throws UaException {
    try {
  ...
  @Override
  public void writeIntermediateResult(@Nullable Object value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable Object> readIntermediateResultAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:IntermediateResult (declaration i=2379, owner"
                            + " i=2378) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeIntermediateResultAsync(
      @Nullable Object intermediateResult) {
    return getIntermediateResultNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:IntermediateResult (declaration"
                                    + " i=2379, owner i=2378) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "IntermediateResult"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:IntermediateResult"
                                              + " (declaration i=2379, owner i=2378) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:IntermediateResult"
                                              + " (declaration i=2379, owner i=2378)"));
                                }
