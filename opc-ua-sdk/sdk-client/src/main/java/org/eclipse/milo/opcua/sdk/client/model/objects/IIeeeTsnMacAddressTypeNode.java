...
public class IIeeeTsnMacAddressTypeNode extends BaseInterfaceTypeNode
  ...
  public @Nullable UByte @Nullable [] readDestinationAddress() throws UaException {
    return ClientMembers.await(readDestinationAddressAsync(), false);
  }
  ...
  public BaseDataVariableTypeNode getDestinationAddressNode() throws UaException {
    return ClientMembers.await(getDestinationAddressNodeAsync(), false);
  }
  ...
  public @Nullable UByte @Nullable [] readSourceAddress() throws UaException {
    return ClientMembers.await(readSourceAddressAsync(), false);
  }
  ...
  public @Nullable BaseDataVariableTypeNode getSourceAddressNode() throws UaException {
    return ClientMembers.await(getSourceAddressNodeAsync(), false);
  }
