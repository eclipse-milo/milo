...
public class IIeeeTsnMacAddressTypeNode extends BaseInterfaceTypeNode
   ...
   */
  public static ClientViews createViews(IIeeeTsnMacAddressTypeNode node) {
  ...
  public CompletableFuture<StatusCode> writeDestinationAddressAsync(
      @Nullable UByte @Nullable [] destinationAddress) {
    return getDestinationAddressNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "DestinationAddress"))
                                  }));
                      return client
  ...
  @Override
  public CompletableFuture<StatusCode> writeSourceAddressAsync(
      @Nullable UByte @Nullable [] sourceAddress) {
    return getSourceAddressNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  @Override
  public @Nullable BaseDataVariableTypeNode getSourceAddressNode() throws UaException {
    try {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:SourceAddress (declaration i=24201,"
                                    + " owner i=24199) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SourceAddress"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
