...
public class NonTransparentRedundancyTypeNode extends ServerRedundancyTypeNode
   ...
   */
  public static ClientViews createViews(NonTransparentRedundancyTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String @Nullable [] getServerUriArray() throws UaException {
    PropertyTypeNode node = getServerUriArrayNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ServerUriArray (declaration i=2040, owner i=2039)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setServerUriArray(@Nullable String @Nullable [] value) throws UaException {
    PropertyTypeNode node = getServerUriArrayNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ServerUriArray (declaration i=2040, owner"
                            + " i=2039) on "
                            + getNodeId()));
              }
  ...
  public CompletableFuture<StatusCode> writeServerUriArrayAsync(
      @Nullable String @Nullable [] serverUriArray) {
    return getServerUriArrayNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ServerUriArray (declaration i=2040,"
                                    + " owner i=2039) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ServerUriArray"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ServerUriArray (declaration"
                                              + " i=2040, owner i=2039) on "
                                              + getNodeId()));
                                }
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:ServerUriArray"
                                                + " (declaration i=2040, owner i=2039) on "
                                                + getNodeId()));
                                  }
