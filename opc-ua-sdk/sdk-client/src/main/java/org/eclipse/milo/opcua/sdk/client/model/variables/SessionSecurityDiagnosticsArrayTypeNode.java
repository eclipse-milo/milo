...
public class SessionSecurityDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
  ...
  @Override
  public @Nullable SessionSecurityDiagnosticsDataType @Nullable [] readTypedValue()
      throws UaException {
    return ClientNodeSupport.await(readTypedValueAsync());
  }

  @Override
  public void writeTypedValue(@Nullable SessionSecurityDiagnosticsDataType @Nullable [] value)
      throws UaException {
