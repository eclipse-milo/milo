...
public class NonTransparentNetworkRedundancyTypeNode extends NonTransparentRedundancyTypeNode
   ...
   */
  public static ClientViews createViews(NonTransparentNetworkRedundancyTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable NetworkGroupDataType @Nullable [] getServerNetworkGroups() throws UaException {
    PropertyTypeNode node = getServerNetworkGroupsNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ServerNetworkGroups (declaration i=11948, owner i=11945)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setServerNetworkGroups(@Nullable NetworkGroupDataType @Nullable [] value)
      throws UaException {
    PropertyTypeNode node = getServerNetworkGroupsNode();
    if (node == null) {
      throw new UaException(
    ...
    node.setValue(
        new Variant(encodeValue(value, NetworkGroupDataType.class, ValueRanks.OneDimension)));
  }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ServerNetworkGroups (declaration i=11948,"
                            + " owner i=11945) on "
                            + getNodeId()));
              }
  ...
  public CompletableFuture<StatusCode> writeServerNetworkGroupsAsync(
      @Nullable NetworkGroupDataType @Nullable [] serverNetworkGroups) {
    return getServerNetworkGroupsNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ServerNetworkGroups (declaration"
                                    + " i=11948, owner i=11945) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ServerNetworkGroups"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ServerNetworkGroups"
                                              + " (declaration i=11948, owner i=11945) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ServerNetworkGroups"
                                              + " (declaration i=11948, owner i=11945)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:ServerNetworkGroups (declaration i=11948, owner"
                          + " i=11945)"));
            } else {
