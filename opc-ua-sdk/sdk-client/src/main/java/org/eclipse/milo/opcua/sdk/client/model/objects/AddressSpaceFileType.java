...
public interface AddressSpaceFileType extends FileType {
   ...
   */
  @NullMarked
  CompletableFuture<? extends @Nullable UaMethodNode> getExportNamespaceMethodNodeAsync();
   ...
   */
  @NullMarked
  void callExportNamespace() throws UaException;
   ...
   */
  @NullMarked
  CompletableFuture<? extends @Nullable Void> callExportNamespaceAsync();
   ...
   */
  @NullMarked
  MethodCallResult<? extends @Nullable Void> callExportNamespaceDetailed() throws UaException;
   ...
   */
  @NullMarked
  MethodCallResult<? extends @Nullable Void> callExportNamespaceDetailed(MethodCallOptions options)
      throws UaException;
