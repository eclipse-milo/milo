...
public class MultiStateDiscreteTypeNode extends DiscreteItemTypeNode
  ...
  @Override
  public @Nullable LocalizedText @Nullable [] getEnumStrings() throws UaException {
    PropertyTypeNode node = getEnumStringsNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:EnumStrings (declaration i=2377, owner i=2376)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setEnumStrings(@Nullable LocalizedText @Nullable [] value) throws UaException {
    PropertyTypeNode node = getEnumStringsNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable LocalizedText @Nullable [] readEnumStrings() throws UaException {
    try {
  ...
  @Override
  public void writeEnumStrings(@Nullable LocalizedText @Nullable [] value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable LocalizedText @Nullable []> readEnumStringsAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EnumStrings (declaration i=2377, owner"
                            + " i=2376) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeEnumStringsAsync(
      @Nullable LocalizedText @Nullable [] enumStrings) {
    return getEnumStringsNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:EnumStrings (declaration i=2377,"
                                    + " owner i=2376) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "EnumStrings"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:EnumStrings (declaration"
                                              + " i=2377, owner i=2376) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:EnumStrings"
                                                        + " (declaration i=2377, owner i=2376) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
