...
public class BrokerDataSetReaderTransportTypeNode extends DataSetReaderTransportTypeNode
   ...
   */
  public static ClientViews createViews(BrokerDataSetReaderTransportTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String getQueueName() throws UaException {
    PropertyTypeNode node = getQueueNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:QueueName (declaration i=21143, owner i=21142)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setQueueName(@Nullable String value) throws UaException {
    PropertyTypeNode node = getQueueNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:QueueName (declaration i=21143, owner"
                            + " i=21142) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeQueueNameAsync(@Nullable String queueName) {
    return getQueueNameNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  public @Nullable String getResourceUri() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ResourceUri (declaration i=15334, owner i=21142)"
              + " on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ResourceUri (declaration i=15334, owner"
                            + " i=21142) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  public @Nullable String getAuthenticationProfileUri() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:AuthenticationProfileUri (declaration i=15419, owner"
              + " i=21142) on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
  ...
  public @Nullable BrokerTransportQualityOfService getRequestedDeliveryGuarantee()
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:RequestedDeliveryGuarantee (declaration i=15420, owner"
              + " i=21142) on "
              + getNodeId());
    }
  ...
  public void writeRequestedDeliveryGuarantee(@Nullable BrokerTransportQualityOfService value)
      throws UaException {
    try {
      StatusCode statusCode = writeRequestedDeliveryGuaranteeAsync(value).get();
      if (statusCode != null && !statusCode.isGood()) {
        throw new UaException(statusCode);
      }
    } catch (ExecutionException e) {
              ...
              try {
                ...
                Object convertedValue;
                {
                  if (value == null || value instanceof Matrix && ((Matrix) value).isNull()) {
                    ...
                    if (value != null
                        && !((Object) value instanceof BrokerTransportQualityOfService)) {
                      if (!(value instanceof Integer)) {
                        throw new UaRuntimeException(
                            StatusCodes.Bad_TypeMismatch,
                            "RequestedDeliveryGuarantee: expected"
  ...
  @Override
  public @Nullable String getMetaDataQueueName() throws UaException {
    PropertyTypeNode node = getMetaDataQueueNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:MetaDataQueueName (declaration i=21144, owner i=21142)"
              + " on "
              + getNodeId());
    }
    return (String) node.getValue().getValue().getValue();
  ...
  @Override
  public void setMetaDataQueueName(@Nullable String value) throws UaException {
    PropertyTypeNode node = getMetaDataQueueNameNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:MetaDataQueueName (declaration i=21144, owner"
                            + " i=21142) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeMetaDataQueueNameAsync(
