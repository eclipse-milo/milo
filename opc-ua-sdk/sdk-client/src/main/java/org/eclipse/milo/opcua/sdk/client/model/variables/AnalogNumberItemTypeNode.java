...
public class AnalogNumberItemTypeNode extends AnalogItemTypeNode implements AnalogNumberItemType {
  public AnalogNumberItemTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
  ...
  public @Nullable NumberRange getEuNumberRange() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:EUNumberRange (declaration i=23907, owner i=23906)"
              + " on "
              + getNodeId());
    }
    return (NumberRange)
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EUNumberRange (declaration i=23907, owner"
                            + " i=23906) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:EUNumberRange (declaration i=23907,"
                                    + " owner i=23906) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "EUNumberRange"))
                                  }));
                      return client
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:EUNumberRange"
                                                + " (declaration i=23907, owner i=23906) on "
                                                + getNodeId()));
                                  }
