...
public class SecurityGroupTypeNode extends BaseObjectTypeNode implements SecurityGroupType {
   ...
   */
  public static ClientViews createViews(SecurityGroupTypeNode node) {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SecurityGroupId (declaration i=15472, owner"
                            + " i=15471) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:SecurityGroupId (declaration i=15472,"
                                    + " owner i=15471) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SecurityGroupId"
                                              + " (declaration i=15472, owner i=15471) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SecurityGroupId"
                                              + " (declaration i=15472, owner i=15471)"));
                                }
  ...
  @Override
  public @Nullable Double getKeyLifetime() throws UaException {
  ...
  @Override
  public void setKeyLifetime(@Nullable Double value) throws UaException {
    PropertyTypeNode node = getKeyLifetimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:KeyLifetime (declaration i=15046, owner"
                            + " i=15471) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeKeyLifetimeAsync(@Nullable Double keyLifetime) {
    return getKeyLifetimeNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:KeyLifetime (declaration i=15046,"
                                    + " owner i=15471) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "KeyLifetime"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:KeyLifetime (declaration"
                                              + " i=15046, owner i=15471) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:KeyLifetime"
                                                        + " (declaration i=15046, owner i=15471) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SecurityPolicyUri (declaration i=15047, owner"
                            + " i=15471) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SecurityPolicyUri"
                                              + " (declaration i=15047, owner i=15471) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:SecurityPolicyUri"
                                              + " (declaration i=15047, owner i=15471)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable UInteger getMaxFutureKeyCount() throws UaException {
  ...
  @Override
  public void setMaxFutureKeyCount(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getMaxFutureKeyCountNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:MaxFutureKeyCount (declaration i=15048, owner"
                            + " i=15471) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeMaxFutureKeyCountAsync(
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:MaxFutureKeyCount (declaration"
                                    + " i=15048, owner i=15471) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "MaxFutureKeyCount"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:MaxFutureKeyCount"
                                              + " (declaration i=15048, owner i=15471) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:MaxFutureKeyCount"
                                              + " (declaration i=15048, owner i=15471)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable UInteger getMaxPastKeyCount() throws UaException {
  ...
  @Override
  public void setMaxPastKeyCount(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getMaxPastKeyCountNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:MaxPastKeyCount (declaration i=15056, owner"
                            + " i=15471) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeMaxPastKeyCountAsync(
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:MaxPastKeyCount (declaration i=15056,"
                                    + " owner i=15471) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "MaxPastKeyCount"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:MaxPastKeyCount"
                                              + " (declaration i=15056, owner i=15471) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:MaxPastKeyCount"
                                              + " (declaration i=15056, owner i=15471)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
  ...
  public @Nullable UaMethodNode getInvalidateKeysMethodNode() throws UaException {
    try {
      return getInvalidateKeysMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getInvalidateKeysMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:InvalidateKeys (declaration i=25624,"
                                    + " owner i=15471) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "InvalidateKeys"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:InvalidateKeys (declaration"
                                              + " i=25624, owner i=15471) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:InvalidateKeys"
                                                + " (declaration i=25624, owner i=15471) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:InvalidateKeys (declaration i=25624, owner"
                          + " i=15471)"));
            } else {
  ...
  @NullMarked
  @Override
  public void callInvalidateKeys() throws UaException {
    callInvalidateKeysDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callInvalidateKeysAsync() {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callInvalidateKeysDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callInvalidateKeysDetailed()
      throws UaException {
    return callInvalidateKeysDetailed(MethodCallOptions.NONE);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callInvalidateKeysDetailed(
    ...
    var awaitedMethod = callInvalidateKeysDetailedAsync(options);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callInvalidateKeysDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      ...
      var lookup = getInvalidateKeysMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: InvalidateKeys"));
                }
                var inputMetadata =
  ...
  public @Nullable UaMethodNode getForceKeyRotationMethodNode() throws UaException {
    try {
      return getForceKeyRotationMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getForceKeyRotationMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ForceKeyRotation (declaration"
                                    + " i=25625, owner i=15471) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ForceKeyRotation"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ForceKeyRotation"
                                              + " (declaration i=25625, owner i=15471) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ForceKeyRotation"
                                              + " (declaration i=25625, owner i=15471)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ForceKeyRotation (declaration i=25625, owner"
                          + " i=15471)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public void callForceKeyRotation() throws UaException {
    callForceKeyRotationDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callForceKeyRotationAsync() {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callForceKeyRotationDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callForceKeyRotationDetailed()
      throws UaException {
    return callForceKeyRotationDetailed(MethodCallOptions.NONE);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callForceKeyRotationDetailed(
      MethodCallOptions options) throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callForceKeyRotationDetailedAsync(options);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callForceKeyRotationDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      var lookup = getForceKeyRotationMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ForceKeyRotation"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
