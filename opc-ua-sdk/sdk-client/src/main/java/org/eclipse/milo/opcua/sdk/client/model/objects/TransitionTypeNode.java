...
public class TransitionTypeNode extends BaseObjectTypeNode implements TransitionType {
   ...
   */
  public static ClientViews createViews(TransitionTypeNode node) {
  ...
  public @Nullable UInteger getTransitionNumber() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:TransitionNumber (declaration i=2312, owner i=2310)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:TransitionNumber (declaration i=2312, owner"
                            + " i=2310) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:TransitionNumber (declaration i=2312,"
                                    + " owner i=2310) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:TransitionNumber"
                                              + " (declaration i=2312, owner i=2310) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:TransitionNumber"
                                              + " (declaration i=2312, owner i=2310)"));
                                }
