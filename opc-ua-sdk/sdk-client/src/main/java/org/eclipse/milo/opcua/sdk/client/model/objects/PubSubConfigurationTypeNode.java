...
public class PubSubConfigurationTypeNode extends FileTypeNode implements PubSubConfigurationType {
   ...
   */
  public static ClientViews createViews(PubSubConfigurationTypeNode node) {
  ...
  public UaMethodNode getReserveIdsMethodNode() throws UaException {
    try {
      return getReserveIdsMethodNodeAsync().get();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getReserveIdsMethodNodeAsync() {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ReserveIds (declaration i=25505,"
                                    + " owner i=25482) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ReserveIds"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ReserveIds (declaration"
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:ReserveIds"
                                                                + " (declaration i=25505, owner"
                                                                + " i=25482) on "
                                                                + getNodeId()));
                                                  }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:ReserveIds"
                                                        + " (declaration i=25505, owner i=25482) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:ReserveIds (declaration i=25505, owner"
                          + " i=25482)"));
            } else {
  ...
  @NullMarked
  @Override
  public PubSubConfigurationTypeReserveIdsOutputs callReserveIds(
      @Nullable String transportProfileUri,
      @Nullable UShort numReqWriterGroupIds,
      @Nullable UShort numReqDataSetWriterIds)
      throws UaException {
    return callReserveIdsDetailed(transportProfileUri, numReqWriterGroupIds, numReqDataSetWriterIds)
        .requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends PubSubConfigurationTypeReserveIdsOutputs> callReserveIdsAsync(
      @Nullable String transportProfileUri,
      @Nullable UShort numReqWriterGroupIds,
      @Nullable UShort numReqDataSetWriterIds) {
    CompletableFuture<PubSubConfigurationTypeReserveIdsOutputs> result = new CompletableFuture<>();
    var call =
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends PubSubConfigurationTypeReserveIdsOutputs>
      callReserveIdsDetailed(
          @Nullable String transportProfileUri,
          @Nullable UShort numReqWriterGroupIds,
          @Nullable UShort numReqDataSetWriterIds)
          throws UaException {
    return callReserveIdsDetailed(
        MethodCallOptions.NONE, transportProfileUri, numReqWriterGroupIds, numReqDataSetWriterIds);
  }
  ...
  public CompletableFuture<
          ? extends MethodCallResult<? extends PubSubConfigurationTypeReserveIdsOutputs>>
      callReserveIdsDetailedAsync(
          @Nullable String transportProfileUri,
          @Nullable UShort numReqWriterGroupIds,
          @Nullable UShort numReqDataSetWriterIds) {
    return callReserveIdsDetailedAsync(
        MethodCallOptions.NONE, transportProfileUri, numReqWriterGroupIds, numReqDataSetWriterIds);
  }
  ...
  public CompletableFuture<
      ...
      callReserveIdsDetailedAsync(
          ...
          @Nullable UShort numReqWriterGroupIds,
          @Nullable UShort numReqDataSetWriterIds) {
    CompletableFuture<MethodCallResult<PubSubConfigurationTypeReserveIdsOutputs>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(transportProfileUri);
      rawInputs.add(numReqWriterGroupIds);
      rawInputs.add(numReqDataSetWriterIds);
      var lookup = getReserveIdsMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
      ...
      CompletableFuture<MethodCallResult<PubSubConfigurationTypeReserveIdsOutputs>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ReserveIds"));
                }
                var inputMetadata =
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument TransportProfileUri (effective property"
                                              + " i=25506, DataType i=12) is unavailable in the"
                                ...
                                @Nullable UShort convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument NumReqWriterGroupIds (effective property"
                                              + " i=25506, DataType i=5) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                ...
                                @Nullable UShort convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument NumReqDataSetWriterIds (effective"
                                              + " property i=25506, DataType i=5) is unavailable in"
                                                    ...
                                                    try {
                                                      return MethodCallResult.decode(
                                                          ...
                                                          outputArguments -> {
                                                            ...
                                                            @Nullable UShort @Nullable [] decoded1;
                                                            {
                                                              Object methodValue =
                                                            ...
                                                            @Nullable UShort @Nullable [] decoded2;
                                                            {
                                                              Object methodValue =
                                                            ...
                                                            return PubSubConfigurationTypeReserveIdsOutputs
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:CloseAndUpdate (declaration i=25508,"
                                    + " owner i=25482) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:CloseAndUpdate"
                                                + " (declaration i=25508, owner i=25482) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:CloseAndUpdate (declaration i=25508, owner"
                          + " i=25482)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public PubSubConfigurationTypeCloseAndUpdateOutputs callCloseAndUpdate(
      ...
      throws UaException {
    return callCloseAndUpdateDetailed(fileHandle, requireCompleteUpdate, configurationReferences)
        .requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends PubSubConfigurationTypeCloseAndUpdateOutputs>
      callCloseAndUpdateAsync(
          @Nullable UInteger fileHandle,
          @Nullable Boolean requireCompleteUpdate,
          @Nullable PubSubConfigurationRefDataType @Nullable [] configurationReferences) {
    CompletableFuture<PubSubConfigurationTypeCloseAndUpdateOutputs> result =
        new CompletableFuture<>();
    var call =
        callCloseAndUpdateDetailedAsync(fileHandle, requireCompleteUpdate, configurationReferences);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends PubSubConfigurationTypeCloseAndUpdateOutputs>
    ...
    return callCloseAndUpdateDetailed(
        MethodCallOptions.NONE, fileHandle, requireCompleteUpdate, configurationReferences);
  }
  ...
  public CompletableFuture<
      ...
      callCloseAndUpdateDetailedAsync(
          ...
          @Nullable Boolean requireCompleteUpdate,
          @Nullable PubSubConfigurationRefDataType @Nullable [] configurationReferences) {
    CompletableFuture<MethodCallResult<PubSubConfigurationTypeCloseAndUpdateOutputs>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(fileHandle);
      rawInputs.add(requireCompleteUpdate);
      rawInputs.add(configurationReferences);
      ...
      CompletableFuture<MethodCallResult<PubSubConfigurationTypeCloseAndUpdateOutputs>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                                ...
                                @Nullable UInteger convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument FileHandle (effective property i=25509,"
                                ...
                                @Nullable Boolean convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument RequireCompleteUpdate (effective"
                                              + " property i=25509, DataType i=1) is unavailable in"
                                              + " the effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                            ...
                            if (rawInputs.size() > 2) {
                              Variant encoded2;
                              {
                                @Nullable PubSubConfigurationRefDataType @Nullable []
                                    convertedValue;
                                {
                                  Object methodValue = rawInputs.get(2);
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument ConfigurationReferences (effective"
                                              + " property i=25509, DataType i=25519) is"
                                    ...
                                    if (methodValue == null) {
                                      ...
                                      for (int valueIndex = 0;
                                        ...
                                        convertedValue[valueIndex] =
                                            (PubSubConfigurationRefDataType) valueElement;
                                      }
                                    }
                                  } catch (UaSerializationException conversionFailure) {
                                    throw new UaException(
                                                    ...
                                                    try {
                                                      return MethodCallResult.decode(
                                                          ...
                                                          outputArguments -> {
                                                            ...
                                                            @Nullable NodeId @Nullable [] decoded3;
                                                            {
                                                              Object methodValue =
                                                            ...
                                                            return PubSubConfigurationTypeCloseAndUpdateOutputs
                                                                .of(
