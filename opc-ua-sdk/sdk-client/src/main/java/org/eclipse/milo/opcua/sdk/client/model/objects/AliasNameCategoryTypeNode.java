...
public class AliasNameCategoryTypeNode extends FolderTypeNode implements AliasNameCategoryType {
   ...
   */
  public static ClientViews createViews(AliasNameCategoryTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable UInteger getLastChange() throws UaException {
    PropertyTypeNode node = getLastChangeNode();
    if (node == null) {
  ...
  @Override
  public void setLastChange(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getLastChangeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:LastChange (declaration i=32850, owner"
                            + " i=23456) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeLastChangeAsync(@Nullable UInteger lastChange) {
    return getLastChangeNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
              ...
              try {
                DataValue value = DataValue.valueOnly(new Variant(lastChange));
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:LastChange (declaration i=32850,"
                                    + " owner i=23456) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "LastChange"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:LastChange (declaration"
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:LastChange"
                                                        + " (declaration i=32850, owner i=23456) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
  ...
  public UaMethodNode getFindAliasMethodNode() throws UaException {
    try {
      return getFindAliasMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getFindAliasMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:FindAlias (declaration i=23462, owner"
                                    + " i=23456) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "FindAlias"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:FindAlias (declaration"
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:FindAlias"
                                                                + " (declaration i=23462, owner"
                                                                + " i=23456) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:FindAlias"
                                                        + " (declaration i=23462, owner i=23456) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
   ...
   *
   * @param aliasNameSearchPattern ; the supplied payload may be null.
   * @param referenceTypeFilter ; the supplied payload may be null.
  ...
  @NullMarked
  @Override
  public @Nullable AliasNameDataType @Nullable [] callFindAlias(
      @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter)
      throws UaException {
    return callFindAliasDetailed(aliasNameSearchPattern, referenceTypeFilter).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable AliasNameDataType @Nullable []> callFindAliasAsync(
      @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter) {
    CompletableFuture<@Nullable AliasNameDataType @Nullable []> result = new CompletableFuture<>();
    var call = callFindAliasDetailedAsync(aliasNameSearchPattern, referenceTypeFilter);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable AliasNameDataType @Nullable []> callFindAliasDetailed(
      @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter)
      throws UaException {
    return callFindAliasDetailed(
        MethodCallOptions.NONE, aliasNameSearchPattern, referenceTypeFilter);
  }
  ...
  public MethodCallResult<? extends @Nullable AliasNameDataType @Nullable []> callFindAliasDetailed(
    ...
    var awaitedMethod =
        callFindAliasDetailedAsync(options, aliasNameSearchPattern, referenceTypeFilter);
    try {
  ...
  public CompletableFuture<
          ? extends MethodCallResult<? extends @Nullable AliasNameDataType @Nullable []>>
      callFindAliasDetailedAsync(
          @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter) {
    return callFindAliasDetailedAsync(
        MethodCallOptions.NONE, aliasNameSearchPattern, referenceTypeFilter);
  }
  ...
  public CompletableFuture<
      ...
      callFindAliasDetailedAsync(
          ...
          @Nullable String aliasNameSearchPattern,
          @Nullable NodeId referenceTypeFilter) {
    CompletableFuture<MethodCallResult<@Nullable AliasNameDataType @Nullable []>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(aliasNameSearchPattern);
      rawInputs.add(referenceTypeFilter);
      var lookup = getFindAliasMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
      ...
      CompletableFuture<MethodCallResult<@Nullable AliasNameDataType @Nullable []>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: FindAlias"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(
                                ExpandedNodeId.parse("i=12"), ExpandedNodeId.parse("i=17"))
                                ...
                                @Nullable String convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument AliasNameSearchPattern (effective"
                                              + " property i=23463, DataType i=12) is unavailable"
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument ReferenceTypeFilter (effective property"
                                              + " i=23463, DataType i=17) is unavailable in the"
                                                    ...
                                                    try {
                                                      return MethodCallResult.decode(
                                                          ...
                                                          outputArguments -> {
                                                            ...
                                                            @Nullable AliasNameDataType @Nullable []
                                                                decoded0;
                                                            {
                                                              Object methodValue =
  ...
  public @Nullable UaMethodNode getFindAliasVerboseMethodNode() throws UaException {
    try {
      return getFindAliasVerboseMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getFindAliasVerboseMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:FindAliasVerbose (declaration"
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "FindAliasVerbose"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:FindAliasVerbose"
                                              + " (declaration i=23963, owner i=23456) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:FindAliasVerbose"
                                              + " (declaration i=23963, owner i=23456)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:FindAliasVerbose (declaration i=23963, owner"
                          + " i=23456)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public @Nullable AliasNameVerboseDataType @Nullable [] callFindAliasVerbose(
      @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter)
      throws UaException {
    return callFindAliasVerboseDetailed(aliasNameSearchPattern, referenceTypeFilter).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable AliasNameVerboseDataType @Nullable []>
      callFindAliasVerboseAsync(
          @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter) {
    CompletableFuture<@Nullable AliasNameVerboseDataType @Nullable []> result =
        new CompletableFuture<>();
    var call = callFindAliasVerboseDetailedAsync(aliasNameSearchPattern, referenceTypeFilter);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable AliasNameVerboseDataType @Nullable []>
      callFindAliasVerboseDetailed(
          @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter)
          throws UaException {
    return callFindAliasVerboseDetailed(
        MethodCallOptions.NONE, aliasNameSearchPattern, referenceTypeFilter);
  }
  ...
  public MethodCallResult<? extends @Nullable AliasNameVerboseDataType @Nullable []>
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod =
        callFindAliasVerboseDetailedAsync(options, aliasNameSearchPattern, referenceTypeFilter);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<
      ...
      callFindAliasVerboseDetailedAsync(
          @Nullable String aliasNameSearchPattern, @Nullable NodeId referenceTypeFilter) {
    return callFindAliasVerboseDetailedAsync(
        MethodCallOptions.NONE, aliasNameSearchPattern, referenceTypeFilter);
  }
  ...
  public CompletableFuture<
      ...
      callFindAliasVerboseDetailedAsync(
          ...
          @Nullable String aliasNameSearchPattern,
          @Nullable NodeId referenceTypeFilter) {
    CompletableFuture<MethodCallResult<@Nullable AliasNameVerboseDataType @Nullable []>> result =
        new CompletableFuture<>();
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(aliasNameSearchPattern);
      rawInputs.add(referenceTypeFilter);
      var lookup = getFindAliasVerboseMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
                  ...
                  methodNode -> {
                    ...
                    if (methodNode == null) {
                      return CompletableFuture.failedFuture(
                          new UaException(
                              StatusCodes.Bad_NotFound,
                              "Method node is required for invocation: FindAliasVerbose"));
                    }
                    var inputMetadata =
                        ClientDataTypes.read(
                            this.client,
                                      ...
                                      try {
                                        ...
                                        if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                          ...
                                          throw new UaException(
                                              StatusCodes.Bad_TypeMismatch,
                                              "Method argument AliasNameSearchPattern (effective"
                                                  + " property i=23964, DataType i=12) is"
                                                  + " unavailable in the effective type tree;"
                                                  + " resolved DataType: "
                                                  + argumentDataTypeId);
                                        }
                                        Object numericElements =
                                    ...
                                    @Nullable NodeId convertedValue;
                                    {
                                      ...
                                      try {
                                        ...
                                        if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                          ...
                                          throw new UaException(
                                              StatusCodes.Bad_TypeMismatch,
                                              "Method argument ReferenceTypeFilter (effective"
                                                  + " property i=23964, DataType i=17) is"
                                                  + " unavailable in the effective type tree;"
                                                  + " resolved DataType: "
                                                  + argumentDataTypeId);
                                        }
  ...
  public @Nullable UaMethodNode getAddAliasesToCategoryMethodNode() throws UaException {
    try {
      return getAddAliasesToCategoryMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AddAliasesToCategory (declaration"
                                    + " i=23972, owner i=23456) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddAliasesToCategory"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AddAliasesToCategory"
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:AddAliasesToCategory"
                                              + " (declaration i=23972, owner i=23456)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:AddAliasesToCategory (declaration i=23972,"
                          + " owner i=23456)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param aliasNames ; the supplied payload may be null.
   * @param targetNodes ; the supplied payload may be null.
   * @param targetServers ; the supplied payload may be null.
   * @param targetReferenceType ; the supplied payload may be null.
   * @return the output value or object, or its future; a single value may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public @Nullable StatusCode @Nullable [] callAddAliasesToCategory(
      ...
      throws UaException {
    return callAddAliasesToCategoryDetailed(
  ...
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
      callAddAliasesToCategoryDetailed(
          @Nullable String @Nullable [] aliasNames,
          @Nullable ExpandedNodeId @Nullable [] targetNodes,
          @Nullable String @Nullable [] targetServers,
          @Nullable NodeId targetReferenceType)
          throws UaException {
    return callAddAliasesToCategoryDetailed(
        MethodCallOptions.NONE, aliasNames, targetNodes, targetServers, targetReferenceType);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
      callAddAliasesToCategoryDetailedAsync(
          ...
          @Nullable String @Nullable [] targetServers,
          @Nullable NodeId targetReferenceType) {
    return callAddAliasesToCategoryDetailedAsync(
        MethodCallOptions.NONE, aliasNames, targetNodes, targetServers, targetReferenceType);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(aliasNames);
      rawInputs.add(targetNodes);
      rawInputs.add(targetServers);
      rawInputs.add(targetReferenceType);
      var lookup = getAddAliasesToCategoryMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddAliasesToCategory"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                                ...
                                @Nullable String @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument AliasNames (effective property i=23973,"
                            ...
                            if (rawInputs.size() > 1) {
                              Variant encoded1;
                              {
                                @Nullable ExpandedNodeId @Nullable [] convertedValue;
                                {
                                  Object methodValue = rawInputs.get(1);
                                  try {
                                    if (methodValue instanceof Matrix
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument TargetNodes (effective property i=23973,"
                                              + " DataType i=18) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                    ...
                                    if (methodValue == null) {
                                      ...
                                      convertedValue =
                                          new ExpandedNodeId[Array.getLength(methodValue)];
                                      for (int valueIndex = 0;
                                          valueIndex < convertedValue.length;
                                          valueIndex++) {
                                        Object valueElement = Array.get(methodValue, valueIndex);
                                        convertedValue[valueIndex] = (ExpandedNodeId) valueElement;
                                      }
                                    }
                                  } catch (UaSerializationException conversionFailure) {
                                    throw new UaException(
                                ...
                                @Nullable String @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument TargetServers (effective property"
                                              + " i=23973, DataType i=12) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument TargetReferenceType (effective property"
                                              + " i=23973, DataType i=17) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
  ...
  public @Nullable UaMethodNode getDeleteAliasesFromCategoryMethodNode() throws UaException {
    try {
      return getDeleteAliasesFromCategoryMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:DeleteAliasesFromCategory"
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "DeleteAliasesFromCategory"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:DeleteAliasesFromCategory"
                                              + " (declaration i=23975, owner i=23456)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:DeleteAliasesFromCategory (declaration i=23975,"
                          + " owner i=23456)"));
            } else {
              result.complete((UaMethodNode) node);
            }
  ...
  @NullMarked
  @Override
  public @Nullable StatusCode @Nullable [] callDeleteAliasesFromCategory(
      @Nullable String @Nullable [] aliasNames, @Nullable ExpandedNodeId @Nullable [] targetNodes)
      throws UaException {
    return callDeleteAliasesFromCategoryDetailed(aliasNames, targetNodes).requireGood();
  }
  ...
  public CompletableFuture<? extends @Nullable StatusCode @Nullable []>
      callDeleteAliasesFromCategoryAsync(
          ...
          @Nullable ExpandedNodeId @Nullable [] targetNodes) {
    CompletableFuture<@Nullable StatusCode @Nullable []> result = new CompletableFuture<>();
    var call = callDeleteAliasesFromCategoryDetailedAsync(aliasNames, targetNodes);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
      callDeleteAliasesFromCategoryDetailed(
          ...
          @Nullable ExpandedNodeId @Nullable [] targetNodes)
          throws UaException {
    return callDeleteAliasesFromCategoryDetailed(MethodCallOptions.NONE, aliasNames, targetNodes);
  }
  ...
  public MethodCallResult<? extends @Nullable StatusCode @Nullable []>
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod =
        callDeleteAliasesFromCategoryDetailedAsync(options, aliasNames, targetNodes);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
      callDeleteAliasesFromCategoryDetailedAsync(
          @Nullable String @Nullable [] aliasNames,
          @Nullable ExpandedNodeId @Nullable [] targetNodes) {
    return callDeleteAliasesFromCategoryDetailedAsync(
        MethodCallOptions.NONE, aliasNames, targetNodes);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable StatusCode @Nullable []>>
    ...
    try {
      ...
      rawInputs.add(aliasNames);
      rawInputs.add(targetNodes);
      var lookup = getDeleteAliasesFromCategoryMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: DeleteAliasesFromCategory"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(
                                ExpandedNodeId.parse("i=12"), ExpandedNodeId.parse("i=18"))
                            .subList(0, rawInputs.size()),
                        rawInputs.toArray());
                result.whenComplete(
                    (cancelledValue, cancelledFailure) -> {
                                ...
                                @Nullable String @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument AliasNames (effective property i=23976,"
                                              + " DataType i=12) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                ...
                                @Nullable ExpandedNodeId @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument TargetNodes (effective property i=23976,"
                                              + " DataType i=18) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
