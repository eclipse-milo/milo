...
public class AliasNameCategoryTypeNode extends FolderTypeNode implements AliasNameCategoryType {
  ...
  @Override
  public UInteger getLastChange() throws UaException {
    PropertyTypeNode node = getLastChangeNode();
    return (UInteger) node.getValue().getValue().getValue();
  }

  @Override
  public void setLastChange(UInteger value) throws UaException {
    PropertyTypeNode node = getLastChangeNode();
  ...
  @Override
  public CompletableFuture<? extends UInteger> readLastChangeAsync() {
  ...
  @Override
  public CompletableFuture<StatusCode> writeLastChangeAsync(UInteger lastChange) {
