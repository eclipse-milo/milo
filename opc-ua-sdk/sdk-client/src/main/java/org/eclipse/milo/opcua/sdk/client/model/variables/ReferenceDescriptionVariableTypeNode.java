...
public class ReferenceDescriptionVariableTypeNode extends BaseDataVariableTypeNode
  ...
  public @Nullable ReferenceListEntryDataType @Nullable [] getReferenceRefinement()
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:ReferenceRefinement (declaration i=32658, owner i=32657)"
              + " on "
              + getNodeId());
    }
  ...
  public void setReferenceRefinement(@Nullable ReferenceListEntryDataType @Nullable [] value)
    ...
    node.setValue(
        new Variant(encodeValue(value, ReferenceListEntryDataType.class, ValueRanks.OneDimension)));
  }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ReferenceRefinement (declaration i=32658,"
                            + " owner i=32657) on "
                            + getNodeId()));
              }
  ...
  public CompletableFuture<StatusCode> writeReferenceRefinementAsync(
      @Nullable ReferenceListEntryDataType @Nullable [] referenceRefinement) {
    return getReferenceRefinementNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ReferenceRefinement (declaration"
                                    + " i=32658, owner i=32657) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ReferenceRefinement"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ReferenceRefinement"
                                              + " (declaration i=32658, owner i=32657) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ReferenceRefinement"
                                              + " (declaration i=32658, owner i=32657)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:ReferenceRefinement (declaration i=32658, owner"
                          + " i=32657)"));
            } else {
