...
public class VectorTypeNode extends BaseDataVariableTypeNode implements VectorType {
  ...
  @Override
  public @Nullable EUInformation getVectorUnit() throws UaException {
    PropertyTypeNode node = getVectorUnitNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:VectorUnit (declaration i=17715, owner i=17714)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setVectorUnit(@Nullable EUInformation value) throws UaException {
    PropertyTypeNode node = getVectorUnitNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable EUInformation readVectorUnit() throws UaException {
    try {
  ...
  @Override
  public void writeVectorUnit(@Nullable EUInformation value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable EUInformation> readVectorUnitAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:VectorUnit (declaration i=17715, owner"
                            + " i=17714) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeVectorUnitAsync(@Nullable EUInformation vectorUnit) {
    return getVectorUnitNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
              ...
              try {
                DataValue value =
                    DataValue.valueOnly(
                        new Variant(
                            encodeValue(vectorUnit, EUInformation.class, ValueRanks.Scalar)));
  ...
  @Override
  public @Nullable PropertyTypeNode getVectorUnitNode() throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable PropertyTypeNode> getVectorUnitNodeAsync() {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:VectorUnit (declaration i=17715,"
                                    + " owner i=17714) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "VectorUnit"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:VectorUnit (declaration"
                                              + " i=17715, owner i=17714) on "
                                              + getNodeId()));
                                }
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:VectorUnit"
                                                                + " (declaration i=17715, owner"
                                                                + " i=17714) on "
                                                                + getNodeId()));
                                                  }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:VectorUnit"
                                                        + " (declaration i=17715, owner i=17714) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
