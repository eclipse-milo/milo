...
public class SubscriptionDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
  ...
  public CompletableFuture<? extends SubscriptionDiagnosticsTypeNode>
    ...
    CompletableFuture<SubscriptionDiagnosticsTypeNode> result = new CompletableFuture<>();
    try {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:SubscriptionDiagnostics (declaration"
                                    + " i=12784, owner i=2171) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        true,
                                        new QualifiedName(
                                            namespaceIndex, "SubscriptionDiagnostics"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SubscriptionDiagnostics"
                                              + " (declaration i=12784, owner i=2171) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SubscriptionDiagnostics"
                                              + " (declaration i=12784, owner i=2171)"));
                                }
      ...
      hop0.whenComplete(
          (node, failure) -> {
            if (failure != null) {
            ...
            } else if (node != null && !(node instanceof SubscriptionDiagnosticsTypeNode)) {
              ...
              result.complete((SubscriptionDiagnosticsTypeNode) node);
            }
          });
    } catch (Exception e) {
