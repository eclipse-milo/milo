...
public class IIeeeTsnInterfaceConfigurationTalkerTypeNode
   ...
   */
  public static ClientViews createViews(IIeeeTsnInterfaceConfigurationTalkerTypeNode node) {
  ...
  @Override
  public CompletableFuture<StatusCode> writeTimeAwareOffsetAsync(
      @Nullable UInteger timeAwareOffset) {
    return getTimeAwareOffsetNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  @Override
  public @Nullable BaseDataVariableTypeNode getTimeAwareOffsetNode() throws UaException {
    try {
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "TimeAwareOffset"))
                                  }));
                      return client
