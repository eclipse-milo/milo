...
public class OptionSetTypeNode extends BaseDataVariableTypeNode implements OptionSetType {
  ...
  @Override
  public @Nullable LocalizedText @Nullable [] getOptionSetValues() throws UaException {
    PropertyTypeNode node = getOptionSetValuesNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:OptionSetValues (declaration i=11488, owner i=11487)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setOptionSetValues(@Nullable LocalizedText @Nullable [] value) throws UaException {
    PropertyTypeNode node = getOptionSetValuesNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable LocalizedText @Nullable [] readOptionSetValues() throws UaException {
    try {
  ...
  @Override
  public void writeOptionSetValues(@Nullable LocalizedText @Nullable [] value) throws UaException {
    try {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:OptionSetValues (declaration i=11488, owner"
                            + " i=11487) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeOptionSetValuesAsync(
      @Nullable LocalizedText @Nullable [] optionSetValues) {
    return getOptionSetValuesNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:OptionSetValues (declaration i=11488,"
                                    + " owner i=11487) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "OptionSetValues"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:OptionSetValues"
                                              + " (declaration i=11488, owner i=11487) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:OptionSetValues"
                                              + " (declaration i=11488, owner i=11487)"));
                                }
  ...
  @Override
  public @Nullable Boolean @Nullable [] getBitMask() throws UaException {
    PropertyTypeNode node = getBitMaskNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:BitMask (declaration i=11701, owner i=11487)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setBitMask(@Nullable Boolean @Nullable [] value) throws UaException {
    PropertyTypeNode node = getBitMaskNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable Boolean @Nullable [] readBitMask() throws UaException {
    try {
  ...
  @Override
  public void writeBitMask(@Nullable Boolean @Nullable [] value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable Boolean @Nullable []> readBitMaskAsync() {
  ...
  @Override
  public CompletableFuture<StatusCode> writeBitMaskAsync(@Nullable Boolean @Nullable [] bitMask) {
    return getBitMaskNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:BitMask (declaration i=11701, owner"
                                    + " i=11487) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "BitMask"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:BitMask (declaration"
                                              + " i=11701, owner i=11487) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:BitMask"
                                                        + " (declaration i=11701, owner i=11487) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
