...
public class AuditProgramTransitionEventTypeNode extends AuditUpdateStateEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditProgramTransitionEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable UInteger getTransitionNumber() throws UaException {
    PropertyTypeNode node = getTransitionNumberNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:TransitionNumber (declaration i=11875, owner i=11856)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setTransitionNumber(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getTransitionNumberNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:TransitionNumber (declaration i=11875, owner"
                            + " i=11856) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeTransitionNumberAsync(
      @Nullable UInteger transitionNumber) {
    return getTransitionNumberNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:TransitionNumber (declaration"
                                    + " i=11875, owner i=11856) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "TransitionNumber"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:TransitionNumber"
                                              + " (declaration i=11875, owner i=11856) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:TransitionNumber"
                                              + " (declaration i=11875, owner i=11856)"));
                                }
