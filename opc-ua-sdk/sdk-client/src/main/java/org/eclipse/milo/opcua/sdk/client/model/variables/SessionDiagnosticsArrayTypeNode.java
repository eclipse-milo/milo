...
public class SessionDiagnosticsArrayTypeNode extends BaseDataVariableTypeNode
    implements SessionDiagnosticsArrayType {
  public SessionDiagnosticsArrayTypeNode(
      OpcUaClient client,
      NodeId nodeId,
      NodeClass nodeClass,
  ...
  public @Nullable SessionDiagnosticsDataType getSessionDiagnostics() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:SessionDiagnostics (declaration i=12816, owner i=2196)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SessionDiagnostics (declaration i=12816,"
                            + " owner i=2196) on "
                            + getNodeId()));
              }
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SessionDiagnostics"
                                              + " (declaration i=12816, owner i=2196) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:SessionDiagnostics"
                                              + " (declaration i=12816, owner i=2196)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:SessionDiagnostics (declaration i=12816, owner"
                          + " i=2196)"));
            } else {
