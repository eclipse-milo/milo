...
public class ReaderGroupTypeNode extends PubSubGroupTypeNode implements ReaderGroupType {
   ...
   */
  public static ClientViews createViews(ReaderGroupTypeNode node) {
  ...
  public CompletableFuture<? extends @Nullable PubSubDiagnosticsReaderGroupTypeNode>
    ...
    CompletableFuture<PubSubDiagnosticsReaderGroupTypeNode> result = new CompletableFuture<>();
    try {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:Diagnostics (declaration i=21015,"
                                    + " owner i=17999) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Diagnostics"
                                                        + " (declaration i=21015, owner i=17999) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
      ...
      hop0.whenComplete(
          (node, failure) -> {
            ...
            } else if (node != null && !(node instanceof PubSubDiagnosticsReaderGroupTypeNode)) {
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:Diagnostics (declaration i=21015, owner"
                          + " i=17999)"));
            } else {
              result.complete((PubSubDiagnosticsReaderGroupTypeNode) node);
            }
          });
    } catch (Exception e) {
  ...
  public CompletableFuture<? extends @Nullable ReaderGroupTransportTypeNode>
    ...
    CompletableFuture<ReaderGroupTransportTypeNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
          lookup.thenCompose(
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:TransportSettings"
                                              + " (declaration i=21080, owner i=17999) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:TransportSettings"
                                              + " (declaration i=21080, owner i=17999)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
      ...
      hop0.whenComplete(
          (node, failure) -> {
            if (failure != null) {
              result.completeExceptionally(failure);
            } else if (node != null && !(node instanceof ReaderGroupTransportTypeNode)) {
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:TransportSettings (declaration i=21080, owner"
                          + " i=17999)"));
            } else {
              result.complete((ReaderGroupTransportTypeNode) node);
            }
          });
    } catch (Exception e) {
      result.completeExceptionally(e);
  ...
  public CompletableFuture<? extends @Nullable ReaderGroupMessageTypeNode>
    ...
    CompletableFuture<ReaderGroupMessageTypeNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
          lookup.thenCompose(
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:MessageSettings (declaration i=21081,"
                                    + " owner i=17999) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:MessageSettings"
                                              + " (declaration i=21081, owner i=17999) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:MessageSettings"
                                              + " (declaration i=21081, owner i=17999)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
      ...
      hop0.whenComplete(
          (node, failure) -> {
            if (failure != null) {
              result.completeExceptionally(failure);
            } else if (node != null && !(node instanceof ReaderGroupMessageTypeNode)) {
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:MessageSettings (declaration i=21081, owner"
                          + " i=17999)"));
            } else {
              result.complete((ReaderGroupMessageTypeNode) node);
            }
          });
    } catch (Exception e) {
      result.completeExceptionally(e);
  ...
  public @Nullable UaMethodNode getAddDataSetReaderMethodNode() throws UaException {
    try {
      return getAddDataSetReaderMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable UaMethodNode> getAddDataSetReaderMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:AddDataSetReader (declaration"
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddDataSetReader"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:AddDataSetReader"
                                              + " (declaration i=21082, owner i=17999) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:AddDataSetReader"
                                              + " (declaration i=21082, owner i=17999)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:AddDataSetReader (declaration i=21082, owner"
                          + " i=17999)"));
            } else {
  ...
  @NullMarked
  @Override
  public @Nullable NodeId callAddDataSetReader(@Nullable DataSetReaderDataType configuration)
      throws UaException {
    return callAddDataSetReaderDetailed(configuration).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable NodeId> callAddDataSetReaderAsync(
      @Nullable DataSetReaderDataType configuration) {
    CompletableFuture<@Nullable NodeId> result = new CompletableFuture<>();
    var call = callAddDataSetReaderDetailedAsync(configuration);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable NodeId> callAddDataSetReaderDetailed(
      @Nullable DataSetReaderDataType configuration) throws UaException {
    return callAddDataSetReaderDetailed(MethodCallOptions.NONE, configuration);
  }
  ...
  public MethodCallResult<? extends @Nullable NodeId> callAddDataSetReaderDetailed(
    ...
    var awaitedMethod = callAddDataSetReaderDetailedAsync(options, configuration);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    return callAddDataSetReaderDetailedAsync(MethodCallOptions.NONE, configuration);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    try {
      ...
      var lookup = getAddDataSetReaderMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          ...
                          "Method node is required for invocation: AddDataSetReader"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(ExpandedNodeId.parse("i=15623"))
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                            ...
                            if (rawInputs.size() > 0) {
                              Variant encoded0;
                              {
                                @Nullable DataSetReaderDataType convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          ...
                                          "Method argument Configuration (effective property"
                                              + " i=21083, DataType i=15623) is unavailable in the"
                                    ...
                                    convertedValue = (DataSetReaderDataType) methodValue;
  ...
  public @Nullable UaMethodNode getRemoveDataSetReaderMethodNode() throws UaException {
    try {
      return getRemoveDataSetReaderMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemoveDataSetReader (declaration"
                                    + " i=21085, owner i=17999) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RemoveDataSetReader"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RemoveDataSetReader"
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RemoveDataSetReader"
                                              + " (declaration i=21085, owner i=17999)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param dataSetReaderNodeId ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callRemoveDataSetReader(@Nullable NodeId dataSetReaderNodeId) throws UaException {
    callRemoveDataSetReaderDetailed(dataSetReaderNodeId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemoveDataSetReaderAsync(
      @Nullable NodeId dataSetReaderNodeId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemoveDataSetReaderDetailedAsync(dataSetReaderNodeId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemoveDataSetReaderDetailed(
      @Nullable NodeId dataSetReaderNodeId) throws UaException {
    return callRemoveDataSetReaderDetailed(MethodCallOptions.NONE, dataSetReaderNodeId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemoveDataSetReaderDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callRemoveDataSetReaderDetailedAsync(options, dataSetReaderNodeId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemoveDataSetReaderDetailedAsync(MethodCallOptions.NONE, dataSetReaderNodeId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(dataSetReaderNodeId);
      var lookup = getRemoveDataSetReaderMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemoveDataSetReader"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument DataSetReaderNodeId (effective property"
                                              + " i=21086, DataType i=17) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
