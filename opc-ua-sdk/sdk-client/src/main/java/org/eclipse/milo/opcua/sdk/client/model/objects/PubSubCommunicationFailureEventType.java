...
public interface PubSubCommunicationFailureEventType extends PubSubStatusEventType {
  ...
  /**
   * Read the value of the Error Node from the server and update the local value if the operation
   * succeeds.
   *
  ...
  /**
   * Write a new value for the Error Node to the server and update the local value if the operation
   * succeeds.
   *
