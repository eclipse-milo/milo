...
public class AuditCancelEventTypeNode extends AuditSessionEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditCancelEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable UInteger getRequestHandle() throws UaException {
    PropertyTypeNode node = getRequestHandleNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:RequestHandle (declaration i=2079, owner i=2078)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setRequestHandle(@Nullable UInteger value) throws UaException {
    PropertyTypeNode node = getRequestHandleNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:RequestHandle (declaration i=2079, owner"
                            + " i=2078) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeRequestHandleAsync(@Nullable UInteger requestHandle) {
    return getRequestHandleNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:RequestHandle (declaration i=2079,"
                                    + " owner i=2078) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RequestHandle"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:RequestHandle (declaration"
                                              + " i=2079, owner i=2078) on "
                                              + getNodeId()));
                                }
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:RequestHandle"
                                                + " (declaration i=2079, owner i=2078) on "
                                                + getNodeId()));
                                  }
