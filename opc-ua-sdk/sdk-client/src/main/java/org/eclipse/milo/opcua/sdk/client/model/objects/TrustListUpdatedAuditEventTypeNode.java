...
public class TrustListUpdatedAuditEventTypeNode extends AuditUpdateMethodEventTypeNode
   ...
   */
  public static ClientViews createViews(TrustListUpdatedAuditEventTypeNode node) {
  ...
  public @Nullable NodeId getTrustListId() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:TrustListId (declaration i=32281, owner i=12561)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:TrustListId (declaration i=32281, owner"
                            + " i=12561) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:TrustListId (declaration i=32281,"
                                    + " owner i=12561) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:TrustListId"
                                                        + " (declaration i=32281, owner i=12561) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
