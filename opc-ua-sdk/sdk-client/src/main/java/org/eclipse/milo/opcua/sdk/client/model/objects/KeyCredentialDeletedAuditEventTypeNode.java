...
public class KeyCredentialDeletedAuditEventTypeNode extends KeyCredentialAuditEventTypeNode
   ...
   */
  public static ClientViews createViews(KeyCredentialDeletedAuditEventTypeNode node) {
  ...
  public @Nullable String getResourceUri() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:ResourceUri (declaration i=18064, owner i=18047)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ResourceUri (declaration i=18064, owner"
                            + " i=18047) on "
                            + getNodeId()));
              }
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ResourceUri (declaration i=18064,"
                                    + " owner i=18047) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:ResourceUri"
                                                        + " (declaration i=18064, owner i=18047) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
