...
public class NonExclusiveRateOfChangeAlarmTypeNode extends NonExclusiveLimitAlarmTypeNode
   ...
   */
  public static ClientViews createViews(NonExclusiveRateOfChangeAlarmTypeNode node) {
  ...
  public @Nullable EUInformation getEngineeringUnits() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          ...
          "http://opcfoundation.org/UA/:EngineeringUnits (declaration i=16858, owner i=10214)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EngineeringUnits (declaration i=16858, owner"
                            + " i=10214) on "
                            + getNodeId()));
              }
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "EngineeringUnits"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:EngineeringUnits"
                                              + " (declaration i=16858, owner i=10214) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:EngineeringUnits"
                                              + " (declaration i=16858, owner i=10214)"));
                                }
