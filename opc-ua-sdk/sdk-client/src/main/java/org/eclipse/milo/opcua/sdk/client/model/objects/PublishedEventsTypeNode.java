...
public class PublishedEventsTypeNode extends PublishedDataSetTypeNode
   ...
   */
  public static ClientViews createViews(PublishedEventsTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable NodeId getPubSubEventNotifier() throws UaException {
    PropertyTypeNode node = getPubSubEventNotifierNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:EventNotifier (declaration i=14586, owner i=14572)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setPubSubEventNotifier(@Nullable NodeId value) throws UaException {
    PropertyTypeNode node = getPubSubEventNotifierNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable NodeId readPubSubEventNotifier() throws UaException {
    try {
  ...
  @Override
  public void writePubSubEventNotifier(@Nullable NodeId value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable NodeId> readPubSubEventNotifierAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:EventNotifier (declaration i=14586, owner"
                            + " i=14572) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writePubSubEventNotifierAsync(
      @Nullable NodeId pubSubEventNotifier) {
    return getPubSubEventNotifierNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:EventNotifier (declaration i=14586,"
                                    + " owner i=14572) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "EventNotifier"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:EventNotifier (declaration"
                                              + " i=14586, owner i=14572) on "
                                              + getNodeId()));
                                }
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:EventNotifier"
                                                + " (declaration i=14586, owner i=14572) on "
                                                + getNodeId()));
                                  }
  ...
  @Override
  public @Nullable SimpleAttributeOperand @Nullable [] getSelectedFields() throws UaException {
    PropertyTypeNode node = getSelectedFieldsNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:SelectedFields (declaration i=14587, owner i=14572)"
              + " on "
              + getNodeId());
    }
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:SelectedFields (declaration i=14587, owner"
                            + " i=14572) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:SelectedFields (declaration i=14587,"
                                    + " owner i=14572) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "SelectedFields"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:SelectedFields (declaration"
                                              + " i=14587, owner i=14572) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            ...
                                            "http://opcfoundation.org/UA/:SelectedFields"
                                                + " (declaration i=14587, owner i=14572) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  public @Nullable ContentFilter getFilter() throws UaException {
    ...
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Filter (declaration i=14588, owner i=14572)"
              + " on "
              + getNodeId());
    }
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Filter (declaration i=14588, owner"
                                    + " i=14572) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Filter"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Filter (declaration"
                                              + " i=14588, owner i=14572) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Filter"
                                                        + " (declaration i=14588, owner i=14572) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
  ...
  public @Nullable UaMethodNode getModifyFieldSelectionMethodNode() throws UaException {
    try {
      return getModifyFieldSelectionMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:ModifyFieldSelection (declaration"
                                    + " i=15052, owner i=14572) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ModifyFieldSelection"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:ModifyFieldSelection"
                                              + " (declaration i=15052, owner i=14572) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:ModifyFieldSelection"
                                              + " (declaration i=15052, owner i=14572)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:ModifyFieldSelection (declaration i=15052,"
                          + " owner i=14572)"));
            } else {
  ...
  @NullMarked
  @Override
  public @Nullable ConfigurationVersionDataType callModifyFieldSelection(
      ...
      @Nullable SimpleAttributeOperand @Nullable [] selectedFields)
      throws UaException {
    return callModifyFieldSelectionDetailed(
  ...
  public CompletableFuture<? extends @Nullable ConfigurationVersionDataType>
      callModifyFieldSelectionAsync(
          ...
          @Nullable Boolean @Nullable [] promotedFields,
          @Nullable SimpleAttributeOperand @Nullable [] selectedFields) {
    CompletableFuture<@Nullable ConfigurationVersionDataType> result = new CompletableFuture<>();
    var call =
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable ConfigurationVersionDataType>
  ...
  public CompletableFuture<
          ? extends MethodCallResult<? extends @Nullable ConfigurationVersionDataType>>
      callModifyFieldSelectionDetailedAsync(
          @Nullable ConfigurationVersionDataType configurationVersion,
          @Nullable String @Nullable [] fieldNameAliases,
          @Nullable Boolean @Nullable [] promotedFields,
          @Nullable SimpleAttributeOperand @Nullable [] selectedFields) {
    return callModifyFieldSelectionDetailedAsync(
        MethodCallOptions.NONE,
        configurationVersion,
        fieldNameAliases,
        promotedFields,
  ...
  public CompletableFuture<
      ...
      callModifyFieldSelectionDetailedAsync(
          ...
          @Nullable Boolean @Nullable [] promotedFields,
          @Nullable SimpleAttributeOperand @Nullable [] selectedFields) {
    CompletableFuture<MethodCallResult<@Nullable ConfigurationVersionDataType>> result =
    ...
    try {
      ...
      rawInputs.add(selectedFields);
      var lookup = getModifyFieldSelectionMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
      ...
      CompletableFuture<MethodCallResult<@Nullable ConfigurationVersionDataType>> pipeline =
          lookup.thenCompose(
              methodNode -> {
                if (result.isCancelled()) {
                  return CompletableFuture.failedFuture(new CancellationException());
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: ModifyFieldSelection"));
                }
                var inputMetadata =
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          ...
                                          "Method argument ConfigurationVersion (effective property"
                                              + " i=15053, DataType i=14593) is unavailable in the"
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          ...
                                          "Method argument FieldNameAliases (effective property"
                                              + " i=15053, DataType i=12) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          ...
                                          "Method argument PromotedFields (effective property"
                                              + " i=15053, DataType i=1) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                            ...
                            if (rawInputs.size() > 3) {
                              Variant encoded3;
                              {
                                @Nullable SimpleAttributeOperand @Nullable [] convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument SelectedFields (effective property"
                                              + " i=15053, DataType i=601) is unavailable in the"
                                              + " effective type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
                                    ...
                                    if (methodValue == null) {
                                      ...
                                      convertedValue =
                                          new SimpleAttributeOperand[Array.getLength(methodValue)];
                                      for (int valueIndex = 0;
                                          valueIndex < convertedValue.length;
                                          valueIndex++) {
                                        Object valueElement = Array.get(methodValue, valueIndex);
                                        convertedValue[valueIndex] =
                                            (SimpleAttributeOperand) valueElement;
                                      }
                                    }
                                  } catch (UaSerializationException conversionFailure) {
                                    throw new UaException(
