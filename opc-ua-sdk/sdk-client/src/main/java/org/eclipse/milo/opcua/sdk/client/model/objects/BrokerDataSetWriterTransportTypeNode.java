...
public class BrokerDataSetWriterTransportTypeNode extends DataSetWriterTransportTypeNode
   ...
   */
  public static ClientViews createViews(BrokerDataSetWriterTransportTypeNode node) {
  ...
  @Override
  public @Nullable Double getMetaDataUpdateTime() throws UaException {
    PropertyTypeNode node = getMetaDataUpdateTimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:MetaDataUpdateTime (declaration i=21141, owner i=21138)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setMetaDataUpdateTime(@Nullable Double value) throws UaException {
    PropertyTypeNode node = getMetaDataUpdateTimeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:MetaDataUpdateTime (declaration i=21141,"
                            + " owner i=21138) on "
                            + getNodeId()));
              }
              return node.readAttributeAsync(AttributeId.Value);
  ...
  @Override
  public CompletableFuture<StatusCode> writeMetaDataUpdateTimeAsync(
