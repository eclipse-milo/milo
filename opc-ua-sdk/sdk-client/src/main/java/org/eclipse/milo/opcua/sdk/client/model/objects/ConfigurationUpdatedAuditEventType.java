...
public interface ConfigurationUpdatedAuditEventType extends AuditEventType {
  ...
  @Nullable UInteger getOldVersion() throws UaException;

  /** Sets the existing node's local value. */
  void setOldVersion(@Nullable UInteger value) throws UaException;
  ...
  /** Gets the existing node's local value. */
  @Nullable UInteger getNewVersion() throws UaException;

  /** Sets the existing node's local value. */
  void setNewVersion(@Nullable UInteger value) throws UaException;
