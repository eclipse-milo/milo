...
public class NetworkAddressUrlTypeNode extends NetworkAddressTypeNode
   ...
   */
  public static ClientViews createViews(NetworkAddressUrlTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String getUrl() throws UaException {
    BaseDataVariableTypeNode node = getUrlNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Url (declaration i=21149, owner i=21147)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setUrl(@Nullable String value) throws UaException {
    BaseDataVariableTypeNode node = getUrlNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeUrlAsync(@Nullable String url) {
    return getUrlNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:Url (declaration i=21149, owner"
                                    + " i=21147) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Url"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:Url (declaration i=21149,"
                                              + " owner i=21147) on "
                                              + getNodeId()));
                                }
                                        ...
                                        ready -> {
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Url (declaration"
                                                        + " i=21149, owner i=21147) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
