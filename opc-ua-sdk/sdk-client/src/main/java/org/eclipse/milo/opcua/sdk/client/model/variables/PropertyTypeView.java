 ...
 */
@NullMarked
public final class PropertyTypeView extends ClientVariableView implements PropertyType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ClientVariableViewType<PropertyType> TYPE =
  ...
  private PropertyTypeView(ClientViews views, UaVariableNode node) {
    super(views, node);
  }
}
