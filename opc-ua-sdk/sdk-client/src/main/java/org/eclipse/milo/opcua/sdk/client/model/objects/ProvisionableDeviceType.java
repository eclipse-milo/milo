...
public interface ProvisionableDeviceType extends BaseObjectType {
  ...
  /**
   * Read the value of the IsSingleton Node from the server and update the local value if the
   * operation succeeds.
   *
  ...
  /**
   * Write a new value for the IsSingleton Node to the server and update the local value if the
   * operation succeeds.
   *
