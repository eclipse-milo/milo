...
/**
 * Client API for the 3DCartesianCoordinatesType VariableType.
 *
...
public interface ThreeDCartesianCoordinatesType extends CartesianCoordinatesType {
   ...
   * @throws UaException if lookup, conversion or the operation fails.
   */
  @Nullable ThreeDCartesianCoordinates readThreeDCartesianCoordinatesValue() throws UaException;
   ...
   * @throws UaException if lookup, conversion or the operation fails.
   */
  void writeThreeDCartesianCoordinatesValue(@Nullable ThreeDCartesianCoordinates value)
      throws UaException;

  /** Asynchronous form of {@link #readThreeDCartesianCoordinatesValue()}. */
  CompletableFuture<? extends @Nullable ThreeDCartesianCoordinates>
      readThreeDCartesianCoordinatesValueAsync();

  /**
   * Asynchronous form of {@link #writeThreeDCartesianCoordinatesValue}; completes with the
   * operation status.
   */
  CompletableFuture<StatusCode> writeThreeDCartesianCoordinatesValueAsync(
