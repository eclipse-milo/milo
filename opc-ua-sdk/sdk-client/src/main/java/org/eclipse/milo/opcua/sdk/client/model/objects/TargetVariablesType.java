...
public interface TargetVariablesType extends SubscribedDataSetType {
  ...
  /**
   * Read the value of the TargetVariables Node from the server and update the local value if the
   * operation succeeds.
   *
  ...
  /**
   * Write a new value for the TargetVariables Node to the server and update the local value if the
   * operation succeeds.
   *
