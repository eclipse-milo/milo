 ...
 */
@NullMarked
public final class BaseDataVariableTypeView extends ClientVariableView
    implements BaseDataVariableType {
  /** Selected UA/Java contract and context-owned factory. */
  public static final ClientVariableViewType<BaseDataVariableType> TYPE =
  ...
  private BaseDataVariableTypeView(ClientViews views, UaVariableNode node) {
    super(views, node);
  }
}
