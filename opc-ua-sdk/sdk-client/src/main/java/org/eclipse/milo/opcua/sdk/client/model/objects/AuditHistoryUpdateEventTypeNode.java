...
public class AuditHistoryUpdateEventTypeNode extends AuditUpdateEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditHistoryUpdateEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable NodeId getParameterDataTypeId() throws UaException {
    PropertyTypeNode node = getParameterDataTypeIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:ParameterDataTypeId (declaration i=2751, owner i=2104)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setParameterDataTypeId(@Nullable NodeId value) throws UaException {
    PropertyTypeNode node = getParameterDataTypeIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:ParameterDataTypeId (declaration i=2751,"
                            + " owner i=2104) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeParameterDataTypeIdAsync(
      @Nullable NodeId parameterDataTypeId) {
    return getParameterDataTypeIdNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ParameterDataTypeId (declaration"
                                    + " i=2751, owner i=2104) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ParameterDataTypeId"))
                                  }));
                      return client
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ParameterDataTypeId"
                                              + " (declaration i=2751, owner i=2104) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:ParameterDataTypeId"
                                              + " (declaration i=2751, owner i=2104)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:ParameterDataTypeId (declaration i=2751, owner"
                          + " i=2104)"));
            } else {
