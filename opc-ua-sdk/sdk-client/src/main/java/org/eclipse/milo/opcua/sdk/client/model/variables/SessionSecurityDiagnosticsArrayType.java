...
/**
 * Client API for the SessionSecurityDiagnosticsArrayType VariableType.
 *
...
public interface SessionSecurityDiagnosticsArrayType extends BaseDataVariableType {
   ...
   */
  @Nullable SessionSecurityDiagnosticsDataType @Nullable [] readTypedValue() throws UaException;
   ...
   * @throws UaException if lookup, conversion or the operation fails.
   */
  void writeTypedValue(@Nullable SessionSecurityDiagnosticsDataType @Nullable [] value)
      throws UaException;
