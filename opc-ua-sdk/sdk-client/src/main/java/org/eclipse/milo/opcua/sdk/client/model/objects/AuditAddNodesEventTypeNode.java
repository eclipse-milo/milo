...
public class AuditAddNodesEventTypeNode extends AuditNodeManagementEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditAddNodesEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable AddNodesItem @Nullable [] getNodesToAdd() throws UaException {
    PropertyTypeNode node = getNodesToAddNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NodesToAdd (declaration i=2092, owner i=2091)"
              + " on "
              + getNodeId());
    }
    return (AddNodesItem[])
        decodeValue(
            node.getValue().getValue().getValue(), AddNodesItem.class, ValueRanks.OneDimension);
  }

  @Override
  public void setNodesToAdd(@Nullable AddNodesItem @Nullable [] value) throws UaException {
    PropertyTypeNode node = getNodesToAddNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
    ...
    node.setValue(new Variant(encodeValue(value, AddNodesItem.class, ValueRanks.OneDimension)));
  }
        ...
        .thenApply(
            v -> {
              ...
              try {
                return (AddNodesItem[])
                    decodeValue(
                        v.getValue().getValue(), AddNodesItem.class, ValueRanks.OneDimension);
  ...
  public CompletableFuture<StatusCode> writeNodesToAddAsync(
      @Nullable AddNodesItem @Nullable [] nodesToAdd) {
    return getNodesToAddNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
              ...
              try {
                DataValue value =
                    DataValue.valueOnly(
                        new Variant(
                            encodeValue(nodesToAdd, AddNodesItem.class, ValueRanks.OneDimension)));
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NodesToAdd (declaration i=2092, owner"
                                    + " i=2091) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "NodesToAdd"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NodesToAdd (declaration"
                                              + " i=2092, owner i=2091) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:NodesToAdd"
                                                        + " (declaration i=2092, owner i=2091) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
