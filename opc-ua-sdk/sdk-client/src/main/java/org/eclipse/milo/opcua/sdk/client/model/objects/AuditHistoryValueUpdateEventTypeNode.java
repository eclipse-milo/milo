...
public class AuditHistoryValueUpdateEventTypeNode extends AuditHistoryUpdateEventTypeNode
  ...
  @Override
  public DataValue @Nullable [] readNewValues() throws UaException {
    return ClientNodeSupport.await(readNewValuesAsync());
  }

  @Override
  public void writeNewValues(DataValue @Nullable [] value) throws UaException {
    ClientNodeSupport.good(
  ...
  @Override
  public CompletableFuture<? extends DataValue @Nullable []> readNewValuesAsync() {
    return ClientNodeSupport.defer(
        () ->
            ClientNodeSupport.compose(
                ClientNodeSupport.compose(
  ...
  @Override
  public CompletableFuture<StatusCode> writeNewValuesAsync(DataValue @Nullable [] value) {
    return ClientNodeSupport.defer(
        () ->
            ClientNodeSupport.compose(
                getNewValuesNodeAsync(),
