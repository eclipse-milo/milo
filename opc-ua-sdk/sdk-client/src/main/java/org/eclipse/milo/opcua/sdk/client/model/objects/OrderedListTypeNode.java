...
public class OrderedListTypeNode extends BaseObjectTypeNode implements OrderedListType {
   ...
   */
  public static ClientViews createViews(OrderedListTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable String getNodeVersionProperty() throws UaException {
    PropertyTypeNode node = getNodeVersionNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:NodeVersion (declaration i=23525, owner i=23518)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setNodeVersionProperty(@Nullable String value) throws UaException {
    PropertyTypeNode node = getNodeVersionNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable String readNodeVersionProperty() throws UaException {
    try {
      return readNodeVersionPropertyAsync().get();
  ...
  @Override
  public void writeNodeVersionProperty(@Nullable String value) throws UaException {
    try {
      StatusCode statusCode = writeNodeVersionPropertyAsync(value).get();
  ...
  @Override
  public CompletableFuture<? extends @Nullable String> readNodeVersionPropertyAsync() {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:NodeVersion (declaration i=23525, owner"
                            + " i=23518) on "
                            + getNodeId()));
              }
  ...
  @Override
  public CompletableFuture<StatusCode> writeNodeVersionPropertyAsync(@Nullable String nodeVersion) {
    return getNodeVersionNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:NodeVersion (declaration i=23525,"
                                    + " owner i=23518) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "NodeVersion"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:NodeVersion (declaration"
                                              + " i=23525, owner i=23518) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:NodeVersion"
                                                        + " (declaration i=23525, owner i=23518) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
