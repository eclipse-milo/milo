...
public class AlarmRateVariableTypeNode extends BaseDataVariableTypeNode
  ...
  @Override
  public @Nullable UShort getRate() throws UaException {
    PropertyTypeNode node = getRateNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
          "http://opcfoundation.org/UA/:Rate (declaration i=17278, owner i=17277)"
              + " on "
              + getNodeId());
    }
  ...
  @Override
  public void setRate(@Nullable UShort value) throws UaException {
    PropertyTypeNode node = getRateNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public CompletableFuture<StatusCode> writeRateAsync(@Nullable UShort rate) {
    return getRateNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:Rate (declaration i=17278, owner"
                                    + " i=17277) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Rate"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:Rate (declaration i=17278,"
                                              + " owner i=17277) on "
                                              + getNodeId()));
                                }
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:Rate (declaration"
                                                + " i=17278, owner i=17277) on "
                                                + getNodeId()));
                                  }
