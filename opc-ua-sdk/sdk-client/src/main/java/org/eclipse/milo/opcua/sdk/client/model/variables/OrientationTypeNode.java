...
public class OrientationTypeNode extends BaseDataVariableTypeNode implements OrientationType {
  ...
  public @Nullable PropertyTypeNode getAngleUnitNode() throws UaException {
    return ClientNodeSupport.await(getAngleUnitNodeAsync());
  }
  ...
  public @Nullable EUInformation readAngleUnit() throws UaException {
    return ClientNodeSupport.await(readAngleUnitAsync());
  }

  @Override
  public void writeAngleUnit(@Nullable EUInformation value) throws UaException {
    ClientNodeSupport.good(
        ClientNodeSupport.await(writeAngleUnitAsync(value)),
        "http://opcfoundation.org/UA/}AngleUnit");
  }
  ...
  @Override
  public CompletableFuture<StatusCode> writeAngleUnitAsync(@Nullable EUInformation value) {
    return ClientNodeSupport.defer(
        () ->
            ClientNodeSupport.compose(
                getAngleUnitNodeAsync(),
  ...
  @Override
  public @Nullable Orientation readTypedValue() throws UaException {
    return ClientNodeSupport.await(readTypedValueAsync());
  }

  @Override
  public void writeTypedValue(@Nullable Orientation value) throws UaException {
    ClientNodeSupport.good(ClientNodeSupport.await(writeTypedValueAsync(value)), "Value");
  }

  @Override
  public CompletableFuture<? extends @Nullable Orientation> readTypedValueAsync() {
    return ClientNodeSupport.defer(
        () ->
            ClientNodeSupport.compose(
                ClientNodeSupport.compose(
                    ...
                    n ->
                        ClientNodeSupport.read(
                            client, n, this, "Value", true, Orientation.class, -1, null)),
                v -> CompletableFuture.completedFuture((@Nullable Orientation) v)));
  }

  @Override
  public CompletableFuture<StatusCode> writeTypedValueAsync(@Nullable Orientation value) {
    return ClientNodeSupport.defer(
        () ->
            ClientNodeSupport.compose(
                CompletableFuture.completedFuture(this),
                n ->
                    ClientNodeSupport.write(
                        client, n, this, "Value", value, Orientation.class, -1, null)));
  }
}
