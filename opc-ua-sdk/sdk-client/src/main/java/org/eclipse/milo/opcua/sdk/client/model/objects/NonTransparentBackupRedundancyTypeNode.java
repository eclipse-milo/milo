...
public class NonTransparentBackupRedundancyTypeNode extends NonTransparentRedundancyTypeNode
   ...
   */
  public static ClientViews createViews(NonTransparentBackupRedundancyTypeNode node) {
            ...
            node -> {
              if (node == null) {
                throw new CompletionException(
                    new UaException(
                        StatusCodes.Bad_NotFound,
                        "http://opcfoundation.org/UA/:RedundantServerArray (declaration i=32413,"
                            + " owner i=32411) on "
                            + getNodeId()));
              }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:RedundantServerArray"
                                              + " (declaration i=32413, owner i=32411)"));
                                }
  ...
  @Override
  public @Nullable RedundantServerMode getMode() throws UaException {
  ...
  @Override
  public void setMode(@Nullable RedundantServerMode value) throws UaException {
    PropertyTypeNode node = getModeNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
                  ...
                  if (value == null || value instanceof Matrix && ((Matrix) value).isNull()) {
                    ...
                    if (!permitted) {
                      throw new UaRuntimeException(
                          StatusCodes.Bad_TypeMismatch,
                          "Mode: ValueRank=-1 does not permit rank " + rank);
                    }
                    if (value != null && !((Object) value instanceof RedundantServerMode)) {
                      if (!(value instanceof Integer)) {
                        throw new UaRuntimeException(
  ...
  @Override
  public CompletableFuture<StatusCode> writeModeAsync(@Nullable RedundantServerMode mode) {
    return getModeNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Mode (declaration i=32415, owner"
                                    + " i=32411) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Mode"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Mode (declaration i=32415,"
                                              + " owner i=32411) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                ...
                                for (var target : targets) {
                                  if (target == null
                                    ...
                                    return CompletableFuture.failedFuture(
                                        new UaException(
                                            StatusCodes.Bad_UnexpectedError,
                                            "http://opcfoundation.org/UA/:Mode (declaration"
                                                + " i=32415, owner i=32411) on "
                                                + getNodeId()));
                                  }
                                  if (!target.getTargetId().isLocal()) {
                                    return CompletableFuture.failedFuture(
  ...
  public UaMethodNode getFailoverMethodNode() throws UaException {
    try {
      return getFailoverMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getFailoverMethodNodeAsync() {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:Failover (declaration i=32416, owner"
                                    + " i=32411) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "Failover"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:Failover (declaration"
                                              + " i=32416, owner i=32411) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                                ...
                                                namespaceTable -> {
                                                  ...
                                                  if (resolvedTarget.isEmpty()) {
                                                    return CompletableFuture.failedFuture(
                                                        new UaException(
                                                            StatusCodes.Bad_NodeIdInvalid,
                                                            "http://opcfoundation.org/UA/:Failover"
                                                                + " (declaration i=32416, owner"
                                                                + " i=32411) on "
                                                                + getNodeId()));
                                                  }
                                                  return CompletableFuture.completedFuture(
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:Failover"
                                                        + " (declaration i=32416, owner i=32411) on"
                                                        + " "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
  ...
  @NullMarked
  @Override
  public void callFailover() throws UaException {
    callFailoverDetailed().requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callFailoverAsync() {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callFailoverDetailedAsync();
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callFailoverDetailed() throws UaException {
    return callFailoverDetailed(MethodCallOptions.NONE);
  }
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callFailoverDetailed(MethodCallOptions options)
      throws UaException {
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callFailoverDetailedAsync(options);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callFailoverDetailedAsync(MethodCallOptions.NONE);
  }
  ...
  @Override
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
      callFailoverDetailedAsync(MethodCallOptions options) {
    ...
    try {
      ...
      var lookup = getFailoverMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: Failover"));
                }
                var inputMetadata =
