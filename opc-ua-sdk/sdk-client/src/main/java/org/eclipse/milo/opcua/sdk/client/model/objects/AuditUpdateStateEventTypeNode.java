...
public class AuditUpdateStateEventTypeNode extends AuditUpdateMethodEventTypeNode
   ...
   */
  public static ClientViews createViews(AuditUpdateStateEventTypeNode node) {
    Objects.requireNonNull(node, "node");
    return ClientViews.forNode(node.client, node);
  }

  @Override
  public @Nullable Object getOldStateId() throws UaException {
  ...
  @Override
  public void setOldStateId(@Nullable Object value) throws UaException {
    PropertyTypeNode node = getOldStateIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable Object readOldStateId() throws UaException {
    try {
  ...
  @Override
  public void writeOldStateId(@Nullable Object value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable Object> readOldStateIdAsync() {
  ...
  @Override
  public CompletableFuture<StatusCode> writeOldStateIdAsync(@Nullable Object oldStateId) {
    return getOldStateIdNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:OldStateId (declaration i=2777, owner"
                                    + " i=2315) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "OldStateId"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:OldStateId (declaration"
                                              + " i=2777, owner i=2315) on "
                                              + getNodeId()));
                                }
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:OldStateId"
                                                        + " (declaration i=2777, owner i=2315) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
  ...
  @Override
  public @Nullable Object getNewStateId() throws UaException {
  ...
  @Override
  public void setNewStateId(@Nullable Object value) throws UaException {
    PropertyTypeNode node = getNewStateIdNode();
    if (node == null) {
      throw new UaException(
          StatusCodes.Bad_NotFound,
  ...
  @Override
  public @Nullable Object readNewStateId() throws UaException {
    try {
  ...
  @Override
  public void writeNewStateId(@Nullable Object value) throws UaException {
    try {
  ...
  @Override
  public CompletableFuture<? extends @Nullable Object> readNewStateIdAsync() {
  ...
  @Override
  public CompletableFuture<StatusCode> writeNewStateIdAsync(@Nullable Object newStateId) {
    return getNewStateIdNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:NewStateId (declaration i=2778, owner"
                                    + " i=2315) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "NewStateId"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:NewStateId (declaration"
                                              + " i=2778, owner i=2315) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                          ...
                                          if (unique.stream().anyMatch(NodeId::isNull)) {
                                            return CompletableFuture.failedFuture(
                                                new UaException(
                                                    StatusCodes.Bad_NodeIdInvalid,
                                                    "http://opcfoundation.org/UA/:NewStateId"
                                                        + " (declaration i=2778, owner i=2315) on "
                                                        + getNodeId()));
                                          }
                                          if (unique.size() != 1) {
                                            return CompletableFuture.failedFuture(
