...
public class IIeeeTsnInterfaceConfigurationListenerTypeNode
   ...
   */
  public static ClientViews createViews(IIeeeTsnInterfaceConfigurationListenerTypeNode node) {
  ...
  @Override
  public CompletableFuture<StatusCode> writeReceiveOffsetAsync(@Nullable UInteger receiveOffset) {
    return getReceiveOffsetNodeAsync()
        .thenCompose(
            node -> {
              if (node == null) {
  ...
  @Override
  public @Nullable BaseDataVariableTypeNode getReceiveOffsetNode() throws UaException {
    try {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:ReceiveOffset (declaration i=24198,"
                                    + " owner i=24195) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "ReceiveOffset"))
                                  }));
                      return client
