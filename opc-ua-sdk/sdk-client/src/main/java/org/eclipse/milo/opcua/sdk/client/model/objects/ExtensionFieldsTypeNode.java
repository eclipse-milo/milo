...
public class ExtensionFieldsTypeNode extends BaseObjectTypeNode implements ExtensionFieldsType {
   ...
   */
  public static ClientViews createViews(ExtensionFieldsTypeNode node) {
  ...
  public UaMethodNode getAddExtensionFieldMethodNode() throws UaException {
    try {
      return getAddExtensionFieldMethodNodeAsync().get();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getAddExtensionFieldMethodNodeAsync() {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                ...
                                "http://opcfoundation.org/UA/:AddExtensionField (declaration"
                                    + " i=15491, owner i=15489) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "AddExtensionField"))
                                  }));
                      return client
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:AddExtensionField"
                                              + " (declaration i=15491, owner i=15489) on "
                                              + getNodeId()));
                                }
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          ...
                                          "http://opcfoundation.org/UA/:AddExtensionField"
                                              + " (declaration i=15491, owner i=15489)"));
                                }
            ...
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      ...
                      "http://opcfoundation.org/UA/:AddExtensionField (declaration i=15491, owner"
                          + " i=15489)"));
            } else {
   ...
   *
   * @param fieldName ; the supplied payload may be null.
   * @param fieldValue ; the supplied payload may be null.
  ...
  @NullMarked
  @Override
  public @Nullable NodeId callAddExtensionField(
      @Nullable QualifiedName fieldName, @Nullable Object fieldValue) throws UaException {
    return callAddExtensionFieldDetailed(fieldName, fieldValue).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable NodeId> callAddExtensionFieldAsync(
    ...
    var call = callAddExtensionFieldDetailedAsync(fieldName, fieldValue);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable NodeId> callAddExtensionFieldDetailed(
      @Nullable QualifiedName fieldName, @Nullable Object fieldValue) throws UaException {
    return callAddExtensionFieldDetailed(MethodCallOptions.NONE, fieldName, fieldValue);
  }
  ...
  public MethodCallResult<? extends @Nullable NodeId> callAddExtensionFieldDetailed(
    ...
    var awaitedMethod = callAddExtensionFieldDetailedAsync(options, fieldName, fieldValue);
    try {
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
      callAddExtensionFieldDetailedAsync(
          @Nullable QualifiedName fieldName, @Nullable Object fieldValue) {
    return callAddExtensionFieldDetailedAsync(MethodCallOptions.NONE, fieldName, fieldValue);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable NodeId>>
    ...
    try {
      ...
      rawInputs.add(fieldName);
      rawInputs.add(fieldValue);
      var lookup = getAddExtensionFieldMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: AddExtensionField"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                        List.<ExpandedNodeId>of(
                                ExpandedNodeId.parse("i=20"), ExpandedNodeId.parse("i=24"))
                        ...
                        dataTypeTree -> {
                          ...
                          try {
                            ...
                            if (rawInputs.size() > 0) {
                              Variant encoded0;
                              {
                                @Nullable QualifiedName convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument FieldName (effective property i=15492,"
                                              + " DataType i=20) is unavailable in the effective"
                                    ...
                                    convertedValue = (QualifiedName) methodValue;
                                ...
                                @Nullable Object convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument FieldValue (effective property i=15492,"
                                              + " DataType i=24) is unavailable in the effective"
                                              + " type tree; resolved DataType: "
                                              + argumentDataTypeId);
                                    }
                                    Object numericElements =
  ...
  public UaMethodNode getRemoveExtensionFieldMethodNode() throws UaException {
    try {
      return getRemoveExtensionFieldMethodNodeAsync().get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
      while (cause instanceof CompletionException || cause instanceof ExecutionException) {
        cause = cause.getCause();
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends UaMethodNode> getRemoveExtensionFieldMethodNodeAsync() {
    CompletableFuture<UaMethodNode> result = new CompletableFuture<>();
    try {
      CompletableFuture<NodeId> lookup = CompletableFuture.completedFuture(getNodeId());
      CompletableFuture<UaNode> hop0 =
                    ...
                    ignored -> {
                      ...
                      if (namespaceIndex == null || referenceId.isEmpty()) {
                        return CompletableFuture.failedFuture(
                            new UaException(
                                StatusCodes.Bad_NodeIdInvalid,
                                "http://opcfoundation.org/UA/:RemoveExtensionField (declaration"
                                    + " i=15494, owner i=15489) on "
                                    + getNodeId()));
                      }
                      var browsePath =
                          new BrowsePath(
                              ...
                              new RelativePath(
                                  new RelativePathElement[] {
                                    new RelativePathElement(
                                        ...
                                        false,
                                        true,
                                        new QualifiedName(namespaceIndex, "RemoveExtensionField"))
                                  }));
                      return client
                          .translateBrowsePathsAsync(List.of(browsePath))
                          .thenCompose(
                              response -> {
                                ...
                                if (results == null
                                  ...
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          StatusCodes.Bad_UnexpectedError,
                                          "http://opcfoundation.org/UA/:RemoveExtensionField"
                                              + " (declaration i=15494, owner i=15489) on "
                                              + getNodeId()));
                                }
                                var operation = results[0];
                                if (operation.getStatusCode().getValue()
                                ...
                                if (!operation.getStatusCode().isGood()) {
                                  return CompletableFuture.failedFuture(
                                      new UaException(
                                          operation.getStatusCode(),
                                          "http://opcfoundation.org/UA/:RemoveExtensionField"
                                              + " (declaration i=15494, owner i=15489)"));
                                }
                                var targets = operation.getTargets();
                                if (targets == null || targets.length == 0) {
                                  return CompletableFuture.failedFuture(
          ...
          (node, failure) -> {
            if (failure != null) {
              ...
              result.completeExceptionally(
                  new UaException(
                      StatusCodes.Bad_TypeMismatch,
                      "http://opcfoundation.org/UA/:RemoveExtensionField (declaration i=15494,"
                          + " owner i=15489)"));
            } else {
              result.complete((UaMethodNode) node);
            }
   ...
   * flag and fails with Bad_UnexpectedError. It does not cancel server execution.
   *
   * @param fieldId ; the supplied payload may be null.
   * @throws UaException if lookup, input validation, transport, service, operation status or output
   *     conversion fails.
   */
  @NullMarked
  @Override
  public void callRemoveExtensionField(@Nullable NodeId fieldId) throws UaException {
    callRemoveExtensionFieldDetailed(fieldId).requireGood();
  }
  ...
  @NullMarked
  @Override
  public CompletableFuture<? extends @Nullable Void> callRemoveExtensionFieldAsync(
      @Nullable NodeId fieldId) {
    CompletableFuture<@Nullable Void> result = new CompletableFuture<>();
    var call = callRemoveExtensionFieldDetailedAsync(fieldId);
    result.whenComplete(
        (value, failure) -> {
          if (result.isCancelled()) {
            call.cancel(false);
  ...
  @NullMarked
  @Override
  public MethodCallResult<? extends @Nullable Void> callRemoveExtensionFieldDetailed(
      @Nullable NodeId fieldId) throws UaException {
    return callRemoveExtensionFieldDetailed(MethodCallOptions.NONE, fieldId);
  }
  ...
  public MethodCallResult<? extends @Nullable Void> callRemoveExtensionFieldDetailed(
    ...
    Objects.requireNonNull(options, "options");
    var awaitedMethod = callRemoveExtensionFieldDetailedAsync(options, fieldId);
    try {
      return awaitedMethod.get();
    } catch (ExecutionException e) {
      Throwable cause = e.getCause();
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    return callRemoveExtensionFieldDetailedAsync(MethodCallOptions.NONE, fieldId);
  }
  ...
  public CompletableFuture<? extends MethodCallResult<? extends @Nullable Void>>
    ...
    try {
      Objects.requireNonNull(options, "options");
      List<@Nullable Object> rawInputs = new ArrayList<>();
      rawInputs.add(fieldId);
      var lookup = getRemoveExtensionFieldMethodNodeAsync();
      result.whenComplete(
          (value, failure) -> {
            if (result.isCancelled()) {
              lookup.cancel(false);
              ...
              methodNode -> {
                ...
                if (methodNode == null) {
                  return CompletableFuture.failedFuture(
                      new UaException(
                          StatusCodes.Bad_NotFound,
                          "Method node is required for invocation: RemoveExtensionField"));
                }
                var inputMetadata =
                    ClientDataTypes.read(
                        this.client,
                                ...
                                @Nullable NodeId convertedValue;
                                {
                                  ...
                                  try {
                                    ...
                                    if (!OpcUaDataType.isBuiltin(argumentDataTypeId)
                                      ...
                                      throw new UaException(
                                          StatusCodes.Bad_TypeMismatch,
                                          "Method argument FieldId (effective property i=15495,"
