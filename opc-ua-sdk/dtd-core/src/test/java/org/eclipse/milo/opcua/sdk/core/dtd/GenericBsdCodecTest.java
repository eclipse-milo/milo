...
public class GenericBsdCodecTest extends AbstractBsdCodecTest {
  ...
  @Test
  public void testFoo() {
    Struct foo = Struct.builder("Foo").addMember("Bar", 0).addMember("Baz", "hello").build();
  ...
  public void testNestedUaStruct() {
    Struct profilePoint =
        Struct.builder("ProfilePointStruct")
